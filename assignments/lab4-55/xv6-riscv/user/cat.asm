...
cat(int fd)
{
  ...
  24:	38a080e7          	jalr	906(ra) # 3aa <read>
  28:	84aa                	mv	s1,a0
  ...
  38:	37e080e7          	jalr	894(ra) # 3b2 <write>
  ...
  58:	33e080e7          	jalr	830(ra) # 392 <exit>
    }
  }
  if(n < 0){
  ...
  86:	310080e7          	jalr	784(ra) # 392 <exit>
...
main(int argc, char *argv[])
{
  ...
  be:	318080e7          	jalr	792(ra) # 3d2 <open>
  c2:	84aa                	mv	s1,a0
