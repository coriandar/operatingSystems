...
main(int argc, char *argv[])
{
  ...
  4c:	2d8080e7          	jalr	728(ra) # 320 <write>
    if(i + 1 < argc){
  ...
  60:	2c4080e7          	jalr	708(ra) # 320 <write>
  for(i = 1; i < argc; i++){
  ...
  76:	2ae080e7          	jalr	686(ra) # 320 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
...
gets(char *buf, int max)
{
 ...
 172:	1aa080e7          	jalr	426(ra) # 318 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	180080e7          	jalr	384(ra) # 340 <open>
  if(fd < 0)
 ...
 1d4:	188080e7          	jalr	392(ra) # 358 <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	14c080e7          	jalr	332(ra) # 328 <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 80c:	b80080e7          	jalr	-1152(ra) # 388 <sbrk>
  if(p == (char*)-1)
