...
main(int argc, char *argv[])
{
  ...
  4c:	2d0080e7          	jalr	720(ra) # 318 <write>
    if(i + 1 < argc){
  ...
  60:	2bc080e7          	jalr	700(ra) # 318 <write>
  for(i = 1; i < argc; i++){
  ...
  76:	2a6080e7          	jalr	678(ra) # 318 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
  7c:	00000097          	auipc	ra,0x0
  80:	27c080e7          	jalr	636(ra) # 2f8 <exit>
...
gets(char *buf, int max)
{
 ...
 172:	1a2080e7          	jalr	418(ra) # 310 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	178080e7          	jalr	376(ra) # 338 <open>
  if(fd < 0)
 ...
 1d4:	180080e7          	jalr	384(ra) # 350 <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	144080e7          	jalr	324(ra) # 320 <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
00000000000002e8 <getthisprocsize>:
...
malloc(uint nbytes)
{
 ...
 804:	b80080e7          	jalr	-1152(ra) # 380 <sbrk>
  if(p == (char*)-1)
