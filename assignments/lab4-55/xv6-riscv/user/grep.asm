...
000000000000011a <grep>:
{
 ...
 180:	3b6080e7          	jalr	950(ra) # 532 <write>
 ...
 198:	396080e7          	jalr	918(ra) # 52a <read>
...
00000000000001de <main>:
{
 ...
 21e:	338080e7          	jalr	824(ra) # 552 <open>
 222:	84aa                	mv	s1,a0
 ...
 23a:	304080e7          	jalr	772(ra) # 53a <close>
  for(i = 2; i < argc; i++){
 ...
 24a:	2cc080e7          	jalr	716(ra) # 512 <exit>
 ...
 266:	2b0080e7          	jalr	688(ra) # 512 <exit>
    grep(pattern, 0);
 26a:	4581                	li	a1,0
 26c:	8552                	mv	a0,s4
 ...
 27c:	29a080e7          	jalr	666(ra) # 512 <exit>
 ...
 29a:	27c080e7          	jalr	636(ra) # 512 <exit>
...
gets(char *buf, int max)
{
 ...
 38c:	1a2080e7          	jalr	418(ra) # 52a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3de:	178080e7          	jalr	376(ra) # 552 <open>
  if(fd < 0)
 ...
 3ee:	180080e7          	jalr	384(ra) # 56a <fstat>
 3f2:	892a                	mv	s2,a0
  close(fd);
 3f4:	8526                	mv	a0,s1
 3f6:	00000097          	auipc	ra,0x0
 3fa:	144080e7          	jalr	324(ra) # 53a <close>
  return r;
}
 3fe:	854a                	mv	a0,s2
