...
000000000000011a <grep>:
{
 ...
 180:	3be080e7          	jalr	958(ra) # 53a <write>
 ...
 198:	39e080e7          	jalr	926(ra) # 532 <read>
...
00000000000001de <main>:
{
 ...
 21e:	340080e7          	jalr	832(ra) # 55a <open>
 222:	84aa                	mv	s1,a0
 ...
 23a:	30c080e7          	jalr	780(ra) # 542 <close>
  for(i = 2; i < argc; i++){
 ...
 24a:	2d4080e7          	jalr	724(ra) # 51a <exit>
 ...
 266:	2b8080e7          	jalr	696(ra) # 51a <exit>
    grep(pattern, 0);
 26a:	4581                	li	a1,0
 26c:	8552                	mv	a0,s4
 ...
 27c:	2a2080e7          	jalr	674(ra) # 51a <exit>
 ...
 29a:	284080e7          	jalr	644(ra) # 51a <exit>
...
gets(char *buf, int max)
{
 ...
 38c:	1aa080e7          	jalr	426(ra) # 532 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3de:	180080e7          	jalr	384(ra) # 55a <open>
  if(fd < 0)
 ...
 3ee:	188080e7          	jalr	392(ra) # 572 <fstat>
 3f2:	892a                	mv	s2,a0
  close(fd);
 3f4:	8526                	mv	a0,s1
 3f6:	00000097          	auipc	ra,0x0
 3fa:	14c080e7          	jalr	332(ra) # 542 <close>
  return r;
}
 3fe:	854a                	mv	a0,s2
...
0000000000000502 <getthisprocsize>:
...
malloc(uint nbytes)
{
 ...
 a26:	b80080e7          	jalr	-1152(ra) # 5a2 <sbrk>
  if(p == (char*)-1)
