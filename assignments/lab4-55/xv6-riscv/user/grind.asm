...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	e00080e7          	jalr	-512(ra) # e90 <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	dce080e7          	jalr	-562(ra) # e70 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	27650513          	addi	a0,a0,630 # 1320 <malloc+0xe6>
      b2:	00001097          	auipc	ra,0x1
      b6:	dc6080e7          	jalr	-570(ra) # e78 <chdir>
    ...
    exit(1);
      ...
      d2:	d3a080e7          	jalr	-710(ra) # e08 <exit>
  }
  chdir("/");
      d6:	00001517          	auipc	a0,0x1
      da:	27250513          	addi	a0,a0,626 # 1348 <malloc+0x10e>
      de:	00001097          	auipc	ra,0x1
      e2:	d9a080e7          	jalr	-614(ra) # e78 <chdir>
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     116:	d36080e7          	jalr	-714(ra) # e48 <open>
     11a:	00001097          	auipc	ra,0x1
     11e:	d16080e7          	jalr	-746(ra) # e30 <close>
    iters++;
    ...
    if((iters % 500) == 0)
     ...
     138:	cf4080e7          	jalr	-780(ra) # e28 <write>
    int what = rand() % 23;
    ...
    if(what == 1){
     ...
     170:	cdc080e7          	jalr	-804(ra) # e48 <open>
     174:	00001097          	auipc	ra,0x1
     178:	cbc080e7          	jalr	-836(ra) # e30 <close>
     ...
     18a:	cd2080e7          	jalr	-814(ra) # e58 <unlink>
     ...
     19c:	ce0080e7          	jalr	-800(ra) # e78 <chdir>
     ...
     1ae:	cae080e7          	jalr	-850(ra) # e58 <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	19650513          	addi	a0,a0,406 # 1348 <malloc+0x10e>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cbe080e7          	jalr	-834(ra) # e78 <chdir>
     ...
     1da:	c32080e7          	jalr	-974(ra) # e08 <exit>
    } else if(what == 5){
      close(fd);
     1de:	8552                	mv	a0,s4
     1e0:	00001097          	auipc	ra,0x1
     1e4:	c50080e7          	jalr	-944(ra) # e30 <close>
      fd = open("/grindir/../a", O_CREATE|O_RDWR);
     1e8:	20200593          	li	a1,514
     1ec:	00001517          	auipc	a0,0x1
     1f0:	1a450513          	addi	a0,a0,420 # 1390 <malloc+0x156>
     1f4:	00001097          	auipc	ra,0x1
     1f8:	c54080e7          	jalr	-940(ra) # e48 <open>
     1fc:	8a2a                	mv	s4,a0
     ...
     234:	bf8080e7          	jalr	-1032(ra) # e28 <write>
     ...
     24c:	bd8080e7          	jalr	-1064(ra) # e20 <read>
     ...
     2da:	b82080e7          	jalr	-1150(ra) # e58 <unlink>
      link("../grindir/./../a", "../b");
     ...
     2f2:	b7a080e7          	jalr	-1158(ra) # e68 <link>
     ...
     304:	b58080e7          	jalr	-1192(ra) # e58 <unlink>
      link(".././b", "/grindir/../a");
     ...
     31c:	b50080e7          	jalr	-1200(ra) # e68 <link>
     320:	b509                	j	122 <go+0xaa>
    } else if(what == 13){
      int pid = fork();
     322:	00001097          	auipc	ra,0x1
     326:	ade080e7          	jalr	-1314(ra) # e00 <fork>
      if(pid == 0){
     ...
     336:	ade080e7          	jalr	-1314(ra) # e10 <wait>
     33a:	b3e5                	j	122 <go+0xaa>
        exit(0);
     33c:	00001097          	auipc	ra,0x1
     340:	acc080e7          	jalr	-1332(ra) # e08 <exit>
        printf("grind: fork failed\n");
     ...
     35a:	ab2080e7          	jalr	-1358(ra) # e08 <exit>
    } else if(what == 14){
      int pid = fork();
     35e:	00001097          	auipc	ra,0x1
     362:	aa2080e7          	jalr	-1374(ra) # e00 <fork>
      if(pid == 0){
     ...
     372:	aa2080e7          	jalr	-1374(ra) # e10 <wait>
     376:	b375                	j	122 <go+0xaa>
        fork();
     378:	00001097          	auipc	ra,0x1
     37c:	a88080e7          	jalr	-1400(ra) # e00 <fork>
        fork();
     380:	00001097          	auipc	ra,0x1
     384:	a80080e7          	jalr	-1408(ra) # e00 <fork>
        exit(0);
     388:	4501                	li	a0,0
     38a:	00001097          	auipc	ra,0x1
     38e:	a7e080e7          	jalr	-1410(ra) # e08 <exit>
        printf("grind: fork failed\n");
     ...
     3a8:	a64080e7          	jalr	-1436(ra) # e08 <exit>
    } else if(what == 15){
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0x8b>
     3b2:	00001097          	auipc	ra,0x1
     3b6:	ade080e7          	jalr	-1314(ra) # e90 <sbrk>
     3ba:	b3a5                	j	122 <go+0xaa>
    } else if(what == 16){
      if(sbrk(0) > break0)
     3bc:	4501                	li	a0,0
     3be:	00001097          	auipc	ra,0x1
     3c2:	ad2080e7          	jalr	-1326(ra) # e90 <sbrk>
     3c6:	d4aafee3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     3ca:	4501                	li	a0,0
     3cc:	00001097          	auipc	ra,0x1
     3d0:	ac4080e7          	jalr	-1340(ra) # e90 <sbrk>
     3d4:	40aa853b          	subw	a0,s5,a0
     3d8:	00001097          	auipc	ra,0x1
     3dc:	ab8080e7          	jalr	-1352(ra) # e90 <sbrk>
     3e0:	b389                	j	122 <go+0xaa>
    } else if(what == 17){
      int pid = fork();
     3e2:	00001097          	auipc	ra,0x1
     3e6:	a1e080e7          	jalr	-1506(ra) # e00 <fork>
     3ea:	8b2a                	mv	s6,a0
      if(pid == 0){
     ...
     3fe:	a7e080e7          	jalr	-1410(ra) # e78 <chdir>
     ...
     40a:	a32080e7          	jalr	-1486(ra) # e38 <kill>
      wait(0);
     40e:	4501                	li	a0,0
     410:	00001097          	auipc	ra,0x1
     414:	a00080e7          	jalr	-1536(ra) # e10 <wait>
     ...
     42a:	a22080e7          	jalr	-1502(ra) # e48 <open>
     42e:	00001097          	auipc	ra,0x1
     432:	a02080e7          	jalr	-1534(ra) # e30 <close>
        exit(0);
     436:	4501                	li	a0,0
     438:	00001097          	auipc	ra,0x1
     43c:	9d0080e7          	jalr	-1584(ra) # e08 <exit>
        printf("grind: fork failed\n");
     ...
     456:	9b6080e7          	jalr	-1610(ra) # e08 <exit>
        printf("grind: chdir failed\n");
     ...
     470:	99c080e7          	jalr	-1636(ra) # e08 <exit>
    } else if(what == 18){
      int pid = fork();
     474:	00001097          	auipc	ra,0x1
     478:	98c080e7          	jalr	-1652(ra) # e00 <fork>
      if(pid == 0){
     ...
     488:	98c080e7          	jalr	-1652(ra) # e10 <wait>
     48c:	b959                	j	122 <go+0xaa>
        kill(getpid());
     48e:	00001097          	auipc	ra,0x1
     492:	9fa080e7          	jalr	-1542(ra) # e88 <getpid>
     496:	00001097          	auipc	ra,0x1
     49a:	9a2080e7          	jalr	-1630(ra) # e38 <kill>
        exit(0);
     49e:	4501                	li	a0,0
     4a0:	00001097          	auipc	ra,0x1
     4a4:	968080e7          	jalr	-1688(ra) # e08 <exit>
        printf("grind: fork failed\n");
     ...
     4be:	94e080e7          	jalr	-1714(ra) # e08 <exit>
    } else if(what == 19){
      int fds[2];
      if(pipe(fds) < 0){
     4c2:	fa840513          	addi	a0,s0,-88
     4c6:	00001097          	auipc	ra,0x1
     4ca:	952080e7          	jalr	-1710(ra) # e18 <pipe>
     ...
     4d6:	92e080e7          	jalr	-1746(ra) # e00 <fork>
      if(pid == 0){
     ...
     4e8:	94c080e7          	jalr	-1716(ra) # e30 <close>
      close(fds[1]);
     4ec:	fac42503          	lw	a0,-84(s0)
     4f0:	00001097          	auipc	ra,0x1
     4f4:	940080e7          	jalr	-1728(ra) # e30 <close>
      wait(0);
     4f8:	4501                	li	a0,0
     4fa:	00001097          	auipc	ra,0x1
     4fe:	916080e7          	jalr	-1770(ra) # e10 <wait>
     ...
     51a:	8f2080e7          	jalr	-1806(ra) # e08 <exit>
        fork();
     51e:	00001097          	auipc	ra,0x1
     522:	8e2080e7          	jalr	-1822(ra) # e00 <fork>
        fork();
     526:	00001097          	auipc	ra,0x1
     52a:	8da080e7          	jalr	-1830(ra) # e00 <fork>
     ...
     540:	8ec080e7          	jalr	-1812(ra) # e28 <write>
     544:	4785                	li	a5,1
     ...
     558:	8cc080e7          	jalr	-1844(ra) # e20 <read>
     55c:	4785                	li	a5,1
     55e:	02f51063          	bne	a0,a5,57e <go+0x506>
        exit(0);
     562:	4501                	li	a0,0
     564:	00001097          	auipc	ra,0x1
     568:	8a4080e7          	jalr	-1884(ra) # e08 <exit>
          printf("grind: pipe write failed\n");
     ...
     5a6:	866080e7          	jalr	-1946(ra) # e08 <exit>
    } else if(what == 20){
      int pid = fork();
     5aa:	00001097          	auipc	ra,0x1
     5ae:	856080e7          	jalr	-1962(ra) # e00 <fork>
      if(pid == 0){
     ...
     66c:	7e0080e7          	jalr	2016(ra) # e48 <open>
     670:	8b2a                	mv	s6,a0
      if(fd1 < 0){
     ...
     684:	7a8080e7          	jalr	1960(ra) # e28 <write>
     688:	4785                	li	a5,1
     ...
     698:	7cc080e7          	jalr	1996(ra) # e60 <fstat>
     ...
     6e6:	726080e7          	jalr	1830(ra) # e08 <exit>
        printf("grind: write c failed\n");
     ...
     700:	70c080e7          	jalr	1804(ra) # e08 <exit>
        printf("grind: fstat failed\n");
     ...
     71a:	6f2080e7          	jalr	1778(ra) # e08 <exit>
        printf("grind: fstat reports wrong size %d\n", (int)st.size);
     ...
     736:	6d6080e7          	jalr	1750(ra) # e08 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     ...
     750:	6bc080e7          	jalr	1724(ra) # e08 <exit>
    } else if(what == 22){
      // echo hi | cat
      int aa[2], bb[2];
      if(pipe(aa) < 0){
     ...
     75c:	6c0080e7          	jalr	1728(ra) # e18 <pipe>
     ...
     76c:	6b0080e7          	jalr	1712(ra) # e18 <pipe>
     ...
     778:	68c080e7          	jalr	1676(ra) # e00 <fork>
      if(pid1 == 0){
     ...
     788:	67c080e7          	jalr	1660(ra) # e00 <fork>
      if(pid2 == 0){
     ...
     79c:	698080e7          	jalr	1688(ra) # e30 <close>
      close(aa[1]);
     7a0:	f9c42503          	lw	a0,-100(s0)
     7a4:	00000097          	auipc	ra,0x0
     7a8:	68c080e7          	jalr	1676(ra) # e30 <close>
      close(bb[1]);
     7ac:	fa442503          	lw	a0,-92(s0)
     7b0:	00000097          	auipc	ra,0x0
     7b4:	680080e7          	jalr	1664(ra) # e30 <close>
      char buf[4] = { 0, 0, 0, 0 };
     ...
     7ca:	65a080e7          	jalr	1626(ra) # e20 <read>
      read(bb[0], buf+1, 1);
     7ce:	4605                	li	a2,1
     7d0:	f9140593          	addi	a1,s0,-111
     7d4:	fa042503          	lw	a0,-96(s0)
     7d8:	00000097          	auipc	ra,0x0
     7dc:	648080e7          	jalr	1608(ra) # e20 <read>
      read(bb[0], buf+2, 1);
     7e0:	4605                	li	a2,1
     7e2:	f9240593          	addi	a1,s0,-110
     7e6:	fa042503          	lw	a0,-96(s0)
     7ea:	00000097          	auipc	ra,0x0
     7ee:	636080e7          	jalr	1590(ra) # e20 <read>
      close(bb[0]);
     7f2:	fa042503          	lw	a0,-96(s0)
     7f6:	00000097          	auipc	ra,0x0
     7fa:	63a080e7          	jalr	1594(ra) # e30 <close>
      int st1, st2;
      wait(&st1);
     7fe:	f9440513          	addi	a0,s0,-108
     802:	00000097          	auipc	ra,0x0
     806:	60e080e7          	jalr	1550(ra) # e10 <wait>
      wait(&st2);
     80a:	fa840513          	addi	a0,s0,-88
     80e:	00000097          	auipc	ra,0x0
     812:	602080e7          	jalr	1538(ra) # e10 <wait>
     ...
     85c:	5b0080e7          	jalr	1456(ra) # e08 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     878:	594080e7          	jalr	1428(ra) # e08 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     894:	578080e7          	jalr	1400(ra) # e08 <exit>
        close(bb[0]);
     898:	fa042503          	lw	a0,-96(s0)
     89c:	00000097          	auipc	ra,0x0
     8a0:	594080e7          	jalr	1428(ra) # e30 <close>
        close(bb[1]);
     8a4:	fa442503          	lw	a0,-92(s0)
     8a8:	00000097          	auipc	ra,0x0
     8ac:	588080e7          	jalr	1416(ra) # e30 <close>
        close(aa[0]);
     8b0:	f9842503          	lw	a0,-104(s0)
     8b4:	00000097          	auipc	ra,0x0
     8b8:	57c080e7          	jalr	1404(ra) # e30 <close>
        close(1);
     8bc:	4505                	li	a0,1
     8be:	00000097          	auipc	ra,0x0
     8c2:	572080e7          	jalr	1394(ra) # e30 <close>
        if(dup(aa[1]) != 1){
     8c6:	f9c42503          	lw	a0,-100(s0)
     8ca:	00000097          	auipc	ra,0x0
     8ce:	5b6080e7          	jalr	1462(ra) # e80 <dup>
     8d2:	4785                	li	a5,1
     ...
     8f0:	51c080e7          	jalr	1308(ra) # e08 <exit>
        close(aa[1]);
     8f4:	f9c42503          	lw	a0,-100(s0)
     8f8:	00000097          	auipc	ra,0x0
     8fc:	538080e7          	jalr	1336(ra) # e30 <close>
        char *args[3] = { "echo", "hi", 0 };
     ...
     92c:	518080e7          	jalr	1304(ra) # e40 <exec>
        fprintf(2, "grind: echo: not found\n");
     ...
     948:	4c4080e7          	jalr	1220(ra) # e08 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     964:	4a8080e7          	jalr	1192(ra) # e08 <exit>
        close(aa[1]);
     968:	f9c42503          	lw	a0,-100(s0)
     96c:	00000097          	auipc	ra,0x0
     970:	4c4080e7          	jalr	1220(ra) # e30 <close>
        close(bb[0]);
     974:	fa042503          	lw	a0,-96(s0)
     978:	00000097          	auipc	ra,0x0
     97c:	4b8080e7          	jalr	1208(ra) # e30 <close>
        close(0);
     980:	4501                	li	a0,0
     982:	00000097          	auipc	ra,0x0
     986:	4ae080e7          	jalr	1198(ra) # e30 <close>
        if(dup(aa[0]) != 0){
     98a:	f9842503          	lw	a0,-104(s0)
     98e:	00000097          	auipc	ra,0x0
     992:	4f2080e7          	jalr	1266(ra) # e80 <dup>
     ...
     9b0:	45c080e7          	jalr	1116(ra) # e08 <exit>
        close(aa[0]);
     9b4:	f9842503          	lw	a0,-104(s0)
     9b8:	00000097          	auipc	ra,0x0
     9bc:	478080e7          	jalr	1144(ra) # e30 <close>
        close(1);
     9c0:	4505                	li	a0,1
     9c2:	00000097          	auipc	ra,0x0
     9c6:	46e080e7          	jalr	1134(ra) # e30 <close>
        if(dup(bb[1]) != 1){
     9ca:	fa442503          	lw	a0,-92(s0)
     9ce:	00000097          	auipc	ra,0x0
     9d2:	4b2080e7          	jalr	1202(ra) # e80 <dup>
     9d6:	4785                	li	a5,1
     ...
     9f4:	418080e7          	jalr	1048(ra) # e08 <exit>
        close(bb[1]);
     9f8:	fa442503          	lw	a0,-92(s0)
     9fc:	00000097          	auipc	ra,0x0
     a00:	434080e7          	jalr	1076(ra) # e30 <close>
        char *args[2] = { "cat", 0 };
     ...
     a24:	420080e7          	jalr	1056(ra) # e40 <exec>
        fprintf(2, "grind: cat: not found\n");
     ...
     a40:	3cc080e7          	jalr	972(ra) # e08 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     a5c:	3b0080e7          	jalr	944(ra) # e08 <exit>
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	3e4080e7          	jalr	996(ra) # e58 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	93450513          	addi	a0,a0,-1740 # 13b0 <malloc+0x176>
     a84:	00000097          	auipc	ra,0x0
     a88:	3d4080e7          	jalr	980(ra) # e58 <unlink>
  
  int pid1 = fork();
     a8c:	00000097          	auipc	ra,0x0
     a90:	374080e7          	jalr	884(ra) # e00 <fork>
  if(pid1 < 0){
  ...
  if(pid1 == 0){
    ...
    exit(1);
     ...
     ac6:	346080e7          	jalr	838(ra) # e08 <exit>
    exit(0);
  }

  int pid2 = fork();
     aca:	00000097          	auipc	ra,0x0
     ace:	336080e7          	jalr	822(ra) # e00 <fork>
     ad2:	892a                	mv	s2,a0
  if(pid2 < 0){
  ...
  if(pid2 == 0){
    ...
    exit(1);
     ...
     b08:	304080e7          	jalr	772(ra) # e08 <exit>
    exit(0);
  }
  ...
  wait(&st1);
     ...
     b1a:	2fa080e7          	jalr	762(ra) # e10 <wait>
  if(st1 != 0){
  ...
  wait(&st2);
     ...
     b32:	2e2080e7          	jalr	738(ra) # e10 <wait>

  exit(0);
     b36:	4501                	li	a0,0
     b38:	00000097          	auipc	ra,0x0
     b3c:	2d0080e7          	jalr	720(ra) # e08 <exit>
    kill(pid1);
     b40:	8526                	mv	a0,s1
     b42:	00000097          	auipc	ra,0x0
     b46:	2f6080e7          	jalr	758(ra) # e38 <kill>
    kill(pid2);
     b4a:	854a                	mv	a0,s2
     b4c:	00000097          	auipc	ra,0x0
     b50:	2ec080e7          	jalr	748(ra) # e38 <kill>
...
main()
{
  ...
  while(1){
    ...
    sleep(20);
     ...
     b6e:	32e080e7          	jalr	814(ra) # e98 <sleep>
    int pid = fork();
     b72:	00000097          	auipc	ra,0x0
     b76:	28e080e7          	jalr	654(ra) # e00 <fork>
    if(pid == 0){
    ...
    if(pid > 0){
     ...
     b86:	28e080e7          	jalr	654(ra) # e10 <wait>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c7a:	1aa080e7          	jalr	426(ra) # e20 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     ccc:	180080e7          	jalr	384(ra) # e48 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cdc:	188080e7          	jalr	392(ra) # e60 <fstat>
     ce0:	892a                	mv	s2,a0
  close(fd);
     ce2:	8526                	mv	a0,s1
     ce4:	00000097          	auipc	ra,0x0
     ce8:	14c080e7          	jalr	332(ra) # e30 <close>
  return r;
}
     cec:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ebe:	f6e080e7          	jalr	-146(ra) # e28 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1314:	b80080e7          	jalr	-1152(ra) # e90 <sbrk>
  if(p == (char*)-1)
