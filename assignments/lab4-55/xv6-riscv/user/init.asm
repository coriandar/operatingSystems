...
main(void)
{
  ...
  1a:	396080e7          	jalr	918(ra) # 3ac <open>
  ...
  28:	3c0080e7          	jalr	960(ra) # 3e4 <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3b6080e7          	jalr	950(ra) # 3e4 <dup>
  ...
  4c:	31c080e7          	jalr	796(ra) # 364 <fork>
  50:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  5e:	31a080e7          	jalr	794(ra) # 374 <wait>
      if(wpid == pid){
  ...
  80:	2f0080e7          	jalr	752(ra) # 36c <exit>
    mknod("console", CONSOLE, 0);
  84:	4601                	li	a2,0
  86:	4585                	li	a1,1
  ...
  c2:	2ae080e7          	jalr	686(ra) # 36c <exit>
      exec("sh", argv);
  ...
  da:	2ce080e7          	jalr	718(ra) # 3a4 <exec>
  ...
  f4:	27c080e7          	jalr	636(ra) # 36c <exit>
...
gets(char *buf, int max)
{
 ...
 1e6:	1a2080e7          	jalr	418(ra) # 384 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 238:	178080e7          	jalr	376(ra) # 3ac <open>
  if(fd < 0)
 ...
 248:	180080e7          	jalr	384(ra) # 3c4 <fstat>
 24c:	892a                	mv	s2,a0
  close(fd);
 24e:	8526                	mv	a0,s1
 250:	00000097          	auipc	ra,0x0
 254:	144080e7          	jalr	324(ra) # 394 <close>
  return r;
}
 258:	854a                	mv	a0,s2
...
000000000000035c <getthisprocsize>:
...
malloc(uint nbytes)
{
 ...
 878:	b80080e7          	jalr	-1152(ra) # 3f4 <sbrk>
  if(p == (char*)-1)
