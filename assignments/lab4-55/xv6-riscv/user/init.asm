...
main(void)
{
  ...
  80:	2f8080e7          	jalr	760(ra) # 374 <exit>
    mknod("console", CONSOLE, 0);
  84:	4601                	li	a2,0
  86:	4585                	li	a1,1
  ...
  c2:	2b6080e7          	jalr	694(ra) # 374 <exit>
      exec("sh", argv);
  ...
  da:	2d6080e7          	jalr	726(ra) # 3ac <exec>
  ...
  f4:	284080e7          	jalr	644(ra) # 374 <exit>
...
gets(char *buf, int max)
{
 ...
 1e6:	1aa080e7          	jalr	426(ra) # 38c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 238:	180080e7          	jalr	384(ra) # 3b4 <open>
  if(fd < 0)
 ...
 248:	188080e7          	jalr	392(ra) # 3cc <fstat>
 24c:	892a                	mv	s2,a0
  close(fd);
 24e:	8526                	mv	a0,s1
 250:	00000097          	auipc	ra,0x0
 254:	14c080e7          	jalr	332(ra) # 39c <close>
  return r;
}
 258:	854a                	mv	a0,s2
