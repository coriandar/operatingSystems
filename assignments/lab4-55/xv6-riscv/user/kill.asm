...
main(int argc, char **argv)
{
  ...
  34:	2e0080e7          	jalr	736(ra) # 310 <kill>
  for(i=1; i<argc; i++)
  ...
  44:	2a0080e7          	jalr	672(ra) # 2e0 <exit>
    fprintf(2, "usage: kill pid...\n");
  ...
  60:	284080e7          	jalr	644(ra) # 2e0 <exit>
...
gets(char *buf, int max)
{
 ...
 152:	1aa080e7          	jalr	426(ra) # 2f8 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a4:	180080e7          	jalr	384(ra) # 320 <open>
  if(fd < 0)
 ...
 1b4:	188080e7          	jalr	392(ra) # 338 <fstat>
 1b8:	892a                	mv	s2,a0
  close(fd);
 1ba:	8526                	mv	a0,s1
 1bc:	00000097          	auipc	ra,0x0
 1c0:	14c080e7          	jalr	332(ra) # 308 <close>
  return r;
}
 1c4:	854a                	mv	a0,s2
...
00000000000002c8 <getthisprocsize>:
