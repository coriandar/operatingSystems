...
ls(char *path)
{
  ...
  de:	4b4080e7          	jalr	1204(ra) # 58e <open>
  ...
  f0:	4ba080e7          	jalr	1210(ra) # 5a6 <fstat>
 ...
 13a:	440080e7          	jalr	1088(ra) # 576 <close>
}
 ...
 190:	3ea080e7          	jalr	1002(ra) # 576 <close>
    return;
 ...
 21a:	350080e7          	jalr	848(ra) # 566 <read>
 21e:	47c1                	li	a5,16
...
main(int argc, char *argv[])
{
 ...
 2b4:	29e080e7          	jalr	670(ra) # 54e <exit>
    ls(".");
 ...
 2ce:	284080e7          	jalr	644(ra) # 54e <exit>
...
gets(char *buf, int max)
{
 ...
 3c0:	1aa080e7          	jalr	426(ra) # 566 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 412:	180080e7          	jalr	384(ra) # 58e <open>
  if(fd < 0)
 ...
 422:	188080e7          	jalr	392(ra) # 5a6 <fstat>
 426:	892a                	mv	s2,a0
  close(fd);
 428:	8526                	mv	a0,s1
 42a:	00000097          	auipc	ra,0x0
 42e:	14c080e7          	jalr	332(ra) # 576 <close>
  return r;
}
 432:	854a                	mv	a0,s2
...
0000000000000536 <getthisprocsize>:
...
malloc(uint nbytes)
{
 ...
 a5a:	b80080e7          	jalr	-1152(ra) # 5d6 <sbrk>
  if(p == (char*)-1)
