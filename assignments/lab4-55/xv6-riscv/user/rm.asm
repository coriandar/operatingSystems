...
main(int argc, char *argv[])
{
  ...
  2e:	31a080e7          	jalr	794(ra) # 344 <unlink>
  ...
  74:	284080e7          	jalr	644(ra) # 2f4 <exit>
...
gets(char *buf, int max)
{
 ...
 166:	1aa080e7          	jalr	426(ra) # 30c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1b8:	180080e7          	jalr	384(ra) # 334 <open>
  if(fd < 0)
 ...
 1c8:	188080e7          	jalr	392(ra) # 34c <fstat>
 1cc:	892a                	mv	s2,a0
  close(fd);
 1ce:	8526                	mv	a0,s1
 1d0:	00000097          	auipc	ra,0x0
 1d4:	14c080e7          	jalr	332(ra) # 31c <close>
  return r;
}
 1d8:	854a                	mv	a0,s2
...
00000000000002dc <getthisprocsize>:
...
malloc(uint nbytes)
{
 ...
 800:	b80080e7          	jalr	-1152(ra) # 37c <sbrk>
  if(p == (char*)-1)
