...
main(int argc, char *argv[])
{
  ...
  2e:	312080e7          	jalr	786(ra) # 33c <unlink>
  ...
  56:	29a080e7          	jalr	666(ra) # 2ec <exit>
  ...
  74:	27c080e7          	jalr	636(ra) # 2ec <exit>
...
gets(char *buf, int max)
{
 ...
 166:	1a2080e7          	jalr	418(ra) # 304 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1b8:	178080e7          	jalr	376(ra) # 32c <open>
  if(fd < 0)
 ...
 1c8:	180080e7          	jalr	384(ra) # 344 <fstat>
 1cc:	892a                	mv	s2,a0
  close(fd);
 1ce:	8526                	mv	a0,s1
 1d0:	00000097          	auipc	ra,0x0
 1d4:	144080e7          	jalr	324(ra) # 314 <close>
  return r;
}
 1d8:	854a                	mv	a0,s2
