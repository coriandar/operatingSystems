...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     34a:	50c080e7          	jalr	1292(ra) # 5852 <exit>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     386:	510080e7          	jalr	1296(ra) # 5892 <open>
     38a:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     432:	424080e7          	jalr	1060(ra) # 5852 <exit>
     ...
     450:	406080e7          	jalr	1030(ra) # 5852 <exit>
     ...
     46e:	3e8080e7          	jalr	1000(ra) # 5852 <exit>
      printf("pipe() failed\n");
     ...
     488:	3ce080e7          	jalr	974(ra) # 5852 <exit>
     ...
     4a6:	3b0080e7          	jalr	944(ra) # 5852 <exit>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4ea:	3ac080e7          	jalr	940(ra) # 5892 <open>
     4ee:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     52a:	34c080e7          	jalr	844(ra) # 5872 <write>
    if(n != 1){
     52e:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     592:	2c4080e7          	jalr	708(ra) # 5852 <exit>
     ...
     5b0:	2a6080e7          	jalr	678(ra) # 5852 <exit>
      printf("pipe() failed\n");
     ...
     5ca:	28c080e7          	jalr	652(ra) # 5852 <exit>
     ...
     5e4:	272080e7          	jalr	626(ra) # 5852 <exit>
     ...
     602:	254080e7          	jalr	596(ra) # 5852 <exit>
...
0000000000000606 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     626:	280080e7          	jalr	640(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     63a:	25c080e7          	jalr	604(ra) # 5892 <open>
     63e:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     640:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     696:	200080e7          	jalr	512(ra) # 5892 <open>
     69a:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     6d2:	19c080e7          	jalr	412(ra) # 586a <read>
     6d6:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     714:	15a080e7          	jalr	346(ra) # 586a <read>
  if(n != 2){
     718:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     72a:	17c080e7          	jalr	380(ra) # 58a2 <unlink>
  close(fd1);
     72e:	854e                	mv	a0,s3
     730:	00005097          	auipc	ra,0x5
     734:	14a080e7          	jalr	330(ra) # 587a <close>
  close(fd2);
     738:	8526                	mv	a0,s1
     73a:	00005097          	auipc	ra,0x5
     73e:	140080e7          	jalr	320(ra) # 587a <close>
  close(fd3);
     742:	854a                	mv	a0,s2
     744:	00005097          	auipc	ra,0x5
     748:	136080e7          	jalr	310(ra) # 587a <close>
}
    ...
    exit(1);
     ...
     778:	0de080e7          	jalr	222(ra) # 5852 <exit>
    printf("aaa fd3=%d\n", fd3);
     77c:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     7a8:	0ae080e7          	jalr	174(ra) # 5852 <exit>
    printf("bbb fd2=%d\n", fd2);
     7ac:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     7d8:	07e080e7          	jalr	126(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     7f6:	060080e7          	jalr	96(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     814:	042080e7          	jalr	66(ra) # 5852 <exit>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     83e:	058080e7          	jalr	88(ra) # 5892 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     868:	00e080e7          	jalr	14(ra) # 5872 <write>
     86c:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     87c:	ffa080e7          	jalr	-6(ra) # 5872 <write>
     880:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8be:	fb0080e7          	jalr	-80(ra) # 586a <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     914:	f42080e7          	jalr	-190(ra) # 5852 <exit>
     ...
     932:	f24080e7          	jalr	-220(ra) # 5852 <exit>
     ...
     950:	f06080e7          	jalr	-250(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     96c:	eea080e7          	jalr	-278(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     988:	ece080e7          	jalr	-306(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     9a4:	eb2080e7          	jalr	-334(ra) # 5852 <exit>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9cc:	eca080e7          	jalr	-310(ra) # 5892 <open>
     9d0:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9d2:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     9f4:	e82080e7          	jalr	-382(ra) # 5872 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3e:	e30080e7          	jalr	-464(ra) # 586a <read>
    if(i == 0){
    ...
    exit(1);
     ...
     a70:	de6080e7          	jalr	-538(ra) # 5852 <exit>
     ...
     a8e:	dc8080e7          	jalr	-568(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     aaa:	dac080e7          	jalr	-596(ra) # 5852 <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     b02:	d54080e7          	jalr	-684(ra) # 5852 <exit>
     ...
     b20:	d36080e7          	jalr	-714(ra) # 5852 <exit>
     ...
     b3e:	d18080e7          	jalr	-744(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     b5a:	cfc080e7          	jalr	-772(ra) # 5852 <exit>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b7e:	d18080e7          	jalr	-744(ra) # 5892 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc8:	cde080e7          	jalr	-802(ra) # 58a2 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bde:	cb8080e7          	jalr	-840(ra) # 5892 <open>
     be2:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be4:	460d                	li	a2,3
     ...
     bf2:	c84080e7          	jalr	-892(ra) # 5872 <write>
  close(fd1);
     bf6:	854a                	mv	a0,s2
     bf8:	00005097          	auipc	ra,0x5
     bfc:	c82080e7          	jalr	-894(ra) # 587a <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c10:	c5e080e7          	jalr	-930(ra) # 586a <read>
     c14:	4795                	li	a5,5
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     c84:	bd2080e7          	jalr	-1070(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     ca0:	bb6080e7          	jalr	-1098(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     cbc:	b9a080e7          	jalr	-1126(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     cd8:	b7e080e7          	jalr	-1154(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     cf4:	b62080e7          	jalr	-1182(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     d10:	b46080e7          	jalr	-1210(ra) # 5852 <exit>
...
0000000000000d14 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     d52:	b44080e7          	jalr	-1212(ra) # 5892 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6a:	b0c080e7          	jalr	-1268(ra) # 5872 <write>
     d6e:	4795                	li	a5,5
     d70:	10f51863          	bne	a0,a5,e80 <linktest+0x16c>
  close(fd);
     d74:	8526                	mv	a0,s1
     d76:	00005097          	auipc	ra,0x5
     d7a:	b04080e7          	jalr	-1276(ra) # 587a <close>
  if(link("lf1", "lf2") < 0){
     ...
     d92:	b24080e7          	jalr	-1244(ra) # 58b2 <link>
  ...
  fd = open("lf2", 0);
     ...
     dce:	ac8080e7          	jalr	-1336(ra) # 5892 <open>
     dd2:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     e1c:	a8a080e7          	jalr	-1398(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     ...
     e34:	a82080e7          	jalr	-1406(ra) # 58b2 <link>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e50:	a66080e7          	jalr	-1434(ra) # 58b2 <link>
    ...
    exit(1);
     ...
     e7c:	9da080e7          	jalr	-1574(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     e98:	9be080e7          	jalr	-1602(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     eb4:	9a2080e7          	jalr	-1630(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     ed0:	986080e7          	jalr	-1658(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     eec:	96a080e7          	jalr	-1686(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     f08:	94e080e7          	jalr	-1714(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     f24:	932080e7          	jalr	-1742(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     f40:	916080e7          	jalr	-1770(ra) # 5852 <exit>
    ...
    exit(1);
     ...
     f5c:	8fa080e7          	jalr	-1798(ra) # 5852 <exit>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff0:	8c6080e7          	jalr	-1850(ra) # 58b2 <link>
     ff4:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    100a:	89c080e7          	jalr	-1892(ra) # 58a2 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    104c:	85a080e7          	jalr	-1958(ra) # 58a2 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    1084:	7d2080e7          	jalr	2002(ra) # 5852 <exit>
    ...
    10a4:	7b2080e7          	jalr	1970(ra) # 5852 <exit>
    ...
    10c0:	796080e7          	jalr	1942(ra) # 5852 <exit>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f4:	7c2080e7          	jalr	1986(ra) # 58b2 <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    112e:	728080e7          	jalr	1832(ra) # 5852 <exit>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1152:	73c080e7          	jalr	1852(ra) # 588a <exec>

  pipe((int*)0xeaeb0b5b00002f5e);
    1156:	8526                	mv	a0,s1
    1158:	00004097          	auipc	ra,0x4
    115c:	70a080e7          	jalr	1802(ra) # 5862 <pipe>

  exit(0);
    1160:	4501                	li	a0,0
    1162:	00004097          	auipc	ra,0x4
    1166:	6f0080e7          	jalr	1776(ra) # 5852 <exit>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    119e:	6f0080e7          	jalr	1776(ra) # 588a <exec>
  for(int i = 0; i < 50000; i++){
  ...
  exit(0);
    ...
    11ac:	6aa080e7          	jalr	1706(ra) # 5852 <exit>
...
00000000000011b0 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    11da:	6cc080e7          	jalr	1740(ra) # 58a2 <unlink>
  if(ret != -1){
    11de:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    11f0:	6a6080e7          	jalr	1702(ra) # 5892 <open>
  if(fd != -1){
    11f4:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    1204:	6b2080e7          	jalr	1714(ra) # 58b2 <link>
  if(ret != -1){
    1208:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    122a:	664080e7          	jalr	1636(ra) # 588a <exec>
  if(ret != -1){
    122e:	57fd                	li	a5,-1
    1230:	0ef51963          	bne	a0,a5,1322 <copyinstr2+0x172>
  int pid = fork();
    1234:	00004097          	auipc	ra,0x4
    1238:	616080e7          	jalr	1558(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    129a:	5f4080e7          	jalr	1524(ra) # 588a <exec>
    if(ret != -1){
    129e:	57fd                	li	a5,-1
    ...
    12bc:	59a080e7          	jalr	1434(ra) # 5852 <exit>
    ...
    12dc:	57a080e7          	jalr	1402(ra) # 5852 <exit>
    ...
    12fc:	55a080e7          	jalr	1370(ra) # 5852 <exit>
    ...
    131e:	538080e7          	jalr	1336(ra) # 5852 <exit>
    ...
    133e:	518080e7          	jalr	1304(ra) # 5852 <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    13a2:	4b4080e7          	jalr	1204(ra) # 5852 <exit>
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13ca:	4cc080e7          	jalr	1228(ra) # 5892 <open>
    13ce:	00004097          	auipc	ra,0x4
    13d2:	4ac080e7          	jalr	1196(ra) # 587a <close>
  pid = fork();
    13d6:	00004097          	auipc	ra,0x4
    13da:	474080e7          	jalr	1140(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1400:	496080e7          	jalr	1174(ra) # 5892 <open>
    1404:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1412:	464080e7          	jalr	1124(ra) # 5872 <write>
      if(n != 10){
    1416:	47a9                	li	a5,10
    ...
    1422:	45c080e7          	jalr	1116(ra) # 587a <close>
      fd = open("truncfile", O_RDONLY);
    1426:	4581                	li	a1,0
    1428:	8552                	mv	a0,s4
    142a:	00004097          	auipc	ra,0x4
    142e:	468080e7          	jalr	1128(ra) # 5892 <open>
    1432:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1434:	02000613          	li	a2,32
    1438:	f9840593          	addi	a1,s0,-104
    143c:	00004097          	auipc	ra,0x4
    1440:	42e080e7          	jalr	1070(ra) # 586a <read>
      close(fd);
    1444:	8526                	mv	a0,s1
    1446:	00004097          	auipc	ra,0x4
    144a:	434080e7          	jalr	1076(ra) # 587a <close>
    for(int i = 0; i < 100; i++){
    ...
    145a:	3fc080e7          	jalr	1020(ra) # 5852 <exit>
    ...
    1492:	3c4080e7          	jalr	964(ra) # 5852 <exit>
    ...
    14b0:	3a6080e7          	jalr	934(ra) # 5852 <exit>
    ...
    14d2:	3c4080e7          	jalr	964(ra) # 5892 <open>
    14d6:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    14e4:	392080e7          	jalr	914(ra) # 5872 <write>
    if(n != 3){
    14e8:	478d                	li	a5,3
    ...
    14f4:	38a080e7          	jalr	906(ra) # 587a <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    153e:	318080e7          	jalr	792(ra) # 5852 <exit>
    ...
    155c:	2fa080e7          	jalr	762(ra) # 5852 <exit>
...
0000000000001560 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1596:	310080e7          	jalr	784(ra) # 58a2 <unlink>
  pid = fork();
    159a:	00004097          	auipc	ra,0x4
    159e:	2b0080e7          	jalr	688(ra) # 584a <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    15b0:	2ce080e7          	jalr	718(ra) # 587a <close>
    ...
    15c4:	2d2080e7          	jalr	722(ra) # 5892 <open>
    if(fd < 0) {
    ...
    15ea:	26c080e7          	jalr	620(ra) # 5852 <exit>
     printf("%s: fork failed\n", s);
    15ee:	85ca                	mv	a1,s2
    ...
    1606:	250080e7          	jalr	592(ra) # 5852 <exit>
    ...
    1622:	234080e7          	jalr	564(ra) # 5852 <exit>
  ...
  if(xstatus != 0)
    ...
    1658:	1fe080e7          	jalr	510(ra) # 5852 <exit>
    ...
    1674:	1e2080e7          	jalr	482(ra) # 5852 <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169a:	1fc080e7          	jalr	508(ra) # 5892 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16ac:	1c2080e7          	jalr	450(ra) # 586a <read>
    16b0:	4789                	li	a5,2
    ...
    16ce:	188080e7          	jalr	392(ra) # 5852 <exit>
    printf("%s: open failed\n", s);
    16d2:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    172e:	128080e7          	jalr	296(ra) # 5852 <exit>
    exit(0);
    1732:	4501                	li	a0,0
    1734:	00004097          	auipc	ra,0x4
    1738:	11e080e7          	jalr	286(ra) # 5852 <exit>
...
000000000000173c <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    175c:	10a080e7          	jalr	266(ra) # 5862 <pipe>
    1760:	e93d                	bnez	a0,17d6 <pipe1+0x9a>
    1762:	84aa                	mv	s1,a0
  pid = fork();
    1764:	00004097          	auipc	ra,0x4
    1768:	0e6080e7          	jalr	230(ra) # 584a <fork>
    176c:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    177c:	102080e7          	jalr	258(ra) # 587a <close>
    total = 0;
    1780:	8a26                	mv	s4,s1
    cc = 1;
    1782:	4985                	li	s3,1
    ...
    179a:	0d4080e7          	jalr	212(ra) # 586a <read>
    ...
    17ee:	068080e7          	jalr	104(ra) # 5852 <exit>
    close(fds[0]);
    17f2:	fa842503          	lw	a0,-88(s0)
    17f6:	00004097          	auipc	ra,0x4
    17fa:	084080e7          	jalr	132(ra) # 587a <close>
    for(n = 0; n < N; n++){
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    183c:	03a080e7          	jalr	58(ra) # 5872 <write>
    ...
    1858:	ffe080e7          	jalr	-2(ra) # 5852 <exit>
    ...
    1874:	fe2080e7          	jalr	-30(ra) # 5852 <exit>
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1922:	f2c080e7          	jalr	-212(ra) # 584a <fork>
    1926:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    1936:	f28080e7          	jalr	-216(ra) # 585a <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1974:	ee2080e7          	jalr	-286(ra) # 5852 <exit>
    ...
    1990:	ec6080e7          	jalr	-314(ra) # 5852 <exit>
    ...
    19ac:	eaa080e7          	jalr	-342(ra) # 5852 <exit>
      exit(i);
    19b0:	854a                	mv	a0,s2
    19b2:	00004097          	auipc	ra,0x4
    19b6:	ea0080e7          	jalr	-352(ra) # 5852 <exit>
...
00000000000019ba <twochildren>:
{
    ...
    19d0:	e7e080e7          	jalr	-386(ra) # 584a <fork>
    if(pid1 < 0){
    ...
    19de:	e70080e7          	jalr	-400(ra) # 584a <fork>
      if(pid2 < 0){
    ...
    19f8:	e66080e7          	jalr	-410(ra) # 585a <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1a24:	e32080e7          	jalr	-462(ra) # 5852 <exit>
      exit(0);
    1a28:	00004097          	auipc	ra,0x4
    1a2c:	e2a080e7          	jalr	-470(ra) # 5852 <exit>
        printf("%s: fork failed\n", s);
    1a30:	85ca                	mv	a1,s2
    ...
    1a48:	e0e080e7          	jalr	-498(ra) # 5852 <exit>
        exit(0);
    1a4c:	00004097          	auipc	ra,0x4
    1a50:	e06080e7          	jalr	-506(ra) # 5852 <exit>
...
0000000000001a54 <forkfork>:
{
    ...
    1a64:	dea080e7          	jalr	-534(ra) # 584a <fork>
    if(pid < 0){
    ...
    1a72:	ddc080e7          	jalr	-548(ra) # 584a <fork>
    if(pid < 0){
    ...
    1a84:	dda080e7          	jalr	-550(ra) # 585a <wait>
    if(xstatus != 0) {
    ...
    1a96:	dc8080e7          	jalr	-568(ra) # 585a <wait>
    if(xstatus != 0) {
    ...
    1ac2:	d94080e7          	jalr	-620(ra) # 5852 <exit>
{
    1ac6:	0c800493          	li	s1,200
        int pid1 = fork();
    1aca:	00004097          	auipc	ra,0x4
    1ace:	d80080e7          	jalr	-640(ra) # 584a <fork>
        if(pid1 < 0){
    ...
    1ade:	d80080e7          	jalr	-640(ra) # 585a <wait>
      for(int j = 0; j < 200; j++){
    ...
    1aec:	d6a080e7          	jalr	-662(ra) # 5852 <exit>
          exit(1);
    1af0:	4505                	li	a0,1
    1af2:	00004097          	auipc	ra,0x4
    1af6:	d60080e7          	jalr	-672(ra) # 5852 <exit>
          exit(0);
    1afa:	00004097          	auipc	ra,0x4
    1afe:	d58080e7          	jalr	-680(ra) # 5852 <exit>
    ...
    1b1a:	d3c080e7          	jalr	-708(ra) # 5852 <exit>
...
0000000000001b1e <reparent2>:
{
    ...
    1b30:	d1e080e7          	jalr	-738(ra) # 584a <fork>
    if(pid1 < 0){
    ...
    1b40:	d1e080e7          	jalr	-738(ra) # 585a <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1b4e:	d08080e7          	jalr	-760(ra) # 5852 <exit>
      printf("fork failed\n");
    ...
    1b68:	cee080e7          	jalr	-786(ra) # 5852 <exit>
      fork();
    1b6c:	00004097          	auipc	ra,0x4
    1b70:	cde080e7          	jalr	-802(ra) # 584a <fork>
      fork();
    ...
    1b82:	cd4080e7          	jalr	-812(ra) # 5852 <exit>
...
0000000000001b86 <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1baa:	ca4080e7          	jalr	-860(ra) # 584a <fork>
    1bae:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bc6:	c98080e7          	jalr	-872(ra) # 585a <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c06:	c50080e7          	jalr	-944(ra) # 5852 <exit>
      name[0] = 'p' + pi;
    ...
    1c32:	c24080e7          	jalr	-988(ra) # 5852 <exit>
      for(i = 0; i < N; i++){
    ...
    1c50:	c46080e7          	jalr	-954(ra) # 5892 <open>
        if(fd < 0){
    1c54:	fc0543e3          	bltz	a0,1c1a <createdelete+0x94>
        close(fd);
    1c58:	00004097          	auipc	ra,0x4
    1c5c:	c22080e7          	jalr	-990(ra) # 587a <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1c84:	c22080e7          	jalr	-990(ra) # 58a2 <unlink>
    ...
    1ca4:	bb2080e7          	jalr	-1102(ra) # 5852 <exit>
      exit(0);
    1ca8:	4501                	li	a0,0
    1caa:	00004097          	auipc	ra,0x4
    1cae:	ba8080e7          	jalr	-1112(ra) # 5852 <exit>
      exit(1);
    1cb2:	4505                	li	a0,1
    1cb4:	00004097          	auipc	ra,0x4
    1cb8:	b9e080e7          	jalr	-1122(ra) # 5852 <exit>
    ...
    1cd8:	b7e080e7          	jalr	-1154(ra) # 5852 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1d00:	b96080e7          	jalr	-1130(ra) # 5892 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1d18:	b66080e7          	jalr	-1178(ra) # 587a <close>
    ...
    1d3e:	b18080e7          	jalr	-1256(ra) # 5852 <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1d78:	b2e080e7          	jalr	-1234(ra) # 58a2 <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd4:	ad2080e7          	jalr	-1326(ra) # 58a2 <unlink>
  pid = fork();
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	a72080e7          	jalr	-1422(ra) # 584a <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	a28080e7          	jalr	-1496(ra) # 5852 <exit>
      close(open("x", O_RDWR | O_CREATE));
    1e32:	20200593          	li	a1,514
    1e36:	8556                	mv	a0,s5
    1e38:	00004097          	auipc	ra,0x4
    1e3c:	a5a080e7          	jalr	-1446(ra) # 5892 <open>
    1e40:	00004097          	auipc	ra,0x4
    1e44:	a3a080e7          	jalr	-1478(ra) # 587a <close>
  for(i = 0; i < 100; i++){
    ...
    1e68:	a3e080e7          	jalr	-1474(ra) # 58a2 <unlink>
    1e6c:	bff1                	j	1e48 <linkunlink+0x9c>
      link("cat", "x");
    1e6e:	85d6                	mv	a1,s5
    1e70:	855e                	mv	a0,s7
    1e72:	00004097          	auipc	ra,0x4
    1e76:	a40080e7          	jalr	-1472(ra) # 58b2 <link>
  ...
  if(pid)
    ...
    1e86:	9d8080e7          	jalr	-1576(ra) # 585a <wait>
}
    ...
    1eaa:	9ac080e7          	jalr	-1620(ra) # 5852 <exit>
...
0000000000001eae <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ece:	980080e7          	jalr	-1664(ra) # 584a <fork>
    1ed2:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1eee:	970080e7          	jalr	-1680(ra) # 585a <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    1f02:	954080e7          	jalr	-1708(ra) # 5852 <exit>
      printf("fork failed\n");
    ...
    1f1c:	93a080e7          	jalr	-1734(ra) # 5852 <exit>
      name[0] = 'b';
    ...
    1f3c:	96a080e7          	jalr	-1686(ra) # 58a2 <unlink>
    1f40:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    ...
    1f5c:	93a080e7          	jalr	-1734(ra) # 5892 <open>
    1f60:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    1f6e:	908080e7          	jalr	-1784(ra) # 5872 <write>
          if(cc != sz){
    ...
    1f7e:	900080e7          	jalr	-1792(ra) # 587a <close>
        for(int i = 0; i < ci+1; i++){
    ...
    1f90:	916080e7          	jalr	-1770(ra) # 58a2 <unlink>
    ...
    1fa2:	904080e7          	jalr	-1788(ra) # 58a2 <unlink>
      exit(0);
    1fa6:	4501                	li	a0,0
    1fa8:	00004097          	auipc	ra,0x4
    1fac:	8aa080e7          	jalr	-1878(ra) # 5852 <exit>
    ...
    1fcc:	88a080e7          	jalr	-1910(ra) # 5852 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1fd0:	86aa                	mv	a3,a0
    ...
    1fec:	86a080e7          	jalr	-1942(ra) # 5852 <exit>
      exit(st);
    1ff0:	00004097          	auipc	ra,0x4
    1ff4:	862080e7          	jalr	-1950(ra) # 5852 <exit>
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2012:	83c080e7          	jalr	-1988(ra) # 584a <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    203a:	81c080e7          	jalr	-2020(ra) # 5852 <exit>
      exit(0);
    203e:	00004097          	auipc	ra,0x4
    2042:	814080e7          	jalr	-2028(ra) # 5852 <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    205a:	804080e7          	jalr	-2044(ra) # 585a <wait>
  ...
  if(wait(0) != -1){
    ...
    206c:	7f2080e7          	jalr	2034(ra) # 585a <wait>
    2070:	57fd                	li	a5,-1
    ...
    209c:	7ba080e7          	jalr	1978(ra) # 5852 <exit>
    ...
    20b8:	79e080e7          	jalr	1950(ra) # 5852 <exit>
    ...
    20d4:	782080e7          	jalr	1922(ra) # 5852 <exit>
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2106:	748080e7          	jalr	1864(ra) # 584a <fork>
    if(pid < 0){
    ...
    2118:	746080e7          	jalr	1862(ra) # 585a <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2154:	702080e7          	jalr	1794(ra) # 5852 <exit>
    ...
    2176:	6e0080e7          	jalr	1760(ra) # 5852 <exit>
      exit(1);
    217a:	4505                	li	a0,1
    217c:	00003097          	auipc	ra,0x3
    2180:	6d6080e7          	jalr	1750(ra) # 5852 <exit>
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21a6:	6a8080e7          	jalr	1704(ra) # 584a <fork>
    if(pid < 0){
    ...
    21b8:	6a6080e7          	jalr	1702(ra) # 585a <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    21f8:	65e080e7          	jalr	1630(ra) # 5852 <exit>
      *(char*)a = 99;
    ...
    2224:	632080e7          	jalr	1586(ra) # 5852 <exit>
      exit(1);
    2228:	4505                	li	a0,1
    222a:	00003097          	auipc	ra,0x3
    222e:	628080e7          	jalr	1576(ra) # 5852 <exit>
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    224a:	65c080e7          	jalr	1628(ra) # 58a2 <unlink>
  pid = fork();
    224e:	00003097          	auipc	ra,0x3
    2252:	5fc080e7          	jalr	1532(ra) # 584a <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    2264:	5fa080e7          	jalr	1530(ra) # 585a <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    227c:	61a080e7          	jalr	1562(ra) # 5892 <open>
  if(fd < 0){
    2280:	08054e63          	bltz	a0,231c <bigargtest+0xea>
  close(fd);
    2284:	00003097          	auipc	ra,0x3
    2288:	5f6080e7          	jalr	1526(ra) # 587a <close>
}
    ...
    22ce:	5c0080e7          	jalr	1472(ra) # 588a <exec>
    ...
    22e2:	5b4080e7          	jalr	1460(ra) # 5892 <open>
    close(fd);
    22e6:	00003097          	auipc	ra,0x3
    22ea:	594080e7          	jalr	1428(ra) # 587a <close>
    exit(0);
    22ee:	4501                	li	a0,0
    22f0:	00003097          	auipc	ra,0x3
    22f4:	562080e7          	jalr	1378(ra) # 5852 <exit>
    ...
    2310:	546080e7          	jalr	1350(ra) # 5852 <exit>
    exit(xstatus);
    2314:	00003097          	auipc	ra,0x3
    2318:	53e080e7          	jalr	1342(ra) # 5852 <exit>
    ...
    2334:	522080e7          	jalr	1314(ra) # 5852 <exit>
...
0000000000002338 <stacktest>:
{
  ...
  pid = fork();
    ...
    2348:	506080e7          	jalr	1286(ra) # 584a <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    235a:	504080e7          	jalr	1284(ra) # 585a <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    236c:	4ea080e7          	jalr	1258(ra) # 5852 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2392:	4c4080e7          	jalr	1220(ra) # 5852 <exit>
    printf("%s: fork failed\n", s);
    2396:	85a6                	mv	a1,s1
    ...
    23ae:	4a8080e7          	jalr	1192(ra) # 5852 <exit>
    exit(0);
    23b2:	4501                	li	a0,0
    23b4:	00003097          	auipc	ra,0x3
    23b8:	49e080e7          	jalr	1182(ra) # 5852 <exit>
...
00000000000023bc <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    23cc:	512080e7          	jalr	1298(ra) # 58da <sbrk>
  uint64 top = (uint64) sbrk(0);
    23d0:	4501                	li	a0,0
    23d2:	00003097          	auipc	ra,0x3
    23d6:	508080e7          	jalr	1288(ra) # 58da <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    23e6:	4f8080e7          	jalr	1272(ra) # 58da <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2402:	4a4080e7          	jalr	1188(ra) # 58a2 <unlink>
  if(ret != -1){
    2406:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2416:	480080e7          	jalr	1152(ra) # 5892 <open>
  if(fd != -1){
    241a:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    2428:	48e080e7          	jalr	1166(ra) # 58b2 <link>
  if(ret != -1){
    242c:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    244c:	442080e7          	jalr	1090(ra) # 588a <exec>
  if(ret != -1){
    2450:	57fd                	li	a5,-1
    ...
    246e:	470080e7          	jalr	1136(ra) # 58da <sbrk>
    ...
    248a:	3cc080e7          	jalr	972(ra) # 5852 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    248e:	862a                	mv	a2,a0
    2490:	85a6                	mv	a1,s1
    ...
    24a8:	3ae080e7          	jalr	942(ra) # 5852 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    24ac:	862a                	mv	a2,a0
    24ae:	85a6                	mv	a1,s1
    ...
    24c6:	390080e7          	jalr	912(ra) # 5852 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    24ca:	86aa                	mv	a3,a0
    24cc:	8626                	mv	a2,s1
    24ce:	85a6                	mv	a1,s1
    ...
    24e6:	370080e7          	jalr	880(ra) # 5852 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    24ea:	567d                	li	a2,-1
    24ec:	85a6                	mv	a1,s1
    ...
    2504:	352080e7          	jalr	850(ra) # 5852 <exit>
...
0000000000002508 <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    251a:	3c4080e7          	jalr	964(ra) # 58da <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    252c:	3b2080e7          	jalr	946(ra) # 58da <sbrk>
    2530:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2546:	350080e7          	jalr	848(ra) # 5892 <open>
    254a:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    255e:	318080e7          	jalr	792(ra) # 5872 <write>
    2562:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2580:	2d6080e7          	jalr	726(ra) # 5852 <exit>
    ...
    259a:	2bc080e7          	jalr	700(ra) # 5852 <exit>
    ...
    25b4:	2a2080e7          	jalr	674(ra) # 5852 <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    260c:	262080e7          	jalr	610(ra) # 586a <read>
    2610:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    262e:	228080e7          	jalr	552(ra) # 5852 <exit>
    printf("open(rwsbrk) failed\n");
    ...
    2648:	20e080e7          	jalr	526(ra) # 5852 <exit>
  close(fd);
    264c:	854a                	mv	a0,s2
    264e:	00003097          	auipc	ra,0x3
    2652:	22c080e7          	jalr	556(ra) # 587a <close>
  exit(0);
    2656:	4501                	li	a0,0
    2658:	00003097          	auipc	ra,0x3
    265c:	1fa080e7          	jalr	506(ra) # 5852 <exit>
...
0000000000002660 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    2676:	1d8080e7          	jalr	472(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2688:	256080e7          	jalr	598(ra) # 58da <sbrk>
    ...
    26ae:	1a8080e7          	jalr	424(ra) # 5852 <exit>
    ...
    26c8:	18e080e7          	jalr	398(ra) # 5852 <exit>
      exit(0);
    26cc:	4501                	li	a0,0
    26ce:	00003097          	auipc	ra,0x3
    26d2:	184080e7          	jalr	388(ra) # 5852 <exit>
  wait(&xstatus);
    26d6:	fcc40513          	addi	a0,s0,-52
    26da:	00003097          	auipc	ra,0x3
    26de:	180080e7          	jalr	384(ra) # 585a <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    26f2:	1ec080e7          	jalr	492(ra) # 58da <sbrk>
    26f6:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    26f8:	4901                	li	s2,0
    ...
    271a:	13c080e7          	jalr	316(ra) # 5852 <exit>
    a = b + 1;
    271e:	84be                	mv	s1,a5
    b = sbrk(1);
    2720:	4505                	li	a0,1
    2722:	00003097          	auipc	ra,0x3
    2726:	1b8080e7          	jalr	440(ra) # 58da <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    2742:	10c080e7          	jalr	268(ra) # 584a <fork>
    2746:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    2752:	18c080e7          	jalr	396(ra) # 58da <sbrk>
  c = sbrk(1);
    2756:	4505                	li	a0,1
    2758:	00003097          	auipc	ra,0x3
    275c:	182080e7          	jalr	386(ra) # 58da <sbrk>
  if(c != a + 1){
    ...
    277e:	0d8080e7          	jalr	216(ra) # 5852 <exit>
    ...
    27a0:	0b6080e7          	jalr	182(ra) # 5852 <exit>
...
00000000000027e6 <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    ...
    27fe:	0e0080e7          	jalr	224(ra) # 58da <sbrk>
    2802:	892a                	mv	s2,a0
  a = sbrk(0);
    2804:	4501                	li	a0,0
  ...
  p = sbrk(amt);
    ...
    281a:	0c4080e7          	jalr	196(ra) # 58da <sbrk>
  if (p != a) {
    281e:	0ca49863          	bne	s1,a0,28ee <sbrkmuch+0x108>
  char *eee = sbrk(0);
    2822:	4501                	li	a0,0
    2824:	00003097          	auipc	ra,0x3
    2828:	0b6080e7          	jalr	182(ra) # 58da <sbrk>
    282c:	87aa                	mv	a5,a0
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2852:	08c080e7          	jalr	140(ra) # 58da <sbrk>
    2856:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2858:	757d                	lui	a0,0xfffff
    285a:	00003097          	auipc	ra,0x3
    285e:	080080e7          	jalr	128(ra) # 58da <sbrk>
  ...
  c = sbrk(0);
    ...
    286e:	070080e7          	jalr	112(ra) # 58da <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    28be:	020080e7          	jalr	32(ra) # 58da <sbrk>
    28c2:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    28c4:	4501                	li	a0,0
    28c6:	00003097          	auipc	ra,0x3
    28ca:	014080e7          	jalr	20(ra) # 58da <sbrk>
    28ce:	40a9053b          	subw	a0,s2,a0
    28d2:	00003097          	auipc	ra,0x3
    28d6:	008080e7          	jalr	8(ra) # 58da <sbrk>
  if(c != a){
    ...
    2906:	f50080e7          	jalr	-176(ra) # 5852 <exit>
    ...
    2922:	f34080e7          	jalr	-204(ra) # 5852 <exit>
    ...
    2942:	f14080e7          	jalr	-236(ra) # 5852 <exit>
    ...
    2962:	ef4080e7          	jalr	-268(ra) # 5852 <exit>
    ...
    297e:	ed8080e7          	jalr	-296(ra) # 5852 <exit>
    ...
    299e:	eb8080e7          	jalr	-328(ra) # 5852 <exit>
...
00000000000029a2 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    29b8:	f26080e7          	jalr	-218(ra) # 58da <sbrk>
    29bc:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    29f2:	e84080e7          	jalr	-380(ra) # 5872 <write>
    29f6:	04054663          	bltz	a0,2a42 <sbrkarg+0xa0>
  close(fd);
    29fa:	8526                	mv	a0,s1
    29fc:	00003097          	auipc	ra,0x3
    2a00:	e7e080e7          	jalr	-386(ra) # 587a <close>
  a = sbrk(PGSIZE);
    2a04:	6505                	lui	a0,0x1
    2a06:	00003097          	auipc	ra,0x3
    2a0a:	ed4080e7          	jalr	-300(ra) # 58da <sbrk>
  if(pipe((int *) a) != 0){
    2a0e:	00003097          	auipc	ra,0x3
    2a12:	e54080e7          	jalr	-428(ra) # 5862 <pipe>
    ...
    2a3e:	e18080e7          	jalr	-488(ra) # 5852 <exit>
    ...
    2a76:	de0080e7          	jalr	-544(ra) # 5852 <exit>
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	e00080e7          	jalr	-512(ra) # 5892 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2aa6:	e38080e7          	jalr	-456(ra) # 58da <sbrk>
    2aaa:	567d                	li	a2,-1
    2aac:	fff50593          	addi	a1,a0,-1
    2ab0:	8526                	mv	a0,s1
    2ab2:	00003097          	auipc	ra,0x3
    2ab6:	db8080e7          	jalr	-584(ra) # 586a <read>
  close(fd);
    2aba:	8526                	mv	a0,s1
    2abc:	00003097          	auipc	ra,0x3
    2ac0:	dbe080e7          	jalr	-578(ra) # 587a <close>
}
    ...
    2ae8:	d6e080e7          	jalr	-658(ra) # 5852 <exit>
...
0000000000002aec <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2af8:	d56080e7          	jalr	-682(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b06:	dd8080e7          	jalr	-552(ra) # 58da <sbrk>
    sbrk(-sz);
    2b0a:	40a0053b          	negw	a0,a0
    2b0e:	00003097          	auipc	ra,0x3
    2b12:	dcc080e7          	jalr	-564(ra) # 58da <sbrk>
    exit(0);
    2b16:	4501                	li	a0,0
    2b18:	00003097          	auipc	ra,0x3
    2b1c:	d3a080e7          	jalr	-710(ra) # 5852 <exit>
    printf("fork failed\n");
    ...
    2b36:	d20080e7          	jalr	-736(ra) # 5852 <exit>
  wait(0);
    2b3a:	4501                	li	a0,0
    2b3c:	00003097          	auipc	ra,0x3
    2b40:	d1e080e7          	jalr	-738(ra) # 585a <wait>
  pid = fork();
    2b44:	00003097          	auipc	ra,0x3
    2b48:	d06080e7          	jalr	-762(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b8c:	cca080e7          	jalr	-822(ra) # 5852 <exit>
  wait(0);
    2b90:	4501                	li	a0,0
    2b92:	00003097          	auipc	ra,0x3
    2b96:	cc8080e7          	jalr	-824(ra) # 585a <wait>
  pid = fork();
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	cb0080e7          	jalr	-848(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2bac:	d32080e7          	jalr	-718(ra) # 58da <sbrk>
    ...
    2bc8:	d16080e7          	jalr	-746(ra) # 58da <sbrk>
    exit(0);
    2bcc:	4501                	li	a0,0
    2bce:	00003097          	auipc	ra,0x3
    2bd2:	c84080e7          	jalr	-892(ra) # 5852 <exit>
    printf("fork failed\n");
    ...
    2bec:	c6a080e7          	jalr	-918(ra) # 5852 <exit>
  wait(0);
    2bf0:	4501                	li	a0,0
    2bf2:	00003097          	auipc	ra,0x3
    2bf6:	c68080e7          	jalr	-920(ra) # 585a <wait>
  exit(0);
    2bfa:	4501                	li	a0,0
...
0000000000002c04 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2c1a:	cc4080e7          	jalr	-828(ra) # 58da <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(10);
    ...
    2c34:	caa080e7          	jalr	-854(ra) # 58da <sbrk>
  sbrk(-20);
    2c38:	5531                	li	a0,-20
    2c3a:	00003097          	auipc	ra,0x3
    2c3e:	ca0080e7          	jalr	-864(ra) # 58da <sbrk>
  top = (uint64) sbrk(0);
    2c42:	4501                	li	a0,0
    2c44:	00003097          	auipc	ra,0x3
    2c48:	c96080e7          	jalr	-874(ra) # 58da <sbrk>
    2c4c:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2c68:	c2e080e7          	jalr	-978(ra) # 5892 <open>
    2c6c:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2c6e:	4605                	li	a2,1
    2c70:	85ca                	mv	a1,s2
    2c72:	00003097          	auipc	ra,0x3
    2c76:	c00080e7          	jalr	-1024(ra) # 5872 <write>
  close(fd);
    2c7a:	854e                	mv	a0,s3
    2c7c:	00003097          	auipc	ra,0x3
    2c80:	bfe080e7          	jalr	-1026(ra) # 587a <close>
  fd = open(p, O_RDWR);
    2c84:	4589                	li	a1,2
    2c86:	854a                	mv	a0,s2
    2c88:	00003097          	auipc	ra,0x3
    2c8c:	c0a080e7          	jalr	-1014(ra) # 5892 <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2c9c:	bd2080e7          	jalr	-1070(ra) # 586a <read>
  if(p[0] != 'x')
    ...
    2cc6:	c18080e7          	jalr	-1000(ra) # 58da <sbrk>
    2cca:	bfa9                	j	2c24 <sbrklast+0x20>
    exit(1);
    2ccc:	4505                	li	a0,1
    2cce:	00003097          	auipc	ra,0x3
    2cd2:	b84080e7          	jalr	-1148(ra) # 5852 <exit>
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce8:	bf6080e7          	jalr	-1034(ra) # 58da <sbrk>
  volatile char *top = sbrk(0);
    2cec:	4501                	li	a0,0
    2cee:	00003097          	auipc	ra,0x3
    2cf2:	bec080e7          	jalr	-1044(ra) # 58da <sbrk>
  *(top-1) = *(top-1) + 1;
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2d24:	b2a080e7          	jalr	-1238(ra) # 584a <fork>
    2d28:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2d36:	b28080e7          	jalr	-1240(ra) # 585a <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2d46:	b10080e7          	jalr	-1264(ra) # 5852 <exit>
      printf("fork failed\n");
    ...
    2d60:	af6080e7          	jalr	-1290(ra) # 5852 <exit>
        if(a == 0xffffffffffffffffLL)
    2d64:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2d66:	4a05                	li	s4,1
    ...
    2d6e:	b70080e7          	jalr	-1168(ra) # 58da <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2d8a:	b54080e7          	jalr	-1196(ra) # 58da <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2d9a:	ae4080e7          	jalr	-1308(ra) # 587a <close>
      char *args[] = { "echo", "x", 0 };
    ...
    2dc2:	acc080e7          	jalr	-1332(ra) # 588a <exec>
      exit(0);
    2dc6:	4501                	li	a0,0
    2dc8:	00003097          	auipc	ra,0x3
    2dcc:	a8a080e7          	jalr	-1398(ra) # 5852 <exit>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	ad6080e7          	jalr	-1322(ra) # 58ba <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	ac4080e7          	jalr	-1340(ra) # 58ba <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	a62080e7          	jalr	-1438(ra) # 58ba <mkdir>
  ...
  unlink("12345678901234");
    ...
    2f00:	956080e7          	jalr	-1706(ra) # 5852 <exit>
    ...
    2f1c:	93a080e7          	jalr	-1734(ra) # 5852 <exit>
    ...
    2f38:	91e080e7          	jalr	-1762(ra) # 5852 <exit>
    ...
    2f54:	902080e7          	jalr	-1790(ra) # 5852 <exit>
    ...
    2f70:	8e6080e7          	jalr	-1818(ra) # 5852 <exit>
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	932080e7          	jalr	-1742(ra) # 58ba <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	926080e7          	jalr	-1754(ra) # 58c2 <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	8f2080e7          	jalr	-1806(ra) # 58a2 <unlink>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	8fe080e7          	jalr	-1794(ra) # 58c2 <chdir>
    ...
    2ff2:	864080e7          	jalr	-1948(ra) # 5852 <exit>
    ...
    300e:	848080e7          	jalr	-1976(ra) # 5852 <exit>
    ...
    302a:	82c080e7          	jalr	-2004(ra) # 5852 <exit>
    ...
    3046:	810080e7          	jalr	-2032(ra) # 5852 <exit>
...
000000000000304a <exitiputtest>:
{
  ...
  pid = fork();
    ...
    305a:	7f4080e7          	jalr	2036(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3070:	84e080e7          	jalr	-1970(ra) # 58ba <mkdir>
    ...
    3084:	842080e7          	jalr	-1982(ra) # 58c2 <chdir>
    ...
    3098:	80e080e7          	jalr	-2034(ra) # 58a2 <unlink>
    309c:	06054163          	bltz	a0,30fe <exitiputtest+0xb4>
    exit(0);
    30a0:	4501                	li	a0,0
    30a2:	00002097          	auipc	ra,0x2
    30a6:	7b0080e7          	jalr	1968(ra) # 5852 <exit>
    printf("%s: fork failed\n", s);
    30aa:	85a6                	mv	a1,s1
    ...
    30c2:	794080e7          	jalr	1940(ra) # 5852 <exit>
      printf("%s: mkdir failed\n", s);
    30c6:	85a6                	mv	a1,s1
    ...
    30de:	778080e7          	jalr	1912(ra) # 5852 <exit>
    ...
    30fa:	75c080e7          	jalr	1884(ra) # 5852 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    30fe:	85a6                	mv	a1,s1
    ...
    3116:	740080e7          	jalr	1856(ra) # 5852 <exit>
  wait(&xstatus);
    311a:	fdc40513          	addi	a0,s0,-36
    311e:	00002097          	auipc	ra,0x2
    3122:	73c080e7          	jalr	1852(ra) # 585a <wait>
  exit(xstatus);
    3126:	fdc42503          	lw	a0,-36(s0)
    312a:	00002097          	auipc	ra,0x2
    312e:	728080e7          	jalr	1832(ra) # 5852 <exit>
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	774080e7          	jalr	1908(ra) # 58ba <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	768080e7          	jalr	1896(ra) # 58c2 <chdir>
  ...
  if(chdir("..") < 0){
    ...
    3172:	754080e7          	jalr	1876(ra) # 58c2 <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	720080e7          	jalr	1824(ra) # 58a2 <unlink>
    ...
    31b0:	6a6080e7          	jalr	1702(ra) # 5852 <exit>
    ...
    31cc:	68a080e7          	jalr	1674(ra) # 5852 <exit>
    printf("%s: chdir .. failed\n", s);
    31d0:	85a6                	mv	a1,s1
    ...
    31e8:	66e080e7          	jalr	1646(ra) # 5852 <exit>
    ...
    3204:	652080e7          	jalr	1618(ra) # 5852 <exit>
...
0000000000003208 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	64c080e7          	jalr	1612(ra) # 5892 <open>
    324e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	62e080e7          	jalr	1582(ra) # 58ba <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	5ee080e7          	jalr	1518(ra) # 5892 <open>
    32ac:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	57a080e7          	jalr	1402(ra) # 586a <read>
  if(cc != 2 || buf[0] != 'f'){
    32f8:	4789                	li	a5,2
  ...
  close(fd);
    ...
    3314:	56a080e7          	jalr	1386(ra) # 587a <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    332c:	58a080e7          	jalr	1418(ra) # 58b2 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	566080e7          	jalr	1382(ra) # 58a2 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	540080e7          	jalr	1344(ra) # 5892 <open>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	55c080e7          	jalr	1372(ra) # 58c2 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	548080e7          	jalr	1352(ra) # 58c2 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	534080e7          	jalr	1332(ra) # 58c2 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	520080e7          	jalr	1312(ra) # 58c2 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	4da080e7          	jalr	1242(ra) # 5892 <open>
    33c0:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	488080e7          	jalr	1160(ra) # 5892 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	470080e7          	jalr	1136(ra) # 5892 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	458080e7          	jalr	1112(ra) # 5892 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	442080e7          	jalr	1090(ra) # 5892 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	42c080e7          	jalr	1068(ra) # 5892 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3486:	430080e7          	jalr	1072(ra) # 58b2 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34a2:	414080e7          	jalr	1044(ra) # 58b2 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34be:	3f8080e7          	jalr	1016(ra) # 58b2 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	3ec080e7          	jalr	1004(ra) # 58ba <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	3d8080e7          	jalr	984(ra) # 58ba <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	3c4080e7          	jalr	964(ra) # 58ba <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	398080e7          	jalr	920(ra) # 58a2 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	384080e7          	jalr	900(ra) # 58a2 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	390080e7          	jalr	912(ra) # 58c2 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	37c080e7          	jalr	892(ra) # 58c2 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	348080e7          	jalr	840(ra) # 58a2 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	334080e7          	jalr	820(ra) # 58a2 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	320080e7          	jalr	800(ra) # 58a2 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	30c080e7          	jalr	780(ra) # 58a2 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	2f8080e7          	jalr	760(ra) # 58a2 <unlink>
    ...
    35da:	27c080e7          	jalr	636(ra) # 5852 <exit>
    ...
    35f6:	260080e7          	jalr	608(ra) # 5852 <exit>
    ...
    3612:	244080e7          	jalr	580(ra) # 5852 <exit>
    ...
    362e:	228080e7          	jalr	552(ra) # 5852 <exit>
    ...
    364a:	20c080e7          	jalr	524(ra) # 5852 <exit>
    ...
    3666:	1f0080e7          	jalr	496(ra) # 5852 <exit>
    ...
    3682:	1d4080e7          	jalr	468(ra) # 5852 <exit>
    ...
    369e:	1b8080e7          	jalr	440(ra) # 5852 <exit>
    ...
    36ba:	19c080e7          	jalr	412(ra) # 5852 <exit>
    ...
    36d6:	180080e7          	jalr	384(ra) # 5852 <exit>
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	ed8080e7          	jalr	-296(ra) # 58ba <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	ece080e7          	jalr	-306(ra) # 58c2 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	e9c080e7          	jalr	-356(ra) # 58a2 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	e8a080e7          	jalr	-374(ra) # 58a2 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	e98080e7          	jalr	-360(ra) # 58c2 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	e66080e7          	jalr	-410(ra) # 58a2 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	e54080e7          	jalr	-428(ra) # 58a2 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	e42080e7          	jalr	-446(ra) # 58a2 <unlink>
    ...
    3a8c:	dca080e7          	jalr	-566(ra) # 5852 <exit>
    ...
    3aa8:	dae080e7          	jalr	-594(ra) # 5852 <exit>
    printf("%s: rm . worked!\n", s);
    3aac:	85a6                	mv	a1,s1
    ...
    3ac4:	d92080e7          	jalr	-622(ra) # 5852 <exit>
    printf("%s: rm .. worked!\n", s);
    3ac8:	85a6                	mv	a1,s1
    ...
    3ae0:	d76080e7          	jalr	-650(ra) # 5852 <exit>
    printf("%s: chdir / failed\n", s);
    3ae4:	85a6                	mv	a1,s1
    ...
    3afc:	d5a080e7          	jalr	-678(ra) # 5852 <exit>
    ...
    3b18:	d3e080e7          	jalr	-706(ra) # 5852 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3b1c:	85a6                	mv	a1,s1
    ...
    3b34:	d22080e7          	jalr	-734(ra) # 5852 <exit>
    ...
    3b50:	d06080e7          	jalr	-762(ra) # 5852 <exit>
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	cf4080e7          	jalr	-780(ra) # 5892 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	cdc080e7          	jalr	-804(ra) # 5892 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	cf0080e7          	jalr	-784(ra) # 58ba <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	cc4080e7          	jalr	-828(ra) # 58a2 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bfe:	cb8080e7          	jalr	-840(ra) # 58b2 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	c94080e7          	jalr	-876(ra) # 58a2 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	c6e080e7          	jalr	-914(ra) # 5892 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    3c3e:	c58080e7          	jalr	-936(ra) # 5892 <open>
    3c42:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3c44:	4605                	li	a2,1
    ...
    3c52:	c24080e7          	jalr	-988(ra) # 5872 <write>
    3c56:	10a04b63          	bgtz	a0,3d6c <dirfile+0x218>
  close(fd);
    3c5a:	8526                	mv	a0,s1
    3c5c:	00002097          	auipc	ra,0x2
    3c60:	c1e080e7          	jalr	-994(ra) # 587a <close>
}
    ...
    3c88:	bce080e7          	jalr	-1074(ra) # 5852 <exit>
    ...
    3ca4:	bb2080e7          	jalr	-1102(ra) # 5852 <exit>
    ...
    3cc0:	b96080e7          	jalr	-1130(ra) # 5852 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3cc4:	85ca                	mv	a1,s2
    ...
    3cdc:	b7a080e7          	jalr	-1158(ra) # 5852 <exit>
    ...
    3cf8:	b5e080e7          	jalr	-1186(ra) # 5852 <exit>
    ...
    3d14:	b42080e7          	jalr	-1214(ra) # 5852 <exit>
    ...
    3d30:	b26080e7          	jalr	-1242(ra) # 5852 <exit>
    ...
    3d4c:	b0a080e7          	jalr	-1270(ra) # 5852 <exit>
    ...
    3d68:	aee080e7          	jalr	-1298(ra) # 5852 <exit>
    ...
    3d84:	ad2080e7          	jalr	-1326(ra) # 5852 <exit>
...
0000000000003d88 <iref>:
{
    ...
    3ddc:	a7a080e7          	jalr	-1414(ra) # 5852 <exit>
    ...
    3df8:	a5e080e7          	jalr	-1442(ra) # 5852 <exit>
      close(fd);
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	a7e080e7          	jalr	-1410(ra) # 587a <close>
    3e04:	a889                	j	3e56 <iref+0xce>
    unlink("xx");
    3e06:	854e                	mv	a0,s3
    3e08:	00002097          	auipc	ra,0x2
    3e0c:	a9a080e7          	jalr	-1382(ra) # 58a2 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e60:	a36080e7          	jalr	-1482(ra) # 5892 <open>
    if(fd >= 0)
    3e64:	fa0541e3          	bltz	a0,3e06 <iref+0x7e>
      close(fd);
    3e68:	00002097          	auipc	ra,0x2
    3e6c:	a12080e7          	jalr	-1518(ra) # 587a <close>
    ...
    3e8c:	a3a080e7          	jalr	-1478(ra) # 58c2 <chdir>
    unlink("irefd");
    3e90:	854a                	mv	a0,s2
    3e92:	00002097          	auipc	ra,0x2
    3e96:	a10080e7          	jalr	-1520(ra) # 58a2 <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    3eaa:	a1c080e7          	jalr	-1508(ra) # 58c2 <chdir>
}
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	9e4080e7          	jalr	-1564(ra) # 58ba <mkdir>
    3ede:	04054263          	bltz	a0,3f22 <openiputtest+0x60>
  pid = fork();
    3ee2:	00002097          	auipc	ra,0x2
    3ee6:	968080e7          	jalr	-1688(ra) # 584a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3efe:	998080e7          	jalr	-1640(ra) # 5892 <open>
    if(fd >= 0){
    ...
    3f1e:	938080e7          	jalr	-1736(ra) # 5852 <exit>
    ...
    3f3a:	91c080e7          	jalr	-1764(ra) # 5852 <exit>
    printf("%s: fork failed\n", s);
    3f3e:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    3f98:	8be080e7          	jalr	-1858(ra) # 5852 <exit>
  wait(&xstatus);
    3f9c:	fdc40513          	addi	a0,s0,-36
    3fa0:	00002097          	auipc	ra,0x2
    3fa4:	8ba080e7          	jalr	-1862(ra) # 585a <wait>
  exit(xstatus);
    3fa8:	fdc42503          	lw	a0,-36(s0)
    3fac:	00002097          	auipc	ra,0x2
    3fb0:	8a6080e7          	jalr	-1882(ra) # 5852 <exit>
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	8da080e7          	jalr	-1830(ra) # 58a2 <unlink>
  int pid = fork();
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	87a080e7          	jalr	-1926(ra) # 584a <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    3fe4:	902080e7          	jalr	-1790(ra) # 58e2 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	89e080e7          	jalr	-1890(ra) # 5892 <open>
    3ffc:	00002097          	auipc	ra,0x2
    4000:	87e080e7          	jalr	-1922(ra) # 587a <close>
  wait(0);
    4004:	4501                	li	a0,0
    4006:	00002097          	auipc	ra,0x2
    400a:	854080e7          	jalr	-1964(ra) # 585a <wait>
  sleep(10); // one second
    400e:	4529                	li	a0,10
    4010:	00002097          	auipc	ra,0x2
    4014:	8d2080e7          	jalr	-1838(ra) # 58e2 <sleep>
}
    ...
    403a:	81c080e7          	jalr	-2020(ra) # 5852 <exit>
...
0000000000004084 <killstatus>:
{
    ...
    40a0:	7ae080e7          	jalr	1966(ra) # 584a <fork>
    40a4:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    40b2:	834080e7          	jalr	-1996(ra) # 58e2 <sleep>
    kill(pid1);
    40b6:	8526                	mv	a0,s1
    40b8:	00001097          	auipc	ra,0x1
    40bc:	7ca080e7          	jalr	1994(ra) # 5882 <kill>
    wait(&xst);
    40c0:	fcc40513          	addi	a0,s0,-52
    40c4:	00001097          	auipc	ra,0x1
    40c8:	796080e7          	jalr	1942(ra) # 585a <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    40e0:	776080e7          	jalr	1910(ra) # 5852 <exit>
      printf("%s: fork failed\n", s);
    40e4:	85d2                	mv	a1,s4
    ...
    40fc:	75a080e7          	jalr	1882(ra) # 5852 <exit>
        getpid();
    4100:	00001097          	auipc	ra,0x1
    4104:	7d2080e7          	jalr	2002(ra) # 58d2 <getpid>
      while(1) {
    ...
    4122:	734080e7          	jalr	1844(ra) # 5852 <exit>
...
0000000000004126 <preempt>:
{
  ...
  pid1 = fork();
    ...
    413c:	712080e7          	jalr	1810(ra) # 584a <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    4162:	6f4080e7          	jalr	1780(ra) # 5852 <exit>
  pid2 = fork();
    4166:	00001097          	auipc	ra,0x1
    416a:	6e4080e7          	jalr	1764(ra) # 584a <fork>
    416e:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4190:	6c6080e7          	jalr	1734(ra) # 5852 <exit>
  pipe(pfds);
    4194:	fc840513          	addi	a0,s0,-56
    4198:	00001097          	auipc	ra,0x1
    419c:	6ca080e7          	jalr	1738(ra) # 5862 <pipe>
  pid3 = fork();
    41a0:	00001097          	auipc	ra,0x1
    41a4:	6aa080e7          	jalr	1706(ra) # 584a <fork>
    41a8:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    41b8:	6c6080e7          	jalr	1734(ra) # 587a <close>
    ...
    41fe:	658080e7          	jalr	1624(ra) # 5852 <exit>
  ...
  close(pfds[1]);
    ...
    421e:	660080e7          	jalr	1632(ra) # 587a <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4234:	63a080e7          	jalr	1594(ra) # 586a <read>
    4238:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    4268:	616080e7          	jalr	1558(ra) # 587a <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    4282:	604080e7          	jalr	1540(ra) # 5882 <kill>
  kill(pid2);
    4286:	854e                	mv	a0,s3
    4288:	00001097          	auipc	ra,0x1
    428c:	5fa080e7          	jalr	1530(ra) # 5882 <kill>
  kill(pid3);
    4290:	8552                	mv	a0,s4
    4292:	00001097          	auipc	ra,0x1
    4296:	5f0080e7          	jalr	1520(ra) # 5882 <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    42b0:	5ae080e7          	jalr	1454(ra) # 585a <wait>
  wait(0);
    42b4:	4501                	li	a0,0
    42b6:	00001097          	auipc	ra,0x1
    42ba:	5a4080e7          	jalr	1444(ra) # 585a <wait>
  wait(0);
    42be:	4501                	li	a0,0
    42c0:	00001097          	auipc	ra,0x1
    42c4:	59a080e7          	jalr	1434(ra) # 585a <wait>
...
00000000000042ca <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    42e0:	5f6080e7          	jalr	1526(ra) # 58d2 <getpid>
    42e4:	8a2a                	mv	s4,a0
    42e6:	0c800913          	li	s2,200
    int pid = fork();
    42ea:	00001097          	auipc	ra,0x1
    42ee:	560080e7          	jalr	1376(ra) # 584a <fork>
    42f2:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4300:	55e080e7          	jalr	1374(ra) # 585a <wait>
  ...
  exit(0);
    ...
    4314:	542080e7          	jalr	1346(ra) # 5852 <exit>
      printf("%s: fork failed\n", s);
    4318:	85ce                	mv	a1,s3
    ...
    4330:	526080e7          	jalr	1318(ra) # 5852 <exit>
        printf("%s: wait wrong pid\n", s);
    4334:	85ce                	mv	a1,s3
    ...
    434c:	50a080e7          	jalr	1290(ra) # 5852 <exit>
      int pid2 = fork();
    4350:	00001097          	auipc	ra,0x1
    4354:	4fa080e7          	jalr	1274(ra) # 584a <fork>
      if(pid2 < 0){
    4358:	00054763          	bltz	a0,4366 <reparent+0x9c>
      exit(0);
    435c:	4501                	li	a0,0
    435e:	00001097          	auipc	ra,0x1
    4362:	4f4080e7          	jalr	1268(ra) # 5852 <exit>
        kill(master_pid);
    4366:	8552                	mv	a0,s4
    4368:	00001097          	auipc	ra,0x1
    436c:	51a080e7          	jalr	1306(ra) # 5882 <kill>
        exit(1);
    4370:	4505                	li	a0,1
    4372:	00001097          	auipc	ra,0x1
    4376:	4e0080e7          	jalr	1248(ra) # 5852 <exit>
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4396:	4d0080e7          	jalr	1232(ra) # 5862 <pipe>
    ...
    43f0:	486080e7          	jalr	1158(ra) # 5872 <write>
      for(;;) sleep(1000);
    43f4:	3e800513          	li	a0,1000
    43f8:	00001097          	auipc	ra,0x1
    43fc:	4ea080e7          	jalr	1258(ra) # 58e2 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    440c:	442080e7          	jalr	1090(ra) # 584a <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    444e:	438080e7          	jalr	1080(ra) # 5882 <kill>
    wait(0);
    4452:	4501                	li	a0,0
    4454:	00001097          	auipc	ra,0x1
    4458:	406080e7          	jalr	1030(ra) # 585a <wait>
  ...
  pid = fork();
    ...
    4468:	3e6080e7          	jalr	998(ra) # 584a <fork>
    446c:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    447c:	3e2080e7          	jalr	994(ra) # 585a <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    44ba:	39c080e7          	jalr	924(ra) # 5852 <exit>
    printf("%s: fork failed\n", s);
    44be:	85d6                	mv	a1,s5
    ...
    44d6:	380080e7          	jalr	896(ra) # 5852 <exit>
    a = sbrk(0);
    44da:	4501                	li	a0,0
    44dc:	00001097          	auipc	ra,0x1
    44e0:	3fe080e7          	jalr	1022(ra) # 58da <sbrk>
    44e4:	892a                	mv	s2,a0
    sbrk(10*BIG);
    44e6:	3e800537          	lui	a0,0x3e800
    44ea:	00001097          	auipc	ra,0x1
    44ee:	3f0080e7          	jalr	1008(ra) # 58da <sbrk>
    ...
    4522:	334080e7          	jalr	820(ra) # 5852 <exit>
    exit(1);
    4526:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4544:	30a080e7          	jalr	778(ra) # 584a <fork>
    m1 = 0;
    4548:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    455a:	304080e7          	jalr	772(ra) # 585a <wait>
    if(xstatus == -1){
    ...
    456c:	2ea080e7          	jalr	746(ra) # 5852 <exit>
      *(char**)m2 = m1;
    ...
    45aa:	2ac080e7          	jalr	684(ra) # 5852 <exit>
    ...
    45c6:	290080e7          	jalr	656(ra) # 5852 <exit>
      exit(0);
    45ca:	4501                	li	a0,0
    45cc:	00001097          	auipc	ra,0x1
    45d0:	286080e7          	jalr	646(ra) # 5852 <exit>
...
00000000000045d4 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    45f8:	2ae080e7          	jalr	686(ra) # 58a2 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    460c:	28a080e7          	jalr	650(ra) # 5892 <open>
  if(fd < 0){
    4610:	04054a63          	bltz	a0,4664 <sharedfd+0x90>
    4614:	892a                	mv	s2,a0
  pid = fork();
    4616:	00001097          	auipc	ra,0x1
    461a:	234080e7          	jalr	564(ra) # 584a <fork>
    461e:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4648:	22e080e7          	jalr	558(ra) # 5872 <write>
    464c:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    4660:	1f6080e7          	jalr	502(ra) # 5852 <exit>
    ...
    467c:	1da080e7          	jalr	474(ra) # 5852 <exit>
    ...
    4698:	1be080e7          	jalr	446(ra) # 5852 <exit>
    wait(&xstatus);
    469c:	f9c40513          	addi	a0,s0,-100
    46a0:	00001097          	auipc	ra,0x1
    46a4:	1ba080e7          	jalr	442(ra) # 585a <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    46f6:	178080e7          	jalr	376(ra) # 586a <read>
    ...
    471c:	13a080e7          	jalr	314(ra) # 5852 <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    477e:	0d8080e7          	jalr	216(ra) # 5852 <exit>
    exit(0);
    4782:	4501                	li	a0,0
    4784:	00001097          	auipc	ra,0x1
    4788:	0ce080e7          	jalr	206(ra) # 5852 <exit>
...
000000000000478c <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    47f2:	0b4080e7          	jalr	180(ra) # 58a2 <unlink>
    pid = fork();
    47f6:	00001097          	auipc	ra,0x1
    47fa:	054080e7          	jalr	84(ra) # 584a <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4816:	048080e7          	jalr	72(ra) # 585a <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4860:	ff6080e7          	jalr	-10(ra) # 5852 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4864:	20200593          	li	a1,514
    4868:	854e                	mv	a0,s3
    486a:	00001097          	auipc	ra,0x1
    486e:	028080e7          	jalr	40(ra) # 5892 <open>
    4872:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    48a6:	fd0080e7          	jalr	-48(ra) # 5872 <write>
    48aa:	85aa                	mv	a1,a0
    ...
    48be:	f98080e7          	jalr	-104(ra) # 5852 <exit>
    ...
    48dc:	f7a080e7          	jalr	-134(ra) # 5852 <exit>
    ...
    48f6:	f60080e7          	jalr	-160(ra) # 5852 <exit>
      exit(xstatus);
    48fa:	855a                	mv	a0,s6
    48fc:	00001097          	auipc	ra,0x1
    4900:	f56080e7          	jalr	-170(ra) # 5852 <exit>
          printf("wrong char\n", s);
    ...
    491e:	f38080e7          	jalr	-200(ra) # 5852 <exit>
      total += n;
    ...
    4930:	f3e080e7          	jalr	-194(ra) # 586a <read>
    ...
    4960:	f1e080e7          	jalr	-226(ra) # 587a <close>
    if(total != N*SZ){
    4964:	03b91863          	bne	s2,s11,4994 <fourfiles+0x208>
    unlink(fname);
    4968:	8566                	mv	a0,s9
    496a:	00001097          	auipc	ra,0x1
    496e:	f38080e7          	jalr	-200(ra) # 58a2 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4986:	f10080e7          	jalr	-240(ra) # 5892 <open>
    498a:	89aa                	mv	s3,a0
    total = 0;
    498c:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    49ac:	eaa080e7          	jalr	-342(ra) # 5852 <exit>
}
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a10:	ea6080e7          	jalr	-346(ra) # 58b2 <link>
    if(pid == 0) {
    ...
    4a2e:	e68080e7          	jalr	-408(ra) # 5892 <open>
      if(fd < 0){
    ...
    4a50:	e06080e7          	jalr	-506(ra) # 5852 <exit>
      link("C0", file);
    ...
    4a64:	e52080e7          	jalr	-430(ra) # 58b2 <link>
      exit(0);
    4a68:	4501                	li	a0,0
    4a6a:	00001097          	auipc	ra,0x1
    4a6e:	de8080e7          	jalr	-536(ra) # 5852 <exit>
        exit(1);
    4a72:	4505                	li	a0,1
    4a74:	00001097          	auipc	ra,0x1
    4a78:	dde080e7          	jalr	-546(ra) # 5852 <exit>
  ...
  fd = open(".", 0);
    ...
    4a9c:	dfa080e7          	jalr	-518(ra) # 5892 <open>
    4aa0:	892a                	mv	s2,a0
  n = 0;
    4aa2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4aba:	db4080e7          	jalr	-588(ra) # 586a <read>
    ...
    4b1e:	d38080e7          	jalr	-712(ra) # 5852 <exit>
    ...
    4b3e:	d18080e7          	jalr	-744(ra) # 5852 <exit>
  close(fd);
    4b42:	854a                	mv	a0,s2
    4b44:	00001097          	auipc	ra,0x1
    4b48:	d36080e7          	jalr	-714(ra) # 587a <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4b76:	ce0080e7          	jalr	-800(ra) # 5852 <exit>
      printf("%s: fork failed\n", s);
    4b7a:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    4c3a:	c14080e7          	jalr	-1004(ra) # 584a <fork>
    4c3e:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    4ce6:	bc0080e7          	jalr	-1088(ra) # 58a2 <unlink>
    pid = fork();
    4cea:	00001097          	auipc	ra,0x1
    4cee:	b60080e7          	jalr	-1184(ra) # 584a <fork>
    if(pid && (i % 3) == 1){
    ...
    4d0a:	b8c080e7          	jalr	-1140(ra) # 5892 <open>
      if(fd < 0){
...
0000000000004d2a <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4d4a:	b5c080e7          	jalr	-1188(ra) # 58a2 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    4d5e:	b38080e7          	jalr	-1224(ra) # 5892 <open>
    4d62:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4d64:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    4d90:	ae6080e7          	jalr	-1306(ra) # 5872 <write>
  ...
  if(fd < 0){
    ...
    4ddc:	a92080e7          	jalr	-1390(ra) # 586a <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e28:	a2e080e7          	jalr	-1490(ra) # 5852 <exit>
    ...
    4e44:	a12080e7          	jalr	-1518(ra) # 5852 <exit>
    ...
    4e60:	9f6080e7          	jalr	-1546(ra) # 5852 <exit>
    ...
    4e7c:	9da080e7          	jalr	-1574(ra) # 5852 <exit>
    ...
    4e98:	9be080e7          	jalr	-1602(ra) # 5852 <exit>
    ...
    4eb4:	9a2080e7          	jalr	-1630(ra) # 5852 <exit>
  close(fd);
    4eb8:	8552                	mv	a0,s4
    4eba:	00001097          	auipc	ra,0x1
    4ebe:	9c0080e7          	jalr	-1600(ra) # 587a <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    4ed8:	9ce080e7          	jalr	-1586(ra) # 58a2 <unlink>
}
    ...
    4f06:	950080e7          	jalr	-1712(ra) # 5852 <exit>
...
0000000000004f0a <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fb4:	8e2080e7          	jalr	-1822(ra) # 5892 <open>
    4fb8:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    502e:	878080e7          	jalr	-1928(ra) # 58a2 <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    5078:	7fe080e7          	jalr	2046(ra) # 5872 <write>
      if(cc < BSIZE)
    ...
    509e:	7e0080e7          	jalr	2016(ra) # 587a <close>
    if(total == 0)
...
00000000000050aa <badwrite>:
{
  ...
  unlink("junk");
    ...
    50c6:	7e0080e7          	jalr	2016(ra) # 58a2 <unlink>
    ...
    50e6:	7b0080e7          	jalr	1968(ra) # 5892 <open>
    50ea:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    50f8:	77e080e7          	jalr	1918(ra) # 5872 <write>
    close(fd);
    50fc:	8526                	mv	a0,s1
    50fe:	00000097          	auipc	ra,0x0
    5102:	77c080e7          	jalr	1916(ra) # 587a <close>
    unlink("junk");
    5106:	854e                	mv	a0,s3
    5108:	00000097          	auipc	ra,0x0
    510c:	79a080e7          	jalr	1946(ra) # 58a2 <unlink>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5126:	770080e7          	jalr	1904(ra) # 5892 <open>
    512a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513e:	738080e7          	jalr	1848(ra) # 5872 <write>
    5142:	4785                	li	a5,1
    ...
    515e:	6f8080e7          	jalr	1784(ra) # 5852 <exit>
    ...
    5178:	6de080e7          	jalr	1758(ra) # 5852 <exit>
    printf("open junk failed\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    51d0:	696080e7          	jalr	1686(ra) # 5862 <pipe>
  ...
  int pid = fork();
    ...
    51dc:	672080e7          	jalr	1650(ra) # 584a <fork>
  ...
  if(pid == 0){
    ...
    51ee:	690080e7          	jalr	1680(ra) # 587a <close>
    ...
    5204:	6da080e7          	jalr	1754(ra) # 58da <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5220:	656080e7          	jalr	1622(ra) # 5872 <write>
    ...
    523e:	618080e7          	jalr	1560(ra) # 5852 <exit>
    printf("pipe() failed in countfree()\n");
    ...
    5258:	5fe080e7          	jalr	1534(ra) # 5852 <exit>
    printf("fork failed in countfree()\n");
    ...
    5272:	5e4080e7          	jalr	1508(ra) # 5852 <exit>
      }
    }
    ...
    527c:	5da080e7          	jalr	1498(ra) # 5852 <exit>
  }

  close(fds[1]);
    5280:	fcc42503          	lw	a0,-52(s0)
    5284:	00000097          	auipc	ra,0x0
    5288:	5f6080e7          	jalr	1526(ra) # 587a <close>
  ...
  while(1){
    ...
    529c:	5d2080e7          	jalr	1490(ra) # 586a <read>
    if(cc < 0){
  ...
  while(1){
    ...
    52c0:	596080e7          	jalr	1430(ra) # 5852 <exit>
  }

  close(fds[0]);
    52c4:	fc842503          	lw	a0,-56(s0)
    52c8:	00000097          	auipc	ra,0x0
    52cc:	5b2080e7          	jalr	1458(ra) # 587a <close>
  wait((int*)0);
    52d0:	4501                	li	a0,0
    52d2:	00000097          	auipc	ra,0x0
    52d6:	588080e7          	jalr	1416(ra) # 585a <wait>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    530e:	540080e7          	jalr	1344(ra) # 584a <fork>
  ...
  if(pid == 0) {
    ...
    5320:	53e080e7          	jalr	1342(ra) # 585a <wait>
    if(xstatus != 0) 
    ...
    5364:	4f2080e7          	jalr	1266(ra) # 5852 <exit>
    f(s);
    5368:	854a                	mv	a0,s2
    536a:	9482                	jalr	s1
    exit(0);
    ...
    5372:	4e4080e7          	jalr	1252(ra) # 5852 <exit>
      printf("OK\n");
...
main(int argc, char *argv[])
{
  ...
  if(fail){
    ...
    544e:	408080e7          	jalr	1032(ra) # 5852 <exit>
    5452:	84ae                	mv	s1,a1
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54a4:	3b2080e7          	jalr	946(ra) # 5852 <exit>
          exit(1);
    54a8:	4505                	li	a0,1
    54aa:	00000097          	auipc	ra,0x0
    54ae:	3a8080e7          	jalr	936(ra) # 5852 <exit>
    ...
    54ca:	38c080e7          	jalr	908(ra) # 5852 <exit>
  for (struct test *t = tests; t->s != 0; t++) {
  ...
  if(fail){
    ...
    5510:	346080e7          	jalr	838(ra) # 5852 <exit>
  } else {
    ...
    552a:	32c080e7          	jalr	812(ra) # 5852 <exit>
        printf("SOME TESTS FAILED\n");
    552e:	8556                	mv	a0,s5
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    56c4:	1aa080e7          	jalr	426(ra) # 586a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5716:	180080e7          	jalr	384(ra) # 5892 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5726:	188080e7          	jalr	392(ra) # 58aa <fstat>
    572a:	892a                	mv	s2,a0
  close(fd);
    572c:	8526                	mv	a0,s1
    572e:	00000097          	auipc	ra,0x0
    5732:	14c080e7          	jalr	332(ra) # 587a <close>
  return r;
}
    5736:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d5e:	b80080e7          	jalr	-1152(ra) # 58da <sbrk>
  if(p == (char*)-1)
