...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	87a080e7          	jalr	-1926(ra) # 588a <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	868080e7          	jalr	-1944(ra) # 588a <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
    ...
    uint64 addr = addrs[ai];
      ...
      54:	7fa080e7          	jalr	2042(ra) # 584a <exit>
      ...
      74:	8082                	ret
{
      ...
      96:	7b8080e7          	jalr	1976(ra) # 584a <exit>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b4:	7da080e7          	jalr	2010(ra) # 588a <open>
  if(fd < 0){
      b8:	02054663          	bltz	a0,e4 <opentest+0x4a>
  close(fd);
      bc:	00005097          	auipc	ra,0x5
      c0:	7b6080e7          	jalr	1974(ra) # 5872 <close>
  fd = open("doesnotexist", 0);
      c4:	4581                	li	a1,0
      c6:	00006517          	auipc	a0,0x6
      ca:	cfa50513          	addi	a0,a0,-774 # 5dc0 <malloc+0x144>
      ce:	00005097          	auipc	ra,0x5
      d2:	7bc080e7          	jalr	1980(ra) # 588a <open>
  if(fd >= 0){
    ...
    exit(1);
      ...
      fc:	752080e7          	jalr	1874(ra) # 584a <exit>
    ...
    exit(1);
     ...
     118:	736080e7          	jalr	1846(ra) # 584a <exit>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     138:	766080e7          	jalr	1894(ra) # 589a <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cb850513          	addi	a0,a0,-840 # 5df8 <malloc+0x17c>
     148:	00005097          	auipc	ra,0x5
     14c:	742080e7          	jalr	1858(ra) # 588a <open>
     150:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     152:	4611                	li	a2,4
     ...
     160:	70e080e7          	jalr	1806(ra) # 586a <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	c9050513          	addi	a0,a0,-880 # 5df8 <malloc+0x17c>
     170:	00005097          	auipc	ra,0x5
     174:	71a080e7          	jalr	1818(ra) # 588a <open>
     178:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     17a:	4605                	li	a2,1
     ...
     18a:	6e4080e7          	jalr	1764(ra) # 586a <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
  ...
  unlink("truncfile");
     ...
     1a0:	6fe080e7          	jalr	1790(ra) # 589a <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00005097          	auipc	ra,0x5
     1aa:	6cc080e7          	jalr	1740(ra) # 5872 <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00005097          	auipc	ra,0x5
     1b4:	6c2080e7          	jalr	1730(ra) # 5872 <close>
}
    ...
    exit(1);
     ...
     1e0:	66e080e7          	jalr	1646(ra) # 584a <exit>
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	67a080e7          	jalr	1658(ra) # 588a <open>
    close(fd);
     218:	00005097          	auipc	ra,0x5
     21c:	65a080e7          	jalr	1626(ra) # 5872 <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	654080e7          	jalr	1620(ra) # 589a <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     288:	616080e7          	jalr	1558(ra) # 589a <unlink>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	5de080e7          	jalr	1502(ra) # 588a <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	5ac080e7          	jalr	1452(ra) # 586a <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	598080e7          	jalr	1432(ra) # 586a <write>
      if(cc != sz){
     2da:	04951a63          	bne	a0,s1,32e <bigwrite+0xca>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00005097          	auipc	ra,0x5
     2e4:	592080e7          	jalr	1426(ra) # 5872 <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00005097          	auipc	ra,0x5
     2ee:	5b0080e7          	jalr	1456(ra) # 589a <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     328:	526080e7          	jalr	1318(ra) # 584a <exit>
      if(cc != sz){
     32c:	89a6                	mv	s3,s1
     ...
     34a:	504080e7          	jalr	1284(ra) # 584a <exit>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     386:	508080e7          	jalr	1288(ra) # 588a <open>
     38a:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     432:	41c080e7          	jalr	1052(ra) # 584a <exit>
     ...
     450:	3fe080e7          	jalr	1022(ra) # 584a <exit>
     ...
     46e:	3e0080e7          	jalr	992(ra) # 584a <exit>
      printf("pipe() failed\n");
     ...
     488:	3c6080e7          	jalr	966(ra) # 584a <exit>
     ...
     4a6:	3a8080e7          	jalr	936(ra) # 584a <exit>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4ea:	3a4080e7          	jalr	932(ra) # 588a <open>
     4ee:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     52a:	344080e7          	jalr	836(ra) # 586a <write>
    if(n != 1){
     52e:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     592:	2bc080e7          	jalr	700(ra) # 584a <exit>
     ...
     5b0:	29e080e7          	jalr	670(ra) # 584a <exit>
      printf("pipe() failed\n");
     ...
     5ca:	284080e7          	jalr	644(ra) # 584a <exit>
     ...
     5e4:	26a080e7          	jalr	618(ra) # 584a <exit>
     ...
     602:	24c080e7          	jalr	588(ra) # 584a <exit>
...
0000000000000606 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     626:	278080e7          	jalr	632(ra) # 589a <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     63a:	254080e7          	jalr	596(ra) # 588a <open>
     63e:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     640:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     696:	1f8080e7          	jalr	504(ra) # 588a <open>
     69a:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     6d2:	194080e7          	jalr	404(ra) # 5862 <read>
     6d6:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     714:	152080e7          	jalr	338(ra) # 5862 <read>
  if(n != 2){
     718:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     72a:	174080e7          	jalr	372(ra) # 589a <unlink>
  close(fd1);
     72e:	854e                	mv	a0,s3
     730:	00005097          	auipc	ra,0x5
     734:	142080e7          	jalr	322(ra) # 5872 <close>
  close(fd2);
     738:	8526                	mv	a0,s1
     73a:	00005097          	auipc	ra,0x5
     73e:	138080e7          	jalr	312(ra) # 5872 <close>
  close(fd3);
     742:	854a                	mv	a0,s2
     744:	00005097          	auipc	ra,0x5
     748:	12e080e7          	jalr	302(ra) # 5872 <close>
}
    ...
    exit(1);
     ...
     778:	0d6080e7          	jalr	214(ra) # 584a <exit>
    printf("aaa fd3=%d\n", fd3);
     77c:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     7a8:	0a6080e7          	jalr	166(ra) # 584a <exit>
    printf("bbb fd2=%d\n", fd2);
     7ac:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     7d8:	076080e7          	jalr	118(ra) # 584a <exit>
    ...
    exit(1);
     ...
     7f6:	058080e7          	jalr	88(ra) # 584a <exit>
    ...
    exit(1);
     ...
     814:	03a080e7          	jalr	58(ra) # 584a <exit>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     83e:	050080e7          	jalr	80(ra) # 588a <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     868:	006080e7          	jalr	6(ra) # 586a <write>
     86c:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     87c:	ff2080e7          	jalr	-14(ra) # 586a <write>
     880:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8be:	fa8080e7          	jalr	-88(ra) # 5862 <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     914:	f3a080e7          	jalr	-198(ra) # 584a <exit>
     ...
     932:	f1c080e7          	jalr	-228(ra) # 584a <exit>
     ...
     950:	efe080e7          	jalr	-258(ra) # 584a <exit>
    ...
    exit(1);
     ...
     96c:	ee2080e7          	jalr	-286(ra) # 584a <exit>
    ...
    exit(1);
     ...
     988:	ec6080e7          	jalr	-314(ra) # 584a <exit>
    ...
    exit(1);
     ...
     9a4:	eaa080e7          	jalr	-342(ra) # 584a <exit>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9cc:	ec2080e7          	jalr	-318(ra) # 588a <open>
     9d0:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9d2:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     9f4:	e7a080e7          	jalr	-390(ra) # 586a <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3e:	e28080e7          	jalr	-472(ra) # 5862 <read>
    if(i == 0){
    ...
    exit(1);
     ...
     a70:	dde080e7          	jalr	-546(ra) # 584a <exit>
     ...
     a8e:	dc0080e7          	jalr	-576(ra) # 584a <exit>
    ...
    exit(1);
     ...
     aaa:	da4080e7          	jalr	-604(ra) # 584a <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     b02:	d4c080e7          	jalr	-692(ra) # 584a <exit>
     ...
     b20:	d2e080e7          	jalr	-722(ra) # 584a <exit>
     ...
     b3e:	d10080e7          	jalr	-752(ra) # 584a <exit>
    ...
    exit(1);
     ...
     b5a:	cf4080e7          	jalr	-780(ra) # 584a <exit>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b7e:	d10080e7          	jalr	-752(ra) # 588a <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc8:	cd6080e7          	jalr	-810(ra) # 589a <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bde:	cb0080e7          	jalr	-848(ra) # 588a <open>
     be2:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be4:	460d                	li	a2,3
     ...
     bf2:	c7c080e7          	jalr	-900(ra) # 586a <write>
  close(fd1);
     bf6:	854a                	mv	a0,s2
     bf8:	00005097          	auipc	ra,0x5
     bfc:	c7a080e7          	jalr	-902(ra) # 5872 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c10:	c56080e7          	jalr	-938(ra) # 5862 <read>
     c14:	4795                	li	a5,5
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     c84:	bca080e7          	jalr	-1078(ra) # 584a <exit>
    ...
    exit(1);
     ...
     ca0:	bae080e7          	jalr	-1106(ra) # 584a <exit>
    ...
    exit(1);
     ...
     cbc:	b92080e7          	jalr	-1134(ra) # 584a <exit>
    ...
    exit(1);
     ...
     cd8:	b76080e7          	jalr	-1162(ra) # 584a <exit>
    ...
    exit(1);
     ...
     cf4:	b5a080e7          	jalr	-1190(ra) # 584a <exit>
    ...
    exit(1);
     ...
     d10:	b3e080e7          	jalr	-1218(ra) # 584a <exit>
...
0000000000000d14 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     d52:	b3c080e7          	jalr	-1220(ra) # 588a <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6a:	b04080e7          	jalr	-1276(ra) # 586a <write>
     d6e:	4795                	li	a5,5
     d70:	10f51863          	bne	a0,a5,e80 <linktest+0x16c>
  close(fd);
     d74:	8526                	mv	a0,s1
     d76:	00005097          	auipc	ra,0x5
     d7a:	afc080e7          	jalr	-1284(ra) # 5872 <close>
  if(link("lf1", "lf2") < 0){
     ...
     d92:	b1c080e7          	jalr	-1252(ra) # 58aa <link>
  ...
  fd = open("lf2", 0);
     ...
     dce:	ac0080e7          	jalr	-1344(ra) # 588a <open>
     dd2:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     e1c:	a82080e7          	jalr	-1406(ra) # 589a <unlink>
  if(link("lf2", "lf1") >= 0){
     ...
     e34:	a7a080e7          	jalr	-1414(ra) # 58aa <link>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e50:	a5e080e7          	jalr	-1442(ra) # 58aa <link>
    ...
    exit(1);
     ...
     e7c:	9d2080e7          	jalr	-1582(ra) # 584a <exit>
    ...
    exit(1);
     ...
     e98:	9b6080e7          	jalr	-1610(ra) # 584a <exit>
    ...
    exit(1);
     ...
     eb4:	99a080e7          	jalr	-1638(ra) # 584a <exit>
    ...
    exit(1);
     ...
     ed0:	97e080e7          	jalr	-1666(ra) # 584a <exit>
    ...
    exit(1);
     ...
     eec:	962080e7          	jalr	-1694(ra) # 584a <exit>
    ...
    exit(1);
     ...
     f08:	946080e7          	jalr	-1722(ra) # 584a <exit>
    ...
    exit(1);
     ...
     f24:	92a080e7          	jalr	-1750(ra) # 584a <exit>
    ...
    exit(1);
     ...
     f40:	90e080e7          	jalr	-1778(ra) # 584a <exit>
    ...
    exit(1);
     ...
     f5c:	8f2080e7          	jalr	-1806(ra) # 584a <exit>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff0:	8be080e7          	jalr	-1858(ra) # 58aa <link>
     ff4:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    100a:	894080e7          	jalr	-1900(ra) # 589a <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    104c:	852080e7          	jalr	-1966(ra) # 589a <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    1084:	7ca080e7          	jalr	1994(ra) # 584a <exit>
    ...
    10a4:	7aa080e7          	jalr	1962(ra) # 584a <exit>
    ...
    10c0:	78e080e7          	jalr	1934(ra) # 584a <exit>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f4:	7ba080e7          	jalr	1978(ra) # 58aa <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    112e:	720080e7          	jalr	1824(ra) # 584a <exit>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1152:	734080e7          	jalr	1844(ra) # 5882 <exec>

  pipe((int*)0xeaeb0b5b00002f5e);
    1156:	8526                	mv	a0,s1
    1158:	00004097          	auipc	ra,0x4
    115c:	702080e7          	jalr	1794(ra) # 585a <pipe>

  exit(0);
    1160:	4501                	li	a0,0
    1162:	00004097          	auipc	ra,0x4
    1166:	6e8080e7          	jalr	1768(ra) # 584a <exit>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    119e:	6e8080e7          	jalr	1768(ra) # 5882 <exec>
  for(int i = 0; i < 50000; i++){
  ...
  exit(0);
    ...
    11ac:	6a2080e7          	jalr	1698(ra) # 584a <exit>
...
00000000000011b0 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    11da:	6c4080e7          	jalr	1732(ra) # 589a <unlink>
  if(ret != -1){
    11de:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    11f0:	69e080e7          	jalr	1694(ra) # 588a <open>
  if(fd != -1){
    11f4:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    1204:	6aa080e7          	jalr	1706(ra) # 58aa <link>
  if(ret != -1){
    1208:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    122a:	65c080e7          	jalr	1628(ra) # 5882 <exec>
  if(ret != -1){
    122e:	57fd                	li	a5,-1
    1230:	0ef51963          	bne	a0,a5,1322 <copyinstr2+0x172>
  int pid = fork();
    1234:	00004097          	auipc	ra,0x4
    1238:	60e080e7          	jalr	1550(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    129a:	5ec080e7          	jalr	1516(ra) # 5882 <exec>
    if(ret != -1){
    129e:	57fd                	li	a5,-1
    ...
    12bc:	592080e7          	jalr	1426(ra) # 584a <exit>
    ...
    12dc:	572080e7          	jalr	1394(ra) # 584a <exit>
    ...
    12fc:	552080e7          	jalr	1362(ra) # 584a <exit>
    ...
    131e:	530080e7          	jalr	1328(ra) # 584a <exit>
    ...
    133e:	510080e7          	jalr	1296(ra) # 584a <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    13a2:	4ac080e7          	jalr	1196(ra) # 584a <exit>
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13ca:	4c4080e7          	jalr	1220(ra) # 588a <open>
    13ce:	00004097          	auipc	ra,0x4
    13d2:	4a4080e7          	jalr	1188(ra) # 5872 <close>
  pid = fork();
    13d6:	00004097          	auipc	ra,0x4
    13da:	46c080e7          	jalr	1132(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1400:	48e080e7          	jalr	1166(ra) # 588a <open>
    1404:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1412:	45c080e7          	jalr	1116(ra) # 586a <write>
      if(n != 10){
    1416:	47a9                	li	a5,10
    ...
    1422:	454080e7          	jalr	1108(ra) # 5872 <close>
      fd = open("truncfile", O_RDONLY);
    1426:	4581                	li	a1,0
    1428:	8552                	mv	a0,s4
    142a:	00004097          	auipc	ra,0x4
    142e:	460080e7          	jalr	1120(ra) # 588a <open>
    1432:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1434:	02000613          	li	a2,32
    1438:	f9840593          	addi	a1,s0,-104
    143c:	00004097          	auipc	ra,0x4
    1440:	426080e7          	jalr	1062(ra) # 5862 <read>
      close(fd);
    1444:	8526                	mv	a0,s1
    1446:	00004097          	auipc	ra,0x4
    144a:	42c080e7          	jalr	1068(ra) # 5872 <close>
    for(int i = 0; i < 100; i++){
    ...
    145a:	3f4080e7          	jalr	1012(ra) # 584a <exit>
    ...
    1476:	3d8080e7          	jalr	984(ra) # 584a <exit>
    ...
    1492:	3bc080e7          	jalr	956(ra) # 584a <exit>
    ...
    14b0:	39e080e7          	jalr	926(ra) # 584a <exit>
    ...
    14d2:	3bc080e7          	jalr	956(ra) # 588a <open>
    14d6:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    14e4:	38a080e7          	jalr	906(ra) # 586a <write>
    if(n != 3){
    14e8:	478d                	li	a5,3
    ...
    14f4:	382080e7          	jalr	898(ra) # 5872 <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    153e:	310080e7          	jalr	784(ra) # 584a <exit>
    ...
    155c:	2f2080e7          	jalr	754(ra) # 584a <exit>
...
0000000000001560 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1596:	308080e7          	jalr	776(ra) # 589a <unlink>
  pid = fork();
    159a:	00004097          	auipc	ra,0x4
    159e:	2a8080e7          	jalr	680(ra) # 5842 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    15b0:	2c6080e7          	jalr	710(ra) # 5872 <close>
    ...
    15c4:	2ca080e7          	jalr	714(ra) # 588a <open>
    if(fd < 0) {
    ...
    15ea:	264080e7          	jalr	612(ra) # 584a <exit>
     printf("%s: fork failed\n", s);
    15ee:	85ca                	mv	a1,s2
    ...
    1606:	248080e7          	jalr	584(ra) # 584a <exit>
    ...
    1622:	22c080e7          	jalr	556(ra) # 584a <exit>
  ...
  if(xstatus != 0)
    ...
    1658:	1f6080e7          	jalr	502(ra) # 584a <exit>
    ...
    1674:	1da080e7          	jalr	474(ra) # 584a <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169a:	1f4080e7          	jalr	500(ra) # 588a <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16ac:	1ba080e7          	jalr	442(ra) # 5862 <read>
    16b0:	4789                	li	a5,2
    ...
    16ce:	180080e7          	jalr	384(ra) # 584a <exit>
    printf("%s: open failed\n", s);
    16d2:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    172e:	120080e7          	jalr	288(ra) # 584a <exit>
    exit(0);
    1732:	4501                	li	a0,0
    1734:	00004097          	auipc	ra,0x4
    1738:	116080e7          	jalr	278(ra) # 584a <exit>
...
000000000000173c <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    175c:	102080e7          	jalr	258(ra) # 585a <pipe>
    1760:	e93d                	bnez	a0,17d6 <pipe1+0x9a>
    1762:	84aa                	mv	s1,a0
  pid = fork();
    1764:	00004097          	auipc	ra,0x4
    1768:	0de080e7          	jalr	222(ra) # 5842 <fork>
    176c:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    177c:	0fa080e7          	jalr	250(ra) # 5872 <close>
    total = 0;
    1780:	8a26                	mv	s4,s1
    cc = 1;
    1782:	4985                	li	s3,1
    ...
    179a:	0cc080e7          	jalr	204(ra) # 5862 <read>
    ...
    17ee:	060080e7          	jalr	96(ra) # 584a <exit>
    close(fds[0]);
    17f2:	fa842503          	lw	a0,-88(s0)
    17f6:	00004097          	auipc	ra,0x4
    17fa:	07c080e7          	jalr	124(ra) # 5872 <close>
    for(n = 0; n < N; n++){
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    183c:	032080e7          	jalr	50(ra) # 586a <write>
    ...
    1858:	ff6080e7          	jalr	-10(ra) # 584a <exit>
    ...
    1874:	fda080e7          	jalr	-38(ra) # 584a <exit>
    ...
    1902:	f4c080e7          	jalr	-180(ra) # 584a <exit>
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1922:	f24080e7          	jalr	-220(ra) # 5842 <fork>
    1926:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    1936:	f20080e7          	jalr	-224(ra) # 5852 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1974:	eda080e7          	jalr	-294(ra) # 584a <exit>
    ...
    1990:	ebe080e7          	jalr	-322(ra) # 584a <exit>
    ...
    19ac:	ea2080e7          	jalr	-350(ra) # 584a <exit>
      exit(i);
    19b0:	854a                	mv	a0,s2
    19b2:	00004097          	auipc	ra,0x4
    19b6:	e98080e7          	jalr	-360(ra) # 584a <exit>
...
00000000000019ba <twochildren>:
{
    ...
    19d0:	e76080e7          	jalr	-394(ra) # 5842 <fork>
    if(pid1 < 0){
    ...
    19de:	e68080e7          	jalr	-408(ra) # 5842 <fork>
      if(pid2 < 0){
    ...
    19ee:	e68080e7          	jalr	-408(ra) # 5852 <wait>
        wait(0);
    19f2:	4501                	li	a0,0
    19f4:	00004097          	auipc	ra,0x4
    19f8:	e5e080e7          	jalr	-418(ra) # 5852 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1a24:	e2a080e7          	jalr	-470(ra) # 584a <exit>
      exit(0);
    1a28:	00004097          	auipc	ra,0x4
    1a2c:	e22080e7          	jalr	-478(ra) # 584a <exit>
        printf("%s: fork failed\n", s);
    1a30:	85ca                	mv	a1,s2
    ...
    1a48:	e06080e7          	jalr	-506(ra) # 584a <exit>
        exit(0);
    1a4c:	00004097          	auipc	ra,0x4
    1a50:	dfe080e7          	jalr	-514(ra) # 584a <exit>
...
0000000000001a54 <forkfork>:
{
    ...
    1a64:	de2080e7          	jalr	-542(ra) # 5842 <fork>
    if(pid < 0){
    ...
    1a72:	dd4080e7          	jalr	-556(ra) # 5842 <fork>
    if(pid < 0){
    ...
    1a84:	dd2080e7          	jalr	-558(ra) # 5852 <wait>
    if(xstatus != 0) {
    ...
    1a96:	dc0080e7          	jalr	-576(ra) # 5852 <wait>
    if(xstatus != 0) {
    ...
    1ac2:	d8c080e7          	jalr	-628(ra) # 584a <exit>
{
    1ac6:	0c800493          	li	s1,200
        int pid1 = fork();
    1aca:	00004097          	auipc	ra,0x4
    1ace:	d78080e7          	jalr	-648(ra) # 5842 <fork>
        if(pid1 < 0){
    ...
    1ade:	d78080e7          	jalr	-648(ra) # 5852 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1aec:	d62080e7          	jalr	-670(ra) # 584a <exit>
          exit(1);
    1af0:	4505                	li	a0,1
    1af2:	00004097          	auipc	ra,0x4
    1af6:	d58080e7          	jalr	-680(ra) # 584a <exit>
          exit(0);
    1afa:	00004097          	auipc	ra,0x4
    1afe:	d50080e7          	jalr	-688(ra) # 584a <exit>
    ...
    1b1a:	d34080e7          	jalr	-716(ra) # 584a <exit>
...
0000000000001b1e <reparent2>:
{
    ...
    1b30:	d16080e7          	jalr	-746(ra) # 5842 <fork>
    if(pid1 < 0){
    ...
    1b40:	d16080e7          	jalr	-746(ra) # 5852 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1b4e:	d00080e7          	jalr	-768(ra) # 584a <exit>
      printf("fork failed\n");
    ...
    1b68:	ce6080e7          	jalr	-794(ra) # 584a <exit>
      fork();
    1b6c:	00004097          	auipc	ra,0x4
    1b70:	cd6080e7          	jalr	-810(ra) # 5842 <fork>
      fork();
    1b74:	00004097          	auipc	ra,0x4
    1b78:	cce080e7          	jalr	-818(ra) # 5842 <fork>
      exit(0);
    1b7c:	4501                	li	a0,0
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	ccc080e7          	jalr	-820(ra) # 584a <exit>
...
0000000000001b86 <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1baa:	c9c080e7          	jalr	-868(ra) # 5842 <fork>
    1bae:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bc6:	c90080e7          	jalr	-880(ra) # 5852 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c06:	c48080e7          	jalr	-952(ra) # 584a <exit>
      name[0] = 'p' + pi;
    ...
    1c32:	c1c080e7          	jalr	-996(ra) # 584a <exit>
      for(i = 0; i < N; i++){
    ...
    1c50:	c3e080e7          	jalr	-962(ra) # 588a <open>
        if(fd < 0){
    1c54:	fc0543e3          	bltz	a0,1c1a <createdelete+0x94>
        close(fd);
    1c58:	00004097          	auipc	ra,0x4
    1c5c:	c1a080e7          	jalr	-998(ra) # 5872 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1c84:	c1a080e7          	jalr	-998(ra) # 589a <unlink>
    ...
    1ca4:	baa080e7          	jalr	-1110(ra) # 584a <exit>
      exit(0);
    1ca8:	4501                	li	a0,0
    1caa:	00004097          	auipc	ra,0x4
    1cae:	ba0080e7          	jalr	-1120(ra) # 584a <exit>
      exit(1);
    1cb2:	4505                	li	a0,1
    1cb4:	00004097          	auipc	ra,0x4
    1cb8:	b96080e7          	jalr	-1130(ra) # 584a <exit>
    ...
    1cd8:	b76080e7          	jalr	-1162(ra) # 584a <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1d00:	b8e080e7          	jalr	-1138(ra) # 588a <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1d18:	b5e080e7          	jalr	-1186(ra) # 5872 <close>
    ...
    1d3e:	b10080e7          	jalr	-1264(ra) # 584a <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1d78:	b26080e7          	jalr	-1242(ra) # 589a <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd4:	aca080e7          	jalr	-1334(ra) # 589a <unlink>
  pid = fork();
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	a6a080e7          	jalr	-1430(ra) # 5842 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	a20080e7          	jalr	-1504(ra) # 584a <exit>
      close(open("x", O_RDWR | O_CREATE));
    1e32:	20200593          	li	a1,514
    1e36:	8556                	mv	a0,s5
    1e38:	00004097          	auipc	ra,0x4
    1e3c:	a52080e7          	jalr	-1454(ra) # 588a <open>
    1e40:	00004097          	auipc	ra,0x4
    1e44:	a32080e7          	jalr	-1486(ra) # 5872 <close>
  for(i = 0; i < 100; i++){
    ...
    1e68:	a36080e7          	jalr	-1482(ra) # 589a <unlink>
    1e6c:	bff1                	j	1e48 <linkunlink+0x9c>
      link("cat", "x");
    1e6e:	85d6                	mv	a1,s5
    1e70:	855e                	mv	a0,s7
    1e72:	00004097          	auipc	ra,0x4
    1e76:	a38080e7          	jalr	-1480(ra) # 58aa <link>
  ...
  if(pid)
    ...
    1e86:	9d0080e7          	jalr	-1584(ra) # 5852 <wait>
}
    ...
    1eaa:	9a4080e7          	jalr	-1628(ra) # 584a <exit>
...
0000000000001eae <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ece:	978080e7          	jalr	-1672(ra) # 5842 <fork>
    1ed2:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1eee:	968080e7          	jalr	-1688(ra) # 5852 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    1f02:	94c080e7          	jalr	-1716(ra) # 584a <exit>
      printf("fork failed\n");
    ...
    1f1c:	932080e7          	jalr	-1742(ra) # 584a <exit>
      name[0] = 'b';
    ...
    1f3c:	962080e7          	jalr	-1694(ra) # 589a <unlink>
    1f40:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    ...
    1f5c:	932080e7          	jalr	-1742(ra) # 588a <open>
    1f60:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    1f6e:	900080e7          	jalr	-1792(ra) # 586a <write>
          if(cc != sz){
    ...
    1f7e:	8f8080e7          	jalr	-1800(ra) # 5872 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    1f90:	90e080e7          	jalr	-1778(ra) # 589a <unlink>
    ...
    1fa2:	8fc080e7          	jalr	-1796(ra) # 589a <unlink>
      exit(0);
    1fa6:	4501                	li	a0,0
    1fa8:	00004097          	auipc	ra,0x4
    1fac:	8a2080e7          	jalr	-1886(ra) # 584a <exit>
    ...
    1fcc:	882080e7          	jalr	-1918(ra) # 584a <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1fd0:	86aa                	mv	a3,a0
    ...
    1fec:	862080e7          	jalr	-1950(ra) # 584a <exit>
      exit(st);
    1ff0:	00004097          	auipc	ra,0x4
    1ff4:	85a080e7          	jalr	-1958(ra) # 584a <exit>
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2012:	834080e7          	jalr	-1996(ra) # 5842 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    203a:	814080e7          	jalr	-2028(ra) # 584a <exit>
      exit(0);
    203e:	00004097          	auipc	ra,0x4
    2042:	80c080e7          	jalr	-2036(ra) # 584a <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    205a:	7fc080e7          	jalr	2044(ra) # 5852 <wait>
  ...
  if(wait(0) != -1){
    ...
    206c:	7ea080e7          	jalr	2026(ra) # 5852 <wait>
    2070:	57fd                	li	a5,-1
    ...
    209c:	7b2080e7          	jalr	1970(ra) # 584a <exit>
    ...
    20b8:	796080e7          	jalr	1942(ra) # 584a <exit>
    ...
    20d4:	77a080e7          	jalr	1914(ra) # 584a <exit>
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2106:	740080e7          	jalr	1856(ra) # 5842 <fork>
    if(pid < 0){
    ...
    2118:	73e080e7          	jalr	1854(ra) # 5852 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2154:	6fa080e7          	jalr	1786(ra) # 584a <exit>
    ...
    2176:	6d8080e7          	jalr	1752(ra) # 584a <exit>
      exit(1);
    217a:	4505                	li	a0,1
    217c:	00003097          	auipc	ra,0x3
    2180:	6ce080e7          	jalr	1742(ra) # 584a <exit>
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21a6:	6a0080e7          	jalr	1696(ra) # 5842 <fork>
    if(pid < 0){
    ...
    21b8:	69e080e7          	jalr	1694(ra) # 5852 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    21f8:	656080e7          	jalr	1622(ra) # 584a <exit>
      *(char*)a = 99;
    ...
    2224:	62a080e7          	jalr	1578(ra) # 584a <exit>
      exit(1);
    2228:	4505                	li	a0,1
    222a:	00003097          	auipc	ra,0x3
    222e:	620080e7          	jalr	1568(ra) # 584a <exit>
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    224a:	654080e7          	jalr	1620(ra) # 589a <unlink>
  pid = fork();
    224e:	00003097          	auipc	ra,0x3
    2252:	5f4080e7          	jalr	1524(ra) # 5842 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    2264:	5f2080e7          	jalr	1522(ra) # 5852 <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    227c:	612080e7          	jalr	1554(ra) # 588a <open>
  if(fd < 0){
    2280:	08054e63          	bltz	a0,231c <bigargtest+0xea>
  close(fd);
    2284:	00003097          	auipc	ra,0x3
    2288:	5ee080e7          	jalr	1518(ra) # 5872 <close>
}
    ...
    22ce:	5b8080e7          	jalr	1464(ra) # 5882 <exec>
    ...
    22e2:	5ac080e7          	jalr	1452(ra) # 588a <open>
    close(fd);
    22e6:	00003097          	auipc	ra,0x3
    22ea:	58c080e7          	jalr	1420(ra) # 5872 <close>
    exit(0);
    22ee:	4501                	li	a0,0
    22f0:	00003097          	auipc	ra,0x3
    22f4:	55a080e7          	jalr	1370(ra) # 584a <exit>
    ...
    2310:	53e080e7          	jalr	1342(ra) # 584a <exit>
    exit(xstatus);
    2314:	00003097          	auipc	ra,0x3
    2318:	536080e7          	jalr	1334(ra) # 584a <exit>
    ...
    2334:	51a080e7          	jalr	1306(ra) # 584a <exit>
...
0000000000002338 <stacktest>:
{
  ...
  pid = fork();
    ...
    2348:	4fe080e7          	jalr	1278(ra) # 5842 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    235a:	4fc080e7          	jalr	1276(ra) # 5852 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    236c:	4e2080e7          	jalr	1250(ra) # 584a <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2392:	4bc080e7          	jalr	1212(ra) # 584a <exit>
    printf("%s: fork failed\n", s);
    2396:	85a6                	mv	a1,s1
    ...
    23ae:	4a0080e7          	jalr	1184(ra) # 584a <exit>
    exit(0);
    23b2:	4501                	li	a0,0
    23b4:	00003097          	auipc	ra,0x3
    23b8:	496080e7          	jalr	1174(ra) # 584a <exit>
...
00000000000023bc <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    23cc:	50a080e7          	jalr	1290(ra) # 58d2 <sbrk>
  uint64 top = (uint64) sbrk(0);
    23d0:	4501                	li	a0,0
    23d2:	00003097          	auipc	ra,0x3
    23d6:	500080e7          	jalr	1280(ra) # 58d2 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    23e6:	4f0080e7          	jalr	1264(ra) # 58d2 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2402:	49c080e7          	jalr	1180(ra) # 589a <unlink>
  if(ret != -1){
    2406:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2416:	478080e7          	jalr	1144(ra) # 588a <open>
  if(fd != -1){
    241a:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    2428:	486080e7          	jalr	1158(ra) # 58aa <link>
  if(ret != -1){
    242c:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    244c:	43a080e7          	jalr	1082(ra) # 5882 <exec>
  if(ret != -1){
    2450:	57fd                	li	a5,-1
    ...
    246e:	468080e7          	jalr	1128(ra) # 58d2 <sbrk>
    ...
    248a:	3c4080e7          	jalr	964(ra) # 584a <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    248e:	862a                	mv	a2,a0
    2490:	85a6                	mv	a1,s1
    ...
    24a8:	3a6080e7          	jalr	934(ra) # 584a <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    24ac:	862a                	mv	a2,a0
    24ae:	85a6                	mv	a1,s1
    ...
    24c6:	388080e7          	jalr	904(ra) # 584a <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    24ca:	86aa                	mv	a3,a0
    24cc:	8626                	mv	a2,s1
    24ce:	85a6                	mv	a1,s1
    ...
    24e6:	368080e7          	jalr	872(ra) # 584a <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    24ea:	567d                	li	a2,-1
    24ec:	85a6                	mv	a1,s1
    ...
    2504:	34a080e7          	jalr	842(ra) # 584a <exit>
...
0000000000002508 <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    251a:	3bc080e7          	jalr	956(ra) # 58d2 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    252c:	3aa080e7          	jalr	938(ra) # 58d2 <sbrk>
    2530:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2546:	348080e7          	jalr	840(ra) # 588a <open>
    254a:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    255e:	310080e7          	jalr	784(ra) # 586a <write>
    2562:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2580:	2ce080e7          	jalr	718(ra) # 584a <exit>
    ...
    259a:	2b4080e7          	jalr	692(ra) # 584a <exit>
    ...
    25b4:	29a080e7          	jalr	666(ra) # 584a <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    260c:	25a080e7          	jalr	602(ra) # 5862 <read>
    2610:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    262e:	220080e7          	jalr	544(ra) # 584a <exit>
    printf("open(rwsbrk) failed\n");
    ...
    2648:	206080e7          	jalr	518(ra) # 584a <exit>
  close(fd);
    264c:	854a                	mv	a0,s2
    264e:	00003097          	auipc	ra,0x3
    2652:	224080e7          	jalr	548(ra) # 5872 <close>
  exit(0);
    2656:	4501                	li	a0,0
    2658:	00003097          	auipc	ra,0x3
    265c:	1f2080e7          	jalr	498(ra) # 584a <exit>
...
0000000000002660 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    2676:	1d0080e7          	jalr	464(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2688:	24e080e7          	jalr	590(ra) # 58d2 <sbrk>
    ...
    26ae:	1a0080e7          	jalr	416(ra) # 584a <exit>
    ...
    26c8:	186080e7          	jalr	390(ra) # 584a <exit>
      exit(0);
    26cc:	4501                	li	a0,0
    26ce:	00003097          	auipc	ra,0x3
    26d2:	17c080e7          	jalr	380(ra) # 584a <exit>
  wait(&xstatus);
    26d6:	fcc40513          	addi	a0,s0,-52
    26da:	00003097          	auipc	ra,0x3
    26de:	178080e7          	jalr	376(ra) # 5852 <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    26f2:	1e4080e7          	jalr	484(ra) # 58d2 <sbrk>
    26f6:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    26f8:	4901                	li	s2,0
    ...
    271a:	134080e7          	jalr	308(ra) # 584a <exit>
    a = b + 1;
    271e:	84be                	mv	s1,a5
    b = sbrk(1);
    2720:	4505                	li	a0,1
    2722:	00003097          	auipc	ra,0x3
    2726:	1b0080e7          	jalr	432(ra) # 58d2 <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    2742:	104080e7          	jalr	260(ra) # 5842 <fork>
    2746:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    2752:	184080e7          	jalr	388(ra) # 58d2 <sbrk>
  c = sbrk(1);
    2756:	4505                	li	a0,1
    2758:	00003097          	auipc	ra,0x3
    275c:	17a080e7          	jalr	378(ra) # 58d2 <sbrk>
  if(c != a + 1){
    ...
    277e:	0d0080e7          	jalr	208(ra) # 584a <exit>
    ...
    27a0:	0ae080e7          	jalr	174(ra) # 584a <exit>
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2852:	084080e7          	jalr	132(ra) # 58d2 <sbrk>
    2856:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2858:	757d                	lui	a0,0xfffff
    285a:	00003097          	auipc	ra,0x3
    285e:	078080e7          	jalr	120(ra) # 58d2 <sbrk>
  ...
  c = sbrk(0);
    ...
    286e:	068080e7          	jalr	104(ra) # 58d2 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    28be:	018080e7          	jalr	24(ra) # 58d2 <sbrk>
    28c2:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    28c4:	4501                	li	a0,0
    28c6:	00003097          	auipc	ra,0x3
    28ca:	00c080e7          	jalr	12(ra) # 58d2 <sbrk>
    28ce:	40a9053b          	subw	a0,s2,a0
    28d2:	00003097          	auipc	ra,0x3
    28d6:	000080e7          	jalr	ra # 58d2 <sbrk>
  if(c != a){
    ...
    2906:	f48080e7          	jalr	-184(ra) # 584a <exit>
    ...
    2922:	f2c080e7          	jalr	-212(ra) # 584a <exit>
    ...
    2942:	f0c080e7          	jalr	-244(ra) # 584a <exit>
    ...
    2962:	eec080e7          	jalr	-276(ra) # 584a <exit>
    ...
    297e:	ed0080e7          	jalr	-304(ra) # 584a <exit>
    ...
    299e:	eb0080e7          	jalr	-336(ra) # 584a <exit>
...
00000000000029a2 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    29b8:	f1e080e7          	jalr	-226(ra) # 58d2 <sbrk>
    29bc:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    29f2:	e7c080e7          	jalr	-388(ra) # 586a <write>
    29f6:	04054663          	bltz	a0,2a42 <sbrkarg+0xa0>
  close(fd);
    29fa:	8526                	mv	a0,s1
    29fc:	00003097          	auipc	ra,0x3
    2a00:	e76080e7          	jalr	-394(ra) # 5872 <close>
  a = sbrk(PGSIZE);
    2a04:	6505                	lui	a0,0x1
    2a06:	00003097          	auipc	ra,0x3
    2a0a:	ecc080e7          	jalr	-308(ra) # 58d2 <sbrk>
  if(pipe((int *) a) != 0){
    2a0e:	00003097          	auipc	ra,0x3
    2a12:	e4c080e7          	jalr	-436(ra) # 585a <pipe>
    ...
    2a3e:	e10080e7          	jalr	-496(ra) # 584a <exit>
    ...
    2a5a:	df4080e7          	jalr	-524(ra) # 584a <exit>
    printf("%s: pipe() failed\n", s);
    2a5e:	85ce                	mv	a1,s3
    ...
    2a76:	dd8080e7          	jalr	-552(ra) # 584a <exit>
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	df8080e7          	jalr	-520(ra) # 588a <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2aa6:	e30080e7          	jalr	-464(ra) # 58d2 <sbrk>
    2aaa:	567d                	li	a2,-1
    2aac:	fff50593          	addi	a1,a0,-1
    2ab0:	8526                	mv	a0,s1
    2ab2:	00003097          	auipc	ra,0x3
    2ab6:	db0080e7          	jalr	-592(ra) # 5862 <read>
  close(fd);
    2aba:	8526                	mv	a0,s1
    2abc:	00003097          	auipc	ra,0x3
    2ac0:	db6080e7          	jalr	-586(ra) # 5872 <close>
}
    ...
    2ae8:	d66080e7          	jalr	-666(ra) # 584a <exit>
...
0000000000002aec <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2af8:	d4e080e7          	jalr	-690(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b06:	dd0080e7          	jalr	-560(ra) # 58d2 <sbrk>
    sbrk(-sz);
    2b0a:	40a0053b          	negw	a0,a0
    2b0e:	00003097          	auipc	ra,0x3
    2b12:	dc4080e7          	jalr	-572(ra) # 58d2 <sbrk>
    exit(0);
    2b16:	4501                	li	a0,0
    2b18:	00003097          	auipc	ra,0x3
    2b1c:	d32080e7          	jalr	-718(ra) # 584a <exit>
    printf("fork failed\n");
    ...
    2b36:	d18080e7          	jalr	-744(ra) # 584a <exit>
  wait(0);
    2b3a:	4501                	li	a0,0
    2b3c:	00003097          	auipc	ra,0x3
    2b40:	d16080e7          	jalr	-746(ra) # 5852 <wait>
  pid = fork();
    2b44:	00003097          	auipc	ra,0x3
    2b48:	cfe080e7          	jalr	-770(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b8c:	cc2080e7          	jalr	-830(ra) # 584a <exit>
  wait(0);
    2b90:	4501                	li	a0,0
    2b92:	00003097          	auipc	ra,0x3
    2b96:	cc0080e7          	jalr	-832(ra) # 5852 <wait>
  pid = fork();
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	ca8080e7          	jalr	-856(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2bac:	d2a080e7          	jalr	-726(ra) # 58d2 <sbrk>
    ...
    2bbe:	d18080e7          	jalr	-744(ra) # 58d2 <sbrk>
    sbrk(-10);
    2bc2:	5559                	li	a0,-10
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	d0e080e7          	jalr	-754(ra) # 58d2 <sbrk>
    exit(0);
    2bcc:	4501                	li	a0,0
    2bce:	00003097          	auipc	ra,0x3
    2bd2:	c7c080e7          	jalr	-900(ra) # 584a <exit>
    printf("fork failed\n");
    ...
    2bec:	c62080e7          	jalr	-926(ra) # 584a <exit>
  wait(0);
    2bf0:	4501                	li	a0,0
    2bf2:	00003097          	auipc	ra,0x3
    2bf6:	c60080e7          	jalr	-928(ra) # 5852 <wait>
  exit(0);
    2bfa:	4501                	li	a0,0
    2bfc:	00003097          	auipc	ra,0x3
    2c00:	c4e080e7          	jalr	-946(ra) # 584a <exit>
...
0000000000002c04 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2c1a:	cbc080e7          	jalr	-836(ra) # 58d2 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2c2a:	cac080e7          	jalr	-852(ra) # 58d2 <sbrk>
  sbrk(10);
    2c2e:	4529                	li	a0,10
    2c30:	00003097          	auipc	ra,0x3
    2c34:	ca2080e7          	jalr	-862(ra) # 58d2 <sbrk>
  sbrk(-20);
    2c38:	5531                	li	a0,-20
    2c3a:	00003097          	auipc	ra,0x3
    2c3e:	c98080e7          	jalr	-872(ra) # 58d2 <sbrk>
  top = (uint64) sbrk(0);
    2c42:	4501                	li	a0,0
    2c44:	00003097          	auipc	ra,0x3
    2c48:	c8e080e7          	jalr	-882(ra) # 58d2 <sbrk>
    2c4c:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2c68:	c26080e7          	jalr	-986(ra) # 588a <open>
    2c6c:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2c6e:	4605                	li	a2,1
    2c70:	85ca                	mv	a1,s2
    2c72:	00003097          	auipc	ra,0x3
    2c76:	bf8080e7          	jalr	-1032(ra) # 586a <write>
  close(fd);
    2c7a:	854e                	mv	a0,s3
    2c7c:	00003097          	auipc	ra,0x3
    2c80:	bf6080e7          	jalr	-1034(ra) # 5872 <close>
  fd = open(p, O_RDWR);
    2c84:	4589                	li	a1,2
    2c86:	854a                	mv	a0,s2
    2c88:	00003097          	auipc	ra,0x3
    2c8c:	c02080e7          	jalr	-1022(ra) # 588a <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2c9c:	bca080e7          	jalr	-1078(ra) # 5862 <read>
  if(p[0] != 'x')
    ...
    2cc6:	c10080e7          	jalr	-1008(ra) # 58d2 <sbrk>
    2cca:	bfa9                	j	2c24 <sbrklast+0x20>
    exit(1);
    2ccc:	4505                	li	a0,1
    2cce:	00003097          	auipc	ra,0x3
    2cd2:	b7c080e7          	jalr	-1156(ra) # 584a <exit>
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce8:	bee080e7          	jalr	-1042(ra) # 58d2 <sbrk>
  volatile char *top = sbrk(0);
    2cec:	4501                	li	a0,0
    2cee:	00003097          	auipc	ra,0x3
    2cf2:	be4080e7          	jalr	-1052(ra) # 58d2 <sbrk>
  *(top-1) = *(top-1) + 1;
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2d24:	b22080e7          	jalr	-1246(ra) # 5842 <fork>
    2d28:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2d36:	b20080e7          	jalr	-1248(ra) # 5852 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2d46:	b08080e7          	jalr	-1272(ra) # 584a <exit>
      printf("fork failed\n");
    ...
    2d60:	aee080e7          	jalr	-1298(ra) # 584a <exit>
        if(a == 0xffffffffffffffffLL)
    2d64:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2d66:	4a05                	li	s4,1
    ...
    2d6e:	b68080e7          	jalr	-1176(ra) # 58d2 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2d8a:	b4c080e7          	jalr	-1204(ra) # 58d2 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2d9a:	adc080e7          	jalr	-1316(ra) # 5872 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    2dc2:	ac4080e7          	jalr	-1340(ra) # 5882 <exec>
      exit(0);
    2dc6:	4501                	li	a0,0
    2dc8:	00003097          	auipc	ra,0x3
    2dcc:	a82080e7          	jalr	-1406(ra) # 584a <exit>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	ace080e7          	jalr	-1330(ra) # 58b2 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	abc080e7          	jalr	-1348(ra) # 58b2 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	a5a080e7          	jalr	-1446(ra) # 58b2 <mkdir>
  ...
  unlink("12345678901234");
    ...
    2ee4:	96a080e7          	jalr	-1686(ra) # 584a <exit>
    ...
    2f00:	94e080e7          	jalr	-1714(ra) # 584a <exit>
    ...
    2f1c:	932080e7          	jalr	-1742(ra) # 584a <exit>
    ...
    2f38:	916080e7          	jalr	-1770(ra) # 584a <exit>
    ...
    2f54:	8fa080e7          	jalr	-1798(ra) # 584a <exit>
    ...
    2f70:	8de080e7          	jalr	-1826(ra) # 584a <exit>
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	92a080e7          	jalr	-1750(ra) # 58b2 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	91e080e7          	jalr	-1762(ra) # 58ba <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	8ea080e7          	jalr	-1814(ra) # 589a <unlink>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	8f6080e7          	jalr	-1802(ra) # 58ba <chdir>
    ...
    2ff2:	85c080e7          	jalr	-1956(ra) # 584a <exit>
    ...
    300e:	840080e7          	jalr	-1984(ra) # 584a <exit>
    ...
    302a:	824080e7          	jalr	-2012(ra) # 584a <exit>
    ...
    3046:	808080e7          	jalr	-2040(ra) # 584a <exit>
...
000000000000304a <exitiputtest>:
{
  ...
  pid = fork();
    ...
    305a:	7ec080e7          	jalr	2028(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3070:	846080e7          	jalr	-1978(ra) # 58b2 <mkdir>
    ...
    3084:	83a080e7          	jalr	-1990(ra) # 58ba <chdir>
    ...
    3098:	806080e7          	jalr	-2042(ra) # 589a <unlink>
    309c:	06054163          	bltz	a0,30fe <exitiputtest+0xb4>
    exit(0);
    30a0:	4501                	li	a0,0
    30a2:	00002097          	auipc	ra,0x2
    30a6:	7a8080e7          	jalr	1960(ra) # 584a <exit>
    printf("%s: fork failed\n", s);
    30aa:	85a6                	mv	a1,s1
    ...
    30c2:	78c080e7          	jalr	1932(ra) # 584a <exit>
      printf("%s: mkdir failed\n", s);
    30c6:	85a6                	mv	a1,s1
    ...
    30de:	770080e7          	jalr	1904(ra) # 584a <exit>
    ...
    30fa:	754080e7          	jalr	1876(ra) # 584a <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    30fe:	85a6                	mv	a1,s1
    ...
    3116:	738080e7          	jalr	1848(ra) # 584a <exit>
  wait(&xstatus);
    311a:	fdc40513          	addi	a0,s0,-36
    311e:	00002097          	auipc	ra,0x2
    3122:	734080e7          	jalr	1844(ra) # 5852 <wait>
  exit(xstatus);
    3126:	fdc42503          	lw	a0,-36(s0)
    312a:	00002097          	auipc	ra,0x2
    312e:	720080e7          	jalr	1824(ra) # 584a <exit>
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	76c080e7          	jalr	1900(ra) # 58b2 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	760080e7          	jalr	1888(ra) # 58ba <chdir>
  ...
  if(chdir("..") < 0){
    ...
    3172:	74c080e7          	jalr	1868(ra) # 58ba <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	718080e7          	jalr	1816(ra) # 589a <unlink>
    ...
    31b0:	69e080e7          	jalr	1694(ra) # 584a <exit>
    ...
    31cc:	682080e7          	jalr	1666(ra) # 584a <exit>
    printf("%s: chdir .. failed\n", s);
    31d0:	85a6                	mv	a1,s1
    ...
    31e8:	666080e7          	jalr	1638(ra) # 584a <exit>
    ...
    3204:	64a080e7          	jalr	1610(ra) # 584a <exit>
...
0000000000003208 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	644080e7          	jalr	1604(ra) # 588a <open>
    324e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	626080e7          	jalr	1574(ra) # 58b2 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	5e6080e7          	jalr	1510(ra) # 588a <open>
    32ac:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	572080e7          	jalr	1394(ra) # 5862 <read>
  if(cc != 2 || buf[0] != 'f'){
    32f8:	4789                	li	a5,2
  ...
  close(fd);
    ...
    3314:	562080e7          	jalr	1378(ra) # 5872 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    332c:	582080e7          	jalr	1410(ra) # 58aa <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	55e080e7          	jalr	1374(ra) # 589a <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	538080e7          	jalr	1336(ra) # 588a <open>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	554080e7          	jalr	1364(ra) # 58ba <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	540080e7          	jalr	1344(ra) # 58ba <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	52c080e7          	jalr	1324(ra) # 58ba <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	518080e7          	jalr	1304(ra) # 58ba <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	4d2080e7          	jalr	1234(ra) # 588a <open>
    33c0:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	480080e7          	jalr	1152(ra) # 588a <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	468080e7          	jalr	1128(ra) # 588a <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	450080e7          	jalr	1104(ra) # 588a <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	43a080e7          	jalr	1082(ra) # 588a <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	424080e7          	jalr	1060(ra) # 588a <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3486:	428080e7          	jalr	1064(ra) # 58aa <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34a2:	40c080e7          	jalr	1036(ra) # 58aa <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34be:	3f0080e7          	jalr	1008(ra) # 58aa <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	3e4080e7          	jalr	996(ra) # 58b2 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	3d0080e7          	jalr	976(ra) # 58b2 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	3bc080e7          	jalr	956(ra) # 58b2 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	390080e7          	jalr	912(ra) # 589a <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	37c080e7          	jalr	892(ra) # 589a <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	388080e7          	jalr	904(ra) # 58ba <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	374080e7          	jalr	884(ra) # 58ba <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	340080e7          	jalr	832(ra) # 589a <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	32c080e7          	jalr	812(ra) # 589a <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	318080e7          	jalr	792(ra) # 589a <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	304080e7          	jalr	772(ra) # 589a <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	2f0080e7          	jalr	752(ra) # 589a <unlink>
    ...
    35da:	274080e7          	jalr	628(ra) # 584a <exit>
    ...
    35f6:	258080e7          	jalr	600(ra) # 584a <exit>
    ...
    3612:	23c080e7          	jalr	572(ra) # 584a <exit>
    ...
    362e:	220080e7          	jalr	544(ra) # 584a <exit>
    ...
    364a:	204080e7          	jalr	516(ra) # 584a <exit>
    ...
    3666:	1e8080e7          	jalr	488(ra) # 584a <exit>
    ...
    3682:	1cc080e7          	jalr	460(ra) # 584a <exit>
    ...
    369e:	1b0080e7          	jalr	432(ra) # 584a <exit>
    ...
    36ba:	194080e7          	jalr	404(ra) # 584a <exit>
    ...
    36d6:	178080e7          	jalr	376(ra) # 584a <exit>
    ...
    36f2:	15c080e7          	jalr	348(ra) # 584a <exit>
    ...
    370e:	140080e7          	jalr	320(ra) # 584a <exit>
    ...
    372a:	124080e7          	jalr	292(ra) # 584a <exit>
    printf("%s: chdir ./.. failed\n", s);
    372e:	85ca                	mv	a1,s2
    ...
    3746:	108080e7          	jalr	264(ra) # 584a <exit>
    ...
    3762:	0ec080e7          	jalr	236(ra) # 584a <exit>
    ...
    377e:	0d0080e7          	jalr	208(ra) # 584a <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    3782:	85ca                	mv	a1,s2
    ...
    379a:	0b4080e7          	jalr	180(ra) # 584a <exit>
    ...
    37b6:	098080e7          	jalr	152(ra) # 584a <exit>
    ...
    37d2:	07c080e7          	jalr	124(ra) # 584a <exit>
    ...
    37ee:	060080e7          	jalr	96(ra) # 584a <exit>
    ...
    380a:	044080e7          	jalr	68(ra) # 584a <exit>
    ...
    3826:	028080e7          	jalr	40(ra) # 584a <exit>
    ...
    3842:	00c080e7          	jalr	12(ra) # 584a <exit>
    ...
    385e:	ff0080e7          	jalr	-16(ra) # 584a <exit>
    ...
    387a:	fd4080e7          	jalr	-44(ra) # 584a <exit>
    ...
    3896:	fb8080e7          	jalr	-72(ra) # 584a <exit>
    ...
    38b2:	f9c080e7          	jalr	-100(ra) # 584a <exit>
    ...
    38ce:	f80080e7          	jalr	-128(ra) # 584a <exit>
    ...
    38ea:	f64080e7          	jalr	-156(ra) # 584a <exit>
    ...
    3906:	f48080e7          	jalr	-184(ra) # 584a <exit>
    ...
    3922:	f2c080e7          	jalr	-212(ra) # 584a <exit>
    ...
    393e:	f10080e7          	jalr	-240(ra) # 584a <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3942:	85ca                	mv	a1,s2
    ...
    395a:	ef4080e7          	jalr	-268(ra) # 584a <exit>
    ...
    3976:	ed8080e7          	jalr	-296(ra) # 584a <exit>
    ...
    3992:	ebc080e7          	jalr	-324(ra) # 584a <exit>
    ...
    39ae:	ea0080e7          	jalr	-352(ra) # 584a <exit>
    ...
    39ca:	e84080e7          	jalr	-380(ra) # 584a <exit>
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	ed0080e7          	jalr	-304(ra) # 58b2 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	ec6080e7          	jalr	-314(ra) # 58ba <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	e94080e7          	jalr	-364(ra) # 589a <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	e82080e7          	jalr	-382(ra) # 589a <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	e90080e7          	jalr	-368(ra) # 58ba <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	e5e080e7          	jalr	-418(ra) # 589a <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	e4c080e7          	jalr	-436(ra) # 589a <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	e3a080e7          	jalr	-454(ra) # 589a <unlink>
    ...
    3a8c:	dc2080e7          	jalr	-574(ra) # 584a <exit>
    ...
    3aa8:	da6080e7          	jalr	-602(ra) # 584a <exit>
    printf("%s: rm . worked!\n", s);
    3aac:	85a6                	mv	a1,s1
    ...
    3ac4:	d8a080e7          	jalr	-630(ra) # 584a <exit>
    printf("%s: rm .. worked!\n", s);
    3ac8:	85a6                	mv	a1,s1
    ...
    3ae0:	d6e080e7          	jalr	-658(ra) # 584a <exit>
    printf("%s: chdir / failed\n", s);
    3ae4:	85a6                	mv	a1,s1
    ...
    3afc:	d52080e7          	jalr	-686(ra) # 584a <exit>
    ...
    3b18:	d36080e7          	jalr	-714(ra) # 584a <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3b1c:	85a6                	mv	a1,s1
    ...
    3b34:	d1a080e7          	jalr	-742(ra) # 584a <exit>
    ...
    3b50:	cfe080e7          	jalr	-770(ra) # 584a <exit>
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	cec080e7          	jalr	-788(ra) # 588a <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	cd4080e7          	jalr	-812(ra) # 588a <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	ce8080e7          	jalr	-792(ra) # 58b2 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	cbc080e7          	jalr	-836(ra) # 589a <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bfe:	cb0080e7          	jalr	-848(ra) # 58aa <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	c8c080e7          	jalr	-884(ra) # 589a <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	c66080e7          	jalr	-922(ra) # 588a <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    3c3e:	c50080e7          	jalr	-944(ra) # 588a <open>
    3c42:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3c44:	4605                	li	a2,1
    ...
    3c52:	c1c080e7          	jalr	-996(ra) # 586a <write>
    3c56:	10a04b63          	bgtz	a0,3d6c <dirfile+0x218>
  close(fd);
    3c5a:	8526                	mv	a0,s1
    3c5c:	00002097          	auipc	ra,0x2
    3c60:	c16080e7          	jalr	-1002(ra) # 5872 <close>
}
    ...
    3c88:	bc6080e7          	jalr	-1082(ra) # 584a <exit>
    ...
    3ca4:	baa080e7          	jalr	-1110(ra) # 584a <exit>
    ...
    3cc0:	b8e080e7          	jalr	-1138(ra) # 584a <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3cc4:	85ca                	mv	a1,s2
    ...
    3cdc:	b72080e7          	jalr	-1166(ra) # 584a <exit>
    ...
    3cf8:	b56080e7          	jalr	-1194(ra) # 584a <exit>
    ...
    3d14:	b3a080e7          	jalr	-1222(ra) # 584a <exit>
    ...
    3d30:	b1e080e7          	jalr	-1250(ra) # 584a <exit>
    ...
    3d4c:	b02080e7          	jalr	-1278(ra) # 584a <exit>
    ...
    3d68:	ae6080e7          	jalr	-1306(ra) # 584a <exit>
    ...
    3d84:	aca080e7          	jalr	-1334(ra) # 584a <exit>
...
0000000000003d88 <iref>:
{
    ...
    3ddc:	a72080e7          	jalr	-1422(ra) # 584a <exit>
    ...
    3df8:	a56080e7          	jalr	-1450(ra) # 584a <exit>
      close(fd);
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	a76080e7          	jalr	-1418(ra) # 5872 <close>
    3e04:	a889                	j	3e56 <iref+0xce>
    unlink("xx");
    3e06:	854e                	mv	a0,s3
    3e08:	00002097          	auipc	ra,0x2
    3e0c:	a92080e7          	jalr	-1390(ra) # 589a <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e60:	a2e080e7          	jalr	-1490(ra) # 588a <open>
    if(fd >= 0)
    3e64:	fa0541e3          	bltz	a0,3e06 <iref+0x7e>
      close(fd);
    3e68:	00002097          	auipc	ra,0x2
    3e6c:	a0a080e7          	jalr	-1526(ra) # 5872 <close>
    ...
    3e8c:	a32080e7          	jalr	-1486(ra) # 58ba <chdir>
    unlink("irefd");
    3e90:	854a                	mv	a0,s2
    3e92:	00002097          	auipc	ra,0x2
    3e96:	a08080e7          	jalr	-1528(ra) # 589a <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    3eaa:	a14080e7          	jalr	-1516(ra) # 58ba <chdir>
}
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	9dc080e7          	jalr	-1572(ra) # 58b2 <mkdir>
    3ede:	04054263          	bltz	a0,3f22 <openiputtest+0x60>
  pid = fork();
    3ee2:	00002097          	auipc	ra,0x2
    3ee6:	960080e7          	jalr	-1696(ra) # 5842 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3efe:	990080e7          	jalr	-1648(ra) # 588a <open>
    if(fd >= 0){
    ...
    3f1e:	930080e7          	jalr	-1744(ra) # 584a <exit>
    ...
    3f3a:	914080e7          	jalr	-1772(ra) # 584a <exit>
    printf("%s: fork failed\n", s);
    3f3e:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    3f98:	8b6080e7          	jalr	-1866(ra) # 584a <exit>
  wait(&xstatus);
    3f9c:	fdc40513          	addi	a0,s0,-36
    3fa0:	00002097          	auipc	ra,0x2
    3fa4:	8b2080e7          	jalr	-1870(ra) # 5852 <wait>
  exit(xstatus);
    3fa8:	fdc42503          	lw	a0,-36(s0)
    3fac:	00002097          	auipc	ra,0x2
    3fb0:	89e080e7          	jalr	-1890(ra) # 584a <exit>
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	8d2080e7          	jalr	-1838(ra) # 589a <unlink>
  int pid = fork();
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	872080e7          	jalr	-1934(ra) # 5842 <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    3fe4:	8fa080e7          	jalr	-1798(ra) # 58da <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	896080e7          	jalr	-1898(ra) # 588a <open>
    3ffc:	00002097          	auipc	ra,0x2
    4000:	876080e7          	jalr	-1930(ra) # 5872 <close>
  wait(0);
    4004:	4501                	li	a0,0
    4006:	00002097          	auipc	ra,0x2
    400a:	84c080e7          	jalr	-1972(ra) # 5852 <wait>
  sleep(10); // one second
    400e:	4529                	li	a0,10
    4010:	00002097          	auipc	ra,0x2
    4014:	8ca080e7          	jalr	-1846(ra) # 58da <sleep>
}
    ...
    403a:	814080e7          	jalr	-2028(ra) # 584a <exit>
...
0000000000004084 <killstatus>:
{
    ...
    40a0:	7a6080e7          	jalr	1958(ra) # 5842 <fork>
    40a4:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    40b2:	82c080e7          	jalr	-2004(ra) # 58da <sleep>
    kill(pid1);
    40b6:	8526                	mv	a0,s1
    40b8:	00001097          	auipc	ra,0x1
    40bc:	7c2080e7          	jalr	1986(ra) # 587a <kill>
    wait(&xst);
    40c0:	fcc40513          	addi	a0,s0,-52
    40c4:	00001097          	auipc	ra,0x1
    40c8:	78e080e7          	jalr	1934(ra) # 5852 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    40e0:	76e080e7          	jalr	1902(ra) # 584a <exit>
      printf("%s: fork failed\n", s);
    40e4:	85d2                	mv	a1,s4
    ...
    40fc:	752080e7          	jalr	1874(ra) # 584a <exit>
        getpid();
    4100:	00001097          	auipc	ra,0x1
    4104:	7ca080e7          	jalr	1994(ra) # 58ca <getpid>
      while(1) {
    ...
    4122:	72c080e7          	jalr	1836(ra) # 584a <exit>
...
0000000000004126 <preempt>:
{
  ...
  pid1 = fork();
    ...
    413c:	70a080e7          	jalr	1802(ra) # 5842 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    4162:	6ec080e7          	jalr	1772(ra) # 584a <exit>
  pid2 = fork();
    4166:	00001097          	auipc	ra,0x1
    416a:	6dc080e7          	jalr	1756(ra) # 5842 <fork>
    416e:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4190:	6be080e7          	jalr	1726(ra) # 584a <exit>
  pipe(pfds);
    4194:	fc840513          	addi	a0,s0,-56
    4198:	00001097          	auipc	ra,0x1
    419c:	6c2080e7          	jalr	1730(ra) # 585a <pipe>
  pid3 = fork();
    41a0:	00001097          	auipc	ra,0x1
    41a4:	6a2080e7          	jalr	1698(ra) # 5842 <fork>
    41a8:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    41b8:	6be080e7          	jalr	1726(ra) # 5872 <close>
    ...
    41fe:	650080e7          	jalr	1616(ra) # 584a <exit>
  ...
  close(pfds[1]);
    ...
    421e:	658080e7          	jalr	1624(ra) # 5872 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4234:	632080e7          	jalr	1586(ra) # 5862 <read>
    4238:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    4268:	60e080e7          	jalr	1550(ra) # 5872 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    4282:	5fc080e7          	jalr	1532(ra) # 587a <kill>
  kill(pid2);
    4286:	854e                	mv	a0,s3
    4288:	00001097          	auipc	ra,0x1
    428c:	5f2080e7          	jalr	1522(ra) # 587a <kill>
  kill(pid3);
    4290:	8552                	mv	a0,s4
    4292:	00001097          	auipc	ra,0x1
    4296:	5e8080e7          	jalr	1512(ra) # 587a <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    42b0:	5a6080e7          	jalr	1446(ra) # 5852 <wait>
  wait(0);
    42b4:	4501                	li	a0,0
    42b6:	00001097          	auipc	ra,0x1
    42ba:	59c080e7          	jalr	1436(ra) # 5852 <wait>
  wait(0);
    42be:	4501                	li	a0,0
    42c0:	00001097          	auipc	ra,0x1
    42c4:	592080e7          	jalr	1426(ra) # 5852 <wait>
...
00000000000042ca <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    42e0:	5ee080e7          	jalr	1518(ra) # 58ca <getpid>
    42e4:	8a2a                	mv	s4,a0
    42e6:	0c800913          	li	s2,200
    int pid = fork();
    42ea:	00001097          	auipc	ra,0x1
    42ee:	558080e7          	jalr	1368(ra) # 5842 <fork>
    42f2:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4300:	556080e7          	jalr	1366(ra) # 5852 <wait>
  ...
  exit(0);
    ...
    4314:	53a080e7          	jalr	1338(ra) # 584a <exit>
      printf("%s: fork failed\n", s);
    4318:	85ce                	mv	a1,s3
    ...
    4330:	51e080e7          	jalr	1310(ra) # 584a <exit>
        printf("%s: wait wrong pid\n", s);
    4334:	85ce                	mv	a1,s3
    ...
    434c:	502080e7          	jalr	1282(ra) # 584a <exit>
      int pid2 = fork();
    4350:	00001097          	auipc	ra,0x1
    4354:	4f2080e7          	jalr	1266(ra) # 5842 <fork>
      if(pid2 < 0){
    4358:	00054763          	bltz	a0,4366 <reparent+0x9c>
      exit(0);
    435c:	4501                	li	a0,0
    435e:	00001097          	auipc	ra,0x1
    4362:	4ec080e7          	jalr	1260(ra) # 584a <exit>
        kill(master_pid);
    4366:	8552                	mv	a0,s4
    4368:	00001097          	auipc	ra,0x1
    436c:	512080e7          	jalr	1298(ra) # 587a <kill>
        exit(1);
    4370:	4505                	li	a0,1
    4372:	00001097          	auipc	ra,0x1
    4376:	4d8080e7          	jalr	1240(ra) # 584a <exit>
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4396:	4c8080e7          	jalr	1224(ra) # 585a <pipe>
    ...
    43f0:	47e080e7          	jalr	1150(ra) # 586a <write>
      for(;;) sleep(1000);
    43f4:	3e800513          	li	a0,1000
    43f8:	00001097          	auipc	ra,0x1
    43fc:	4e2080e7          	jalr	1250(ra) # 58da <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    440c:	43a080e7          	jalr	1082(ra) # 5842 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    444e:	430080e7          	jalr	1072(ra) # 587a <kill>
    wait(0);
    4452:	4501                	li	a0,0
    4454:	00001097          	auipc	ra,0x1
    4458:	3fe080e7          	jalr	1022(ra) # 5852 <wait>
  ...
  pid = fork();
    ...
    4468:	3de080e7          	jalr	990(ra) # 5842 <fork>
    446c:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    447c:	3da080e7          	jalr	986(ra) # 5852 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    44ba:	394080e7          	jalr	916(ra) # 584a <exit>
    printf("%s: fork failed\n", s);
    44be:	85d6                	mv	a1,s5
    ...
    44d6:	378080e7          	jalr	888(ra) # 584a <exit>
    a = sbrk(0);
    44da:	4501                	li	a0,0
    44dc:	00001097          	auipc	ra,0x1
    44e0:	3f6080e7          	jalr	1014(ra) # 58d2 <sbrk>
    44e4:	892a                	mv	s2,a0
    sbrk(10*BIG);
    44e6:	3e800537          	lui	a0,0x3e800
    44ea:	00001097          	auipc	ra,0x1
    44ee:	3e8080e7          	jalr	1000(ra) # 58d2 <sbrk>
    ...
    4522:	32c080e7          	jalr	812(ra) # 584a <exit>
    exit(1);
    4526:	4505                	li	a0,1
    4528:	00001097          	auipc	ra,0x1
    452c:	322080e7          	jalr	802(ra) # 584a <exit>
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4544:	302080e7          	jalr	770(ra) # 5842 <fork>
    m1 = 0;
    4548:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    455a:	2fc080e7          	jalr	764(ra) # 5852 <wait>
    if(xstatus == -1){
    ...
    456c:	2e2080e7          	jalr	738(ra) # 584a <exit>
      *(char**)m2 = m1;
    ...
    45aa:	2a4080e7          	jalr	676(ra) # 584a <exit>
    ...
    45c6:	288080e7          	jalr	648(ra) # 584a <exit>
      exit(0);
    45ca:	4501                	li	a0,0
    45cc:	00001097          	auipc	ra,0x1
    45d0:	27e080e7          	jalr	638(ra) # 584a <exit>
...
00000000000045d4 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    45f8:	2a6080e7          	jalr	678(ra) # 589a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    460c:	282080e7          	jalr	642(ra) # 588a <open>
  if(fd < 0){
    4610:	04054a63          	bltz	a0,4664 <sharedfd+0x90>
    4614:	892a                	mv	s2,a0
  pid = fork();
    4616:	00001097          	auipc	ra,0x1
    461a:	22c080e7          	jalr	556(ra) # 5842 <fork>
    461e:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4648:	226080e7          	jalr	550(ra) # 586a <write>
    464c:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    4660:	1ee080e7          	jalr	494(ra) # 584a <exit>
    ...
    467c:	1d2080e7          	jalr	466(ra) # 584a <exit>
    ...
    4698:	1b6080e7          	jalr	438(ra) # 584a <exit>
    wait(&xstatus);
    469c:	f9c40513          	addi	a0,s0,-100
    46a0:	00001097          	auipc	ra,0x1
    46a4:	1b2080e7          	jalr	434(ra) # 5852 <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    46f6:	170080e7          	jalr	368(ra) # 5862 <read>
    ...
    471c:	132080e7          	jalr	306(ra) # 584a <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    477e:	0d0080e7          	jalr	208(ra) # 584a <exit>
    exit(0);
    4782:	4501                	li	a0,0
    4784:	00001097          	auipc	ra,0x1
    4788:	0c6080e7          	jalr	198(ra) # 584a <exit>
...
000000000000478c <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    47f2:	0ac080e7          	jalr	172(ra) # 589a <unlink>
    pid = fork();
    47f6:	00001097          	auipc	ra,0x1
    47fa:	04c080e7          	jalr	76(ra) # 5842 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4816:	040080e7          	jalr	64(ra) # 5852 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4860:	fee080e7          	jalr	-18(ra) # 584a <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4864:	20200593          	li	a1,514
    4868:	854e                	mv	a0,s3
    486a:	00001097          	auipc	ra,0x1
    486e:	020080e7          	jalr	32(ra) # 588a <open>
    4872:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    48a6:	fc8080e7          	jalr	-56(ra) # 586a <write>
    48aa:	85aa                	mv	a1,a0
    ...
    48be:	f90080e7          	jalr	-112(ra) # 584a <exit>
    ...
    48dc:	f72080e7          	jalr	-142(ra) # 584a <exit>
    ...
    48f6:	f58080e7          	jalr	-168(ra) # 584a <exit>
      exit(xstatus);
    48fa:	855a                	mv	a0,s6
    48fc:	00001097          	auipc	ra,0x1
    4900:	f4e080e7          	jalr	-178(ra) # 584a <exit>
          printf("wrong char\n", s);
    ...
    491e:	f30080e7          	jalr	-208(ra) # 584a <exit>
      total += n;
    ...
    4930:	f36080e7          	jalr	-202(ra) # 5862 <read>
    ...
    4960:	f16080e7          	jalr	-234(ra) # 5872 <close>
    if(total != N*SZ){
    4964:	03b91863          	bne	s2,s11,4994 <fourfiles+0x208>
    unlink(fname);
    4968:	8566                	mv	a0,s9
    496a:	00001097          	auipc	ra,0x1
    496e:	f30080e7          	jalr	-208(ra) # 589a <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4986:	f08080e7          	jalr	-248(ra) # 588a <open>
    498a:	89aa                	mv	s3,a0
    total = 0;
    498c:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    49ac:	ea2080e7          	jalr	-350(ra) # 584a <exit>
}
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a10:	e9e080e7          	jalr	-354(ra) # 58aa <link>
    if(pid == 0) {
    ...
    4a2e:	e60080e7          	jalr	-416(ra) # 588a <open>
      if(fd < 0){
    ...
    4a50:	dfe080e7          	jalr	-514(ra) # 584a <exit>
      link("C0", file);
    ...
    4a64:	e4a080e7          	jalr	-438(ra) # 58aa <link>
      exit(0);
    4a68:	4501                	li	a0,0
    4a6a:	00001097          	auipc	ra,0x1
    4a6e:	de0080e7          	jalr	-544(ra) # 584a <exit>
        exit(1);
    4a72:	4505                	li	a0,1
    4a74:	00001097          	auipc	ra,0x1
    4a78:	dd6080e7          	jalr	-554(ra) # 584a <exit>
  ...
  fd = open(".", 0);
    ...
    4a9c:	df2080e7          	jalr	-526(ra) # 588a <open>
    4aa0:	892a                	mv	s2,a0
  n = 0;
    4aa2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4aba:	dac080e7          	jalr	-596(ra) # 5862 <read>
    ...
    4b1e:	d30080e7          	jalr	-720(ra) # 584a <exit>
    ...
    4b3e:	d10080e7          	jalr	-752(ra) # 584a <exit>
  close(fd);
    4b42:	854a                	mv	a0,s2
    4b44:	00001097          	auipc	ra,0x1
    4b48:	d2e080e7          	jalr	-722(ra) # 5872 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4b76:	cd8080e7          	jalr	-808(ra) # 584a <exit>
      printf("%s: fork failed\n", s);
    4b7a:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    4c3a:	c0c080e7          	jalr	-1012(ra) # 5842 <fork>
    4c3e:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    4ce6:	bb8080e7          	jalr	-1096(ra) # 589a <unlink>
    pid = fork();
    4cea:	00001097          	auipc	ra,0x1
    4cee:	b58080e7          	jalr	-1192(ra) # 5842 <fork>
    if(pid && (i % 3) == 1){
    ...
    4d0a:	b84080e7          	jalr	-1148(ra) # 588a <open>
      if(fd < 0){
...
0000000000004d2a <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4d4a:	b54080e7          	jalr	-1196(ra) # 589a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    4d5e:	b30080e7          	jalr	-1232(ra) # 588a <open>
    4d62:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4d64:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    4d90:	ade080e7          	jalr	-1314(ra) # 586a <write>
  ...
  if(fd < 0){
    ...
    4ddc:	a8a080e7          	jalr	-1398(ra) # 5862 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e28:	a26080e7          	jalr	-1498(ra) # 584a <exit>
    ...
    4e44:	a0a080e7          	jalr	-1526(ra) # 584a <exit>
    ...
    4e60:	9ee080e7          	jalr	-1554(ra) # 584a <exit>
    ...
    4e7c:	9d2080e7          	jalr	-1582(ra) # 584a <exit>
    ...
    4e98:	9b6080e7          	jalr	-1610(ra) # 584a <exit>
    ...
    4eb4:	99a080e7          	jalr	-1638(ra) # 584a <exit>
  close(fd);
    4eb8:	8552                	mv	a0,s4
    4eba:	00001097          	auipc	ra,0x1
    4ebe:	9b8080e7          	jalr	-1608(ra) # 5872 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    4ed8:	9c6080e7          	jalr	-1594(ra) # 589a <unlink>
}
    ...
    4f06:	948080e7          	jalr	-1720(ra) # 584a <exit>
...
0000000000004f0a <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fb4:	8da080e7          	jalr	-1830(ra) # 588a <open>
    4fb8:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    502e:	870080e7          	jalr	-1936(ra) # 589a <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    5078:	7f6080e7          	jalr	2038(ra) # 586a <write>
      if(cc < BSIZE)
    ...
    509e:	7d8080e7          	jalr	2008(ra) # 5872 <close>
    if(total == 0)
...
00000000000050aa <badwrite>:
{
  ...
  unlink("junk");
    ...
    50c6:	7d8080e7          	jalr	2008(ra) # 589a <unlink>
    ...
    50e6:	7a8080e7          	jalr	1960(ra) # 588a <open>
    50ea:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    50f8:	776080e7          	jalr	1910(ra) # 586a <write>
    close(fd);
    50fc:	8526                	mv	a0,s1
    50fe:	00000097          	auipc	ra,0x0
    5102:	774080e7          	jalr	1908(ra) # 5872 <close>
    unlink("junk");
    5106:	854e                	mv	a0,s3
    5108:	00000097          	auipc	ra,0x0
    510c:	792080e7          	jalr	1938(ra) # 589a <unlink>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5126:	768080e7          	jalr	1896(ra) # 588a <open>
    512a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513e:	730080e7          	jalr	1840(ra) # 586a <write>
    5142:	4785                	li	a5,1
    ...
    515e:	6f0080e7          	jalr	1776(ra) # 584a <exit>
    ...
    5178:	6d6080e7          	jalr	1750(ra) # 584a <exit>
    printf("open junk failed\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    51d0:	68e080e7          	jalr	1678(ra) # 585a <pipe>
  ...
  int pid = fork();
    ...
    51dc:	66a080e7          	jalr	1642(ra) # 5842 <fork>
  ...
  if(pid == 0){
    ...
    51ee:	688080e7          	jalr	1672(ra) # 5872 <close>
    ...
    5204:	6d2080e7          	jalr	1746(ra) # 58d2 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5220:	64e080e7          	jalr	1614(ra) # 586a <write>
    ...
    523e:	610080e7          	jalr	1552(ra) # 584a <exit>
    printf("pipe() failed in countfree()\n");
    ...
    5258:	5f6080e7          	jalr	1526(ra) # 584a <exit>
    printf("fork failed in countfree()\n");
    ...
    5272:	5dc080e7          	jalr	1500(ra) # 584a <exit>
      }
    }
    ...
    527c:	5d2080e7          	jalr	1490(ra) # 584a <exit>
  }

  close(fds[1]);
    5280:	fcc42503          	lw	a0,-52(s0)
    5284:	00000097          	auipc	ra,0x0
    5288:	5ee080e7          	jalr	1518(ra) # 5872 <close>
  ...
  while(1){
    ...
    529c:	5ca080e7          	jalr	1482(ra) # 5862 <read>
    if(cc < 0){
  ...
  while(1){
    ...
    52c0:	58e080e7          	jalr	1422(ra) # 584a <exit>
  }

  close(fds[0]);
    52c4:	fc842503          	lw	a0,-56(s0)
    52c8:	00000097          	auipc	ra,0x0
    52cc:	5aa080e7          	jalr	1450(ra) # 5872 <close>
  wait((int*)0);
    52d0:	4501                	li	a0,0
    52d2:	00000097          	auipc	ra,0x0
    52d6:	580080e7          	jalr	1408(ra) # 5852 <wait>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    530e:	538080e7          	jalr	1336(ra) # 5842 <fork>
  ...
  if(pid == 0) {
    ...
    5320:	536080e7          	jalr	1334(ra) # 5852 <wait>
    if(xstatus != 0) 
    ...
    5364:	4ea080e7          	jalr	1258(ra) # 584a <exit>
    f(s);
    5368:	854a                	mv	a0,s2
    536a:	9482                	jalr	s1
    exit(0);
    ...
    5372:	4dc080e7          	jalr	1244(ra) # 584a <exit>
      printf("OK\n");
...
main(int argc, char *argv[])
{
  ...
  if(fail){
    ...
    544e:	400080e7          	jalr	1024(ra) # 584a <exit>
    5452:	84ae                	mv	s1,a1
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54a4:	3aa080e7          	jalr	938(ra) # 584a <exit>
          exit(1);
    54a8:	4505                	li	a0,1
    54aa:	00000097          	auipc	ra,0x0
    54ae:	3a0080e7          	jalr	928(ra) # 584a <exit>
    ...
    54ca:	384080e7          	jalr	900(ra) # 584a <exit>
  for (struct test *t = tests; t->s != 0; t++) {
  ...
  if(fail){
    ...
    5510:	33e080e7          	jalr	830(ra) # 584a <exit>
  } else {
    ...
    552a:	324080e7          	jalr	804(ra) # 584a <exit>
        printf("SOME TESTS FAILED\n");
    552e:	8556                	mv	a0,s5
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    56c4:	1a2080e7          	jalr	418(ra) # 5862 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5716:	178080e7          	jalr	376(ra) # 588a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5726:	180080e7          	jalr	384(ra) # 58a2 <fstat>
    572a:	892a                	mv	s2,a0
  close(fd);
    572c:	8526                	mv	a0,s1
    572e:	00000097          	auipc	ra,0x0
    5732:	144080e7          	jalr	324(ra) # 5872 <close>
  return r;
}
    5736:	854a                	mv	a0,s2
...
000000000000583a <getthisprocsize>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5900:	f6e080e7          	jalr	-146(ra) # 586a <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d56:	b80080e7          	jalr	-1152(ra) # 58d2 <sbrk>
  if(p == (char*)-1)
