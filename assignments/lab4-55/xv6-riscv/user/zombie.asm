...
main(void)
{
  ...
  if(fork() > 0)
   ...
   c:	296080e7          	jalr	662(ra) # 29e <fork>
  10:	00a04763          	bgtz	a0,1e <main+0x1e>
    sleep(5);  // Let child exit before parent.
  exit(0);
  14:	4501                	li	a0,0
  16:	00000097          	auipc	ra,0x0
  1a:	290080e7          	jalr	656(ra) # 2a6 <exit>
    sleep(5);  // Let child exit before parent.
  1e:	4515                	li	a0,5
  20:	00000097          	auipc	ra,0x0
  24:	316080e7          	jalr	790(ra) # 336 <sleep>
...
gets(char *buf, int max)
{
 ...
 118:	1aa080e7          	jalr	426(ra) # 2be <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 16a:	180080e7          	jalr	384(ra) # 2e6 <open>
  if(fd < 0)
 ...
 17a:	188080e7          	jalr	392(ra) # 2fe <fstat>
 17e:	892a                	mv	s2,a0
  close(fd);
 180:	8526                	mv	a0,s1
 182:	00000097          	auipc	ra,0x0
 186:	14c080e7          	jalr	332(ra) # 2ce <close>
  return r;
}
 18a:	854a                	mv	a0,s2
