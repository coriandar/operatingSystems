...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	df8080e7          	jalr	-520(ra) # e88 <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	dc6080e7          	jalr	-570(ra) # e68 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	26e50513          	addi	a0,a0,622 # 1318 <malloc+0xe6>
      b2:	00001097          	auipc	ra,0x1
      b6:	dbe080e7          	jalr	-578(ra) # e70 <chdir>
    ...
    exit(1);
      ...
      d2:	d32080e7          	jalr	-718(ra) # e00 <exit>
  }
  chdir("/");
      d6:	00001517          	auipc	a0,0x1
      da:	26a50513          	addi	a0,a0,618 # 1340 <malloc+0x10e>
      de:	00001097          	auipc	ra,0x1
      e2:	d92080e7          	jalr	-622(ra) # e70 <chdir>
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     116:	d2e080e7          	jalr	-722(ra) # e40 <open>
     11a:	00001097          	auipc	ra,0x1
     11e:	d0e080e7          	jalr	-754(ra) # e28 <close>
    iters++;
    ...
    if((iters % 500) == 0)
     ...
     138:	cec080e7          	jalr	-788(ra) # e20 <write>
    int what = rand() % 23;
    ...
    if(what == 1){
     ...
     170:	cd4080e7          	jalr	-812(ra) # e40 <open>
     174:	00001097          	auipc	ra,0x1
     178:	cb4080e7          	jalr	-844(ra) # e28 <close>
     ...
     18a:	cca080e7          	jalr	-822(ra) # e50 <unlink>
     ...
     19c:	cd8080e7          	jalr	-808(ra) # e70 <chdir>
     ...
     1ae:	ca6080e7          	jalr	-858(ra) # e50 <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	18e50513          	addi	a0,a0,398 # 1340 <malloc+0x10e>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cb6080e7          	jalr	-842(ra) # e70 <chdir>
     ...
     1da:	c2a080e7          	jalr	-982(ra) # e00 <exit>
    } else if(what == 5){
      close(fd);
     1de:	8552                	mv	a0,s4
     1e0:	00001097          	auipc	ra,0x1
     1e4:	c48080e7          	jalr	-952(ra) # e28 <close>
      fd = open("/grindir/../a", O_CREATE|O_RDWR);
     1e8:	20200593          	li	a1,514
     1ec:	00001517          	auipc	a0,0x1
     1f0:	19c50513          	addi	a0,a0,412 # 1388 <malloc+0x156>
     1f4:	00001097          	auipc	ra,0x1
     1f8:	c4c080e7          	jalr	-948(ra) # e40 <open>
     1fc:	8a2a                	mv	s4,a0
     ...
     234:	bf0080e7          	jalr	-1040(ra) # e20 <write>
     ...
     24c:	bd0080e7          	jalr	-1072(ra) # e18 <read>
     ...
     2da:	b7a080e7          	jalr	-1158(ra) # e50 <unlink>
      link("../grindir/./../a", "../b");
     ...
     2f2:	b72080e7          	jalr	-1166(ra) # e60 <link>
     ...
     304:	b50080e7          	jalr	-1200(ra) # e50 <unlink>
      link(".././b", "/grindir/../a");
     ...
     31c:	b48080e7          	jalr	-1208(ra) # e60 <link>
     320:	b509                	j	122 <go+0xaa>
    } else if(what == 13){
      int pid = fork();
     322:	00001097          	auipc	ra,0x1
     326:	ad6080e7          	jalr	-1322(ra) # df8 <fork>
      if(pid == 0){
     ...
     336:	ad6080e7          	jalr	-1322(ra) # e08 <wait>
     33a:	b3e5                	j	122 <go+0xaa>
        exit(0);
     33c:	00001097          	auipc	ra,0x1
     340:	ac4080e7          	jalr	-1340(ra) # e00 <exit>
        printf("grind: fork failed\n");
     ...
     35a:	aaa080e7          	jalr	-1366(ra) # e00 <exit>
    } else if(what == 14){
      int pid = fork();
     35e:	00001097          	auipc	ra,0x1
     362:	a9a080e7          	jalr	-1382(ra) # df8 <fork>
      if(pid == 0){
     ...
     372:	a9a080e7          	jalr	-1382(ra) # e08 <wait>
     376:	b375                	j	122 <go+0xaa>
        fork();
     378:	00001097          	auipc	ra,0x1
     37c:	a80080e7          	jalr	-1408(ra) # df8 <fork>
        fork();
     380:	00001097          	auipc	ra,0x1
     384:	a78080e7          	jalr	-1416(ra) # df8 <fork>
        exit(0);
     388:	4501                	li	a0,0
     38a:	00001097          	auipc	ra,0x1
     38e:	a76080e7          	jalr	-1418(ra) # e00 <exit>
        printf("grind: fork failed\n");
     ...
     3a8:	a5c080e7          	jalr	-1444(ra) # e00 <exit>
    } else if(what == 15){
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0x93>
     3b2:	00001097          	auipc	ra,0x1
     3b6:	ad6080e7          	jalr	-1322(ra) # e88 <sbrk>
     3ba:	b3a5                	j	122 <go+0xaa>
    } else if(what == 16){
      if(sbrk(0) > break0)
     3bc:	4501                	li	a0,0
     3be:	00001097          	auipc	ra,0x1
     3c2:	aca080e7          	jalr	-1334(ra) # e88 <sbrk>
     3c6:	d4aafee3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     3ca:	4501                	li	a0,0
     3cc:	00001097          	auipc	ra,0x1
     3d0:	abc080e7          	jalr	-1348(ra) # e88 <sbrk>
     3d4:	40aa853b          	subw	a0,s5,a0
     3d8:	00001097          	auipc	ra,0x1
     3dc:	ab0080e7          	jalr	-1360(ra) # e88 <sbrk>
     3e0:	b389                	j	122 <go+0xaa>
    } else if(what == 17){
      int pid = fork();
     3e2:	00001097          	auipc	ra,0x1
     3e6:	a16080e7          	jalr	-1514(ra) # df8 <fork>
     3ea:	8b2a                	mv	s6,a0
      if(pid == 0){
     ...
     3fe:	a76080e7          	jalr	-1418(ra) # e70 <chdir>
     ...
     40a:	a2a080e7          	jalr	-1494(ra) # e30 <kill>
      wait(0);
     40e:	4501                	li	a0,0
     410:	00001097          	auipc	ra,0x1
     414:	9f8080e7          	jalr	-1544(ra) # e08 <wait>
     ...
     42a:	a1a080e7          	jalr	-1510(ra) # e40 <open>
     42e:	00001097          	auipc	ra,0x1
     432:	9fa080e7          	jalr	-1542(ra) # e28 <close>
        exit(0);
     436:	4501                	li	a0,0
     438:	00001097          	auipc	ra,0x1
     43c:	9c8080e7          	jalr	-1592(ra) # e00 <exit>
        printf("grind: fork failed\n");
     ...
     456:	9ae080e7          	jalr	-1618(ra) # e00 <exit>
        printf("grind: chdir failed\n");
     ...
     470:	994080e7          	jalr	-1644(ra) # e00 <exit>
    } else if(what == 18){
      int pid = fork();
     474:	00001097          	auipc	ra,0x1
     478:	984080e7          	jalr	-1660(ra) # df8 <fork>
      if(pid == 0){
     ...
     488:	984080e7          	jalr	-1660(ra) # e08 <wait>
     48c:	b959                	j	122 <go+0xaa>
        kill(getpid());
     48e:	00001097          	auipc	ra,0x1
     492:	9f2080e7          	jalr	-1550(ra) # e80 <getpid>
     496:	00001097          	auipc	ra,0x1
     49a:	99a080e7          	jalr	-1638(ra) # e30 <kill>
        exit(0);
     49e:	4501                	li	a0,0
     4a0:	00001097          	auipc	ra,0x1
     4a4:	960080e7          	jalr	-1696(ra) # e00 <exit>
        printf("grind: fork failed\n");
     ...
     4be:	946080e7          	jalr	-1722(ra) # e00 <exit>
    } else if(what == 19){
      int fds[2];
      if(pipe(fds) < 0){
     4c2:	fa840513          	addi	a0,s0,-88
     4c6:	00001097          	auipc	ra,0x1
     4ca:	94a080e7          	jalr	-1718(ra) # e10 <pipe>
     ...
     4d6:	926080e7          	jalr	-1754(ra) # df8 <fork>
      if(pid == 0){
     ...
     4e8:	944080e7          	jalr	-1724(ra) # e28 <close>
      close(fds[1]);
     4ec:	fac42503          	lw	a0,-84(s0)
     4f0:	00001097          	auipc	ra,0x1
     4f4:	938080e7          	jalr	-1736(ra) # e28 <close>
      wait(0);
     4f8:	4501                	li	a0,0
     4fa:	00001097          	auipc	ra,0x1
     4fe:	90e080e7          	jalr	-1778(ra) # e08 <wait>
     ...
     51a:	8ea080e7          	jalr	-1814(ra) # e00 <exit>
        fork();
     51e:	00001097          	auipc	ra,0x1
     522:	8da080e7          	jalr	-1830(ra) # df8 <fork>
        fork();
     526:	00001097          	auipc	ra,0x1
     52a:	8d2080e7          	jalr	-1838(ra) # df8 <fork>
     ...
     540:	8e4080e7          	jalr	-1820(ra) # e20 <write>
     544:	4785                	li	a5,1
     ...
     558:	8c4080e7          	jalr	-1852(ra) # e18 <read>
     55c:	4785                	li	a5,1
     55e:	02f51063          	bne	a0,a5,57e <go+0x506>
        exit(0);
     562:	4501                	li	a0,0
     564:	00001097          	auipc	ra,0x1
     568:	89c080e7          	jalr	-1892(ra) # e00 <exit>
          printf("grind: pipe write failed\n");
     ...
     5a6:	85e080e7          	jalr	-1954(ra) # e00 <exit>
    } else if(what == 20){
      int pid = fork();
     5aa:	00001097          	auipc	ra,0x1
     5ae:	84e080e7          	jalr	-1970(ra) # df8 <fork>
      if(pid == 0){
     ...
     66c:	7d8080e7          	jalr	2008(ra) # e40 <open>
     670:	8b2a                	mv	s6,a0
      if(fd1 < 0){
     ...
     684:	7a0080e7          	jalr	1952(ra) # e20 <write>
     688:	4785                	li	a5,1
     ...
     698:	7c4080e7          	jalr	1988(ra) # e58 <fstat>
     ...
     6e6:	71e080e7          	jalr	1822(ra) # e00 <exit>
        printf("grind: write c failed\n");
     ...
     700:	704080e7          	jalr	1796(ra) # e00 <exit>
        printf("grind: fstat failed\n");
     ...
     71a:	6ea080e7          	jalr	1770(ra) # e00 <exit>
        printf("grind: fstat reports wrong size %d\n", (int)st.size);
     ...
     736:	6ce080e7          	jalr	1742(ra) # e00 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     ...
     750:	6b4080e7          	jalr	1716(ra) # e00 <exit>
    } else if(what == 22){
      // echo hi | cat
      int aa[2], bb[2];
      if(pipe(aa) < 0){
     ...
     75c:	6b8080e7          	jalr	1720(ra) # e10 <pipe>
     ...
     76c:	6a8080e7          	jalr	1704(ra) # e10 <pipe>
     ...
     778:	684080e7          	jalr	1668(ra) # df8 <fork>
      if(pid1 == 0){
     ...
     788:	674080e7          	jalr	1652(ra) # df8 <fork>
      if(pid2 == 0){
     ...
     79c:	690080e7          	jalr	1680(ra) # e28 <close>
      close(aa[1]);
     7a0:	f9c42503          	lw	a0,-100(s0)
     7a4:	00000097          	auipc	ra,0x0
     7a8:	684080e7          	jalr	1668(ra) # e28 <close>
      close(bb[1]);
     7ac:	fa442503          	lw	a0,-92(s0)
     7b0:	00000097          	auipc	ra,0x0
     7b4:	678080e7          	jalr	1656(ra) # e28 <close>
      char buf[4] = { 0, 0, 0, 0 };
     ...
     7ca:	652080e7          	jalr	1618(ra) # e18 <read>
      read(bb[0], buf+1, 1);
     7ce:	4605                	li	a2,1
     7d0:	f9140593          	addi	a1,s0,-111
     7d4:	fa042503          	lw	a0,-96(s0)
     7d8:	00000097          	auipc	ra,0x0
     7dc:	640080e7          	jalr	1600(ra) # e18 <read>
      read(bb[0], buf+2, 1);
     7e0:	4605                	li	a2,1
     7e2:	f9240593          	addi	a1,s0,-110
     7e6:	fa042503          	lw	a0,-96(s0)
     7ea:	00000097          	auipc	ra,0x0
     7ee:	62e080e7          	jalr	1582(ra) # e18 <read>
      close(bb[0]);
     7f2:	fa042503          	lw	a0,-96(s0)
     7f6:	00000097          	auipc	ra,0x0
     7fa:	632080e7          	jalr	1586(ra) # e28 <close>
      int st1, st2;
      wait(&st1);
     7fe:	f9440513          	addi	a0,s0,-108
     802:	00000097          	auipc	ra,0x0
     806:	606080e7          	jalr	1542(ra) # e08 <wait>
      wait(&st2);
     80a:	fa840513          	addi	a0,s0,-88
     80e:	00000097          	auipc	ra,0x0
     812:	5fa080e7          	jalr	1530(ra) # e08 <wait>
     ...
     85c:	5a8080e7          	jalr	1448(ra) # e00 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     878:	58c080e7          	jalr	1420(ra) # e00 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     894:	570080e7          	jalr	1392(ra) # e00 <exit>
        close(bb[0]);
     898:	fa042503          	lw	a0,-96(s0)
     89c:	00000097          	auipc	ra,0x0
     8a0:	58c080e7          	jalr	1420(ra) # e28 <close>
        close(bb[1]);
     8a4:	fa442503          	lw	a0,-92(s0)
     8a8:	00000097          	auipc	ra,0x0
     8ac:	580080e7          	jalr	1408(ra) # e28 <close>
        close(aa[0]);
     8b0:	f9842503          	lw	a0,-104(s0)
     8b4:	00000097          	auipc	ra,0x0
     8b8:	574080e7          	jalr	1396(ra) # e28 <close>
        close(1);
     8bc:	4505                	li	a0,1
     8be:	00000097          	auipc	ra,0x0
     8c2:	56a080e7          	jalr	1386(ra) # e28 <close>
        if(dup(aa[1]) != 1){
     8c6:	f9c42503          	lw	a0,-100(s0)
     8ca:	00000097          	auipc	ra,0x0
     8ce:	5ae080e7          	jalr	1454(ra) # e78 <dup>
     8d2:	4785                	li	a5,1
     ...
     8f0:	514080e7          	jalr	1300(ra) # e00 <exit>
        close(aa[1]);
     8f4:	f9c42503          	lw	a0,-100(s0)
     8f8:	00000097          	auipc	ra,0x0
     8fc:	530080e7          	jalr	1328(ra) # e28 <close>
        char *args[3] = { "echo", "hi", 0 };
     ...
     92c:	510080e7          	jalr	1296(ra) # e38 <exec>
        fprintf(2, "grind: echo: not found\n");
     ...
     948:	4bc080e7          	jalr	1212(ra) # e00 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     964:	4a0080e7          	jalr	1184(ra) # e00 <exit>
        close(aa[1]);
     968:	f9c42503          	lw	a0,-100(s0)
     96c:	00000097          	auipc	ra,0x0
     970:	4bc080e7          	jalr	1212(ra) # e28 <close>
        close(bb[0]);
     974:	fa042503          	lw	a0,-96(s0)
     978:	00000097          	auipc	ra,0x0
     97c:	4b0080e7          	jalr	1200(ra) # e28 <close>
        close(0);
     980:	4501                	li	a0,0
     982:	00000097          	auipc	ra,0x0
     986:	4a6080e7          	jalr	1190(ra) # e28 <close>
        if(dup(aa[0]) != 0){
     98a:	f9842503          	lw	a0,-104(s0)
     98e:	00000097          	auipc	ra,0x0
     992:	4ea080e7          	jalr	1258(ra) # e78 <dup>
     ...
     9b0:	454080e7          	jalr	1108(ra) # e00 <exit>
        close(aa[0]);
     9b4:	f9842503          	lw	a0,-104(s0)
     9b8:	00000097          	auipc	ra,0x0
     9bc:	470080e7          	jalr	1136(ra) # e28 <close>
        close(1);
     9c0:	4505                	li	a0,1
     9c2:	00000097          	auipc	ra,0x0
     9c6:	466080e7          	jalr	1126(ra) # e28 <close>
        if(dup(bb[1]) != 1){
     9ca:	fa442503          	lw	a0,-92(s0)
     9ce:	00000097          	auipc	ra,0x0
     9d2:	4aa080e7          	jalr	1194(ra) # e78 <dup>
     9d6:	4785                	li	a5,1
     ...
     9f4:	410080e7          	jalr	1040(ra) # e00 <exit>
        close(bb[1]);
     9f8:	fa442503          	lw	a0,-92(s0)
     9fc:	00000097          	auipc	ra,0x0
     a00:	42c080e7          	jalr	1068(ra) # e28 <close>
        char *args[2] = { "cat", 0 };
     ...
     a24:	418080e7          	jalr	1048(ra) # e38 <exec>
        fprintf(2, "grind: cat: not found\n");
     ...
     a40:	3c4080e7          	jalr	964(ra) # e00 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     a5c:	3a8080e7          	jalr	936(ra) # e00 <exit>
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	3dc080e7          	jalr	988(ra) # e50 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	92c50513          	addi	a0,a0,-1748 # 13a8 <malloc+0x176>
     a84:	00000097          	auipc	ra,0x0
     a88:	3cc080e7          	jalr	972(ra) # e50 <unlink>
  
  int pid1 = fork();
     a8c:	00000097          	auipc	ra,0x0
     a90:	36c080e7          	jalr	876(ra) # df8 <fork>
  if(pid1 < 0){
  ...
  if(pid1 == 0){
    ...
    exit(1);
     ...
     ac6:	33e080e7          	jalr	830(ra) # e00 <exit>
    exit(0);
  }

  int pid2 = fork();
     aca:	00000097          	auipc	ra,0x0
     ace:	32e080e7          	jalr	814(ra) # df8 <fork>
     ad2:	892a                	mv	s2,a0
  if(pid2 < 0){
  ...
  if(pid2 == 0){
    ...
    exit(1);
     ...
     b08:	2fc080e7          	jalr	764(ra) # e00 <exit>
    exit(0);
  }
  ...
  wait(&st1);
     ...
     b1a:	2f2080e7          	jalr	754(ra) # e08 <wait>
  if(st1 != 0){
  ...
  wait(&st2);
     ...
     b32:	2da080e7          	jalr	730(ra) # e08 <wait>

  exit(0);
     b36:	4501                	li	a0,0
     b38:	00000097          	auipc	ra,0x0
     b3c:	2c8080e7          	jalr	712(ra) # e00 <exit>
    kill(pid1);
     b40:	8526                	mv	a0,s1
     b42:	00000097          	auipc	ra,0x0
     b46:	2ee080e7          	jalr	750(ra) # e30 <kill>
    kill(pid2);
     b4a:	854a                	mv	a0,s2
     b4c:	00000097          	auipc	ra,0x0
     b50:	2e4080e7          	jalr	740(ra) # e30 <kill>
...
main()
{
  ...
  while(1){
    ...
    sleep(20);
     ...
     b6e:	326080e7          	jalr	806(ra) # e90 <sleep>
    int pid = fork();
     b72:	00000097          	auipc	ra,0x0
     b76:	286080e7          	jalr	646(ra) # df8 <fork>
    if(pid == 0){
    ...
    if(pid > 0){
     ...
     b86:	286080e7          	jalr	646(ra) # e08 <wait>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c7a:	1a2080e7          	jalr	418(ra) # e18 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     ccc:	178080e7          	jalr	376(ra) # e40 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cdc:	180080e7          	jalr	384(ra) # e58 <fstat>
     ce0:	892a                	mv	s2,a0
  close(fd);
     ce2:	8526                	mv	a0,s1
     ce4:	00000097          	auipc	ra,0x0
     ce8:	144080e7          	jalr	324(ra) # e28 <close>
  return r;
}
     cec:	854a                	mv	a0,s2
...
0000000000000df0 <getthisprocsize>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eb6:	f6e080e7          	jalr	-146(ra) # e20 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    130c:	b80080e7          	jalr	-1152(ra) # e88 <sbrk>
  if(p == (char*)-1)
