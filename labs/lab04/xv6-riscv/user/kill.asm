...
main(int argc, char **argv)
{
  ...
  34:	2d8080e7          	jalr	728(ra) # 308 <kill>
  for(i=1; i<argc; i++)
  ...
  60:	27c080e7          	jalr	636(ra) # 2d8 <exit>
...
gets(char *buf, int max)
{
 ...
 152:	1a2080e7          	jalr	418(ra) # 2f0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a4:	178080e7          	jalr	376(ra) # 318 <open>
  if(fd < 0)
 ...
 1b4:	180080e7          	jalr	384(ra) # 330 <fstat>
 1b8:	892a                	mv	s2,a0
  close(fd);
 1ba:	8526                	mv	a0,s1
 1bc:	00000097          	auipc	ra,0x0
 1c0:	144080e7          	jalr	324(ra) # 300 <close>
  return r;
}
 1c4:	854a                	mv	a0,s2
