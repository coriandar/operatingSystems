...
ls(char *path)
{
  ...
  de:	4ac080e7          	jalr	1196(ra) # 586 <open>
  ...
  f0:	4b2080e7          	jalr	1202(ra) # 59e <fstat>
 ...
 13a:	438080e7          	jalr	1080(ra) # 56e <close>
}
 ...
 190:	3e2080e7          	jalr	994(ra) # 56e <close>
    return;
 ...
 21a:	348080e7          	jalr	840(ra) # 55e <read>
 21e:	47c1                	li	a5,16
...
main(int argc, char *argv[])
{
 ...
 2b4:	296080e7          	jalr	662(ra) # 546 <exit>
    ls(".");
 ...
 2ce:	27c080e7          	jalr	636(ra) # 546 <exit>
...
gets(char *buf, int max)
{
 ...
 3c0:	1a2080e7          	jalr	418(ra) # 55e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 412:	178080e7          	jalr	376(ra) # 586 <open>
  if(fd < 0)
 ...
 42e:	144080e7          	jalr	324(ra) # 56e <close>
  return r;
}
 432:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 a52:	b80080e7          	jalr	-1152(ra) # 5ce <sbrk>
  if(p == (char*)-1)
