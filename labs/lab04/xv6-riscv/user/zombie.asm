...
main(void)
{
  ...
  if(fork() > 0)
   ...
   c:	28e080e7          	jalr	654(ra) # 296 <fork>
  10:	00a04763          	bgtz	a0,1e <main+0x1e>
    sleep(5);  // Let child exit before parent.
  exit(0);
  14:	4501                	li	a0,0
  16:	00000097          	auipc	ra,0x0
  1a:	288080e7          	jalr	648(ra) # 29e <exit>
    sleep(5);  // Let child exit before parent.
  1e:	4515                	li	a0,5
  20:	00000097          	auipc	ra,0x0
  24:	30e080e7          	jalr	782(ra) # 32e <sleep>
...
gets(char *buf, int max)
{
 ...
 118:	1a2080e7          	jalr	418(ra) # 2b6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 16a:	178080e7          	jalr	376(ra) # 2de <open>
  if(fd < 0)
 ...
 17a:	180080e7          	jalr	384(ra) # 2f6 <fstat>
 17e:	892a                	mv	s2,a0
  close(fd);
 180:	8526                	mv	a0,s1
 182:	00000097          	auipc	ra,0x0
 186:	144080e7          	jalr	324(ra) # 2c6 <close>
  return r;
}
 18a:	854a                	mv	a0,s2
...
000000000000028e <getthisprocsize>:
...
putc(int fd, char c)
{
 ...
 354:	f6e080e7          	jalr	-146(ra) # 2be <write>
}
...
malloc(uint nbytes)
{
 ...
 7aa:	b80080e7          	jalr	-1152(ra) # 326 <sbrk>
  if(p == (char*)-1)
