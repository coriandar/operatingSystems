...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	29258593          	addi	a1,a1,658 # 12f0 <malloc+0xf6>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	26050513          	addi	a0,a0,608 # 12f8 <malloc+0xfe>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    panic("runcmd");
      ...
      e2:	22250513          	addi	a0,a0,546 # 1300 <malloc+0x106>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	20858593          	addi	a1,a1,520 # 1308 <malloc+0x10e>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	1cc58593          	addi	a1,a1,460 # 1318 <malloc+0x11e>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	14650513          	addi	a0,a0,326 # 1328 <malloc+0x12e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ae:	da6b8b93          	addi	s7,s7,-602 # 1350 <malloc+0x156>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c0:	d7450513          	addi	a0,a0,-652 # 1330 <malloc+0x136>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a8:	cb460613          	addi	a2,a2,-844 # 1358 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d8:	ca4b0b13          	addi	s6,s6,-860 # 1378 <malloc+0x17e>
  ...
  return ret;
     ...
     712:	c5250513          	addi	a0,a0,-942 # 1360 <malloc+0x166>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     774:	bf850513          	addi	a0,a0,-1032 # 1368 <malloc+0x16e>
...
000000000000078e <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ae:	bd660613          	addi	a2,a2,-1066 # 1380 <malloc+0x186>
     7b2:	85ce                	mv	a1,s3
     7b4:	854a                	mv	a0,s2
...
00000000000007fc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81e:	b6ea0a13          	addi	s4,s4,-1170 # 1388 <malloc+0x18e>
  ...
  if(peek(ps, es, ";")){
     ...
     854:	b4060613          	addi	a2,a2,-1216 # 1390 <malloc+0x196>
     858:	85ce                	mv	a1,s3
     85a:	854a                	mv	a0,s2
...
00000000000008a4 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8ba:	aa260613          	addi	a2,a2,-1374 # 1358 <malloc+0x15e>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ea:	ac260613          	addi	a2,a2,-1342 # 13a8 <malloc+0x1ae>
     8ee:	85ca                	mv	a1,s2
     8f0:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92c:	a7050513          	addi	a0,a0,-1424 # 1398 <malloc+0x19e>
     930:	fffff097          	auipc	ra,0xfffff
     934:	724080e7          	jalr	1828(ra) # 54 <panic>
    panic("syntax - missing )");
     938:	00001517          	auipc	a0,0x1
     93c:	a7850513          	addi	a0,a0,-1416 # 13b0 <malloc+0x1b6>
...
00000000000009e0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a14:	8d860613          	addi	a2,a2,-1832 # 12e8 <malloc+0xee>
     a18:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a5c:	90850513          	addi	a0,a0,-1784 # 1360 <malloc+0x166>
