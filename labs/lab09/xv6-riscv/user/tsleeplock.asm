...
int main()
{
  ...
  1a:	80290913          	addi	s2,s2,-2046 # 818 <malloc+0xe6>
    pid = fork();
  ...
  30:	64e080e7          	jalr	1614(ra) # 67a <printf>
      sleep(10);
  34:	4529                	li	a0,10
  ...
  6e:	7c650513          	addi	a0,a0,1990 # 830 <malloc+0xfe>
  72:	00000097          	auipc	ra,0x0
  76:	608080e7          	jalr	1544(ra) # 67a <printf>
...
stat(const char *n, struct stat *st)
{
 ...
 1cc:	170080e7          	jalr	368(ra) # 338 <open>
  if(fd < 0)
...
putc(int fd, char c)
{
 ...
 3b6:	f66080e7          	jalr	-154(ra) # 318 <write>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a8:	3acc8c93          	addi	s9,s9,940 # 850 <malloc+0x11e>
 ...
 4b6:	3f6b8b93          	addi	s7,s7,1014 # 8a8 <digits>
 ...
 5dc:	27098993          	addi	s3,s3,624 # 848 <malloc+0x116>
        while(*s != 0){
 5e0:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 75a:	16a53503          	ld	a0,362(a0) # 8c0 <freep>
 ...
 782:	14290913          	addi	s2,s2,322 # 8c0 <freep>
  if(p == (char*)-1)
 786:	5afd                	li	s5,-1
 788:	a895                	j	7fc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 78a:	00000797          	auipc	a5,0x0
 78e:	13e78793          	addi	a5,a5,318 # 8c8 <base>
 792:	00000717          	auipc	a4,0x0
 796:	12f73723          	sd	a5,302(a4) # 8c0 <freep>
 79a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7be:	10a73323          	sd	a0,262(a4) # 8c0 <freep>
      return (void*)(p + 1);
 ...
 80c:	b78080e7          	jalr	-1160(ra) # 380 <sbrk>
  if(p == (char*)-1)
